...
class UserScaleTabLayout
    ...
    constructor(
        ...
        private fun ensureUserScaleCustomView(
            tab: Tab,
            requestLayoutIfChanged: Boolean,
        ): Boolean {
        ...
        private fun updateUserScaleTabTextView(
            view: android.view.View,
            expectedPx: Float? = null,
        ): Boolean {
