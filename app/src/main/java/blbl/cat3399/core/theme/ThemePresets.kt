...
object ThemePresets {
    ...
    fun resolve(context: Context): Spec {
        ...
        return when (preset) {
            ...
            // v5.0: Blue Dark
            AppPrefs.THEME_PRESET_BLUE_DARK ->
                Spec(
                    baseThemeRes = R.style.Theme_Blbl_Base_BlueDark,
                    overlayRes = null,
                )

            // v5.0: Green Dark
            AppPrefs.THEME_PRESET_GREEN_DARK ->
                Spec(
                    baseThemeRes = R.style.Theme_Blbl_Base_GreenDark,
                    overlayRes = null,
                )
