...
internal fun PlayerActivity.showV36ProgressBarStyleDialog() {
    ...
    showSettingsChoiceDialog(title = "进度条样式", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { style ->
        BiliClient.prefs.v36ProgressBarStyle = style
...
internal fun PlayerActivity.showV36CastResolutionDialog() {
    ...
    showSettingsChoiceDialog(title = "投射分辨率", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { res ->
        BiliClient.prefs.v36CastResolution = res
        AppToast.show(this, "投射分辨率：${labels[options.indexOf(res)]}")
    }
}
...
internal fun PlayerActivity.showV36DanmakuBackgroundBlurDialog() {
    ...
    showSettingsChoiceDialog(title = "背景模糊", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            0 -> "关闭"
            5 -> "轻微(5)"
            10 -> "中等(10)"
        ...
        BiliClient.prefs.v36DanmakuBackgroundBlur = blur
        AppToast.show(this, "背景模糊：$blur")
    }
}
...
internal fun PlayerActivity.showV36GestureLongPressSpeedDialog() {
    ...
    showSettingsChoiceDialog(title = "长按速度", options = options, checkedIndex = currentIndex, label = { v -> "${v}x" }) { speed ->
        BiliClient.prefs.v36GestureLongPressSpeed = speed
        AppToast.show(this, "长按速度：${speed}x")
    }
}
...
internal fun PlayerActivity.showV36ColorHueShiftDialog() {
    ...
    showSettingsChoiceDialog(title = "色调偏移", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            -180 -> "反转(-180)"
            -90 -> "偏绿(-90)"
            0 -> "标准(0)"
        ...
        BiliClient.prefs.v36ColorHueShift = shift
        AppToast.show(this, "色调偏移：$shift")
    }
}
...
internal fun PlayerActivity.showV36DanmakuFontGlowColorDialog() {
    ...
    showSettingsChoiceDialog(title = "发光颜色", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { color ->
        BiliClient.prefs.v36DanmakuFontGlowColor = color
        AppToast.show(this, "发光颜色：${labels[options.indexOf(color)]}")
    }
}
...
internal fun PlayerActivity.showV37DanmakuShadowColorDialog() {
    ...
    showSettingsChoiceDialog(title = "阴影颜色", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { color ->
        BiliClient.prefs.v37DanmakuShadowColor = color
        AppToast.show(this, "阴影颜色：${labels[options.indexOf(color)]}")
    }
}
...
internal fun PlayerActivity.showV37ColorVividnessDialog() {
    ...
    showSettingsChoiceDialog(title = "鲜艳度", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            -50 -> "淡雅(-50)"
            -25 -> "略淡(-25)"
            0 -> "标准(0)"
        ...
        BiliClient.prefs.v37ColorVividness = vivid
        AppToast.show(this, "鲜艳度：$vivid")
    }
}
...
internal fun PlayerActivity.showV37VibrationDecayDialog() {
    ...
    showSettingsChoiceDialog(title = "震动衰减", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            0 -> "关闭"
            25 -> "快速(25)"
            50 -> "中等(50)"
        ...
        BiliClient.prefs.v37VibrationDecay = decay
        AppToast.show(this, "震动衰减：$decay")
    }
}
...
internal fun PlayerActivity.showV37DanmakuScrollSpeedDialog() {
    ...
    showSettingsChoiceDialog(title = "滚动速度", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            -50 -> "极慢(-50)"
            -25 -> "较慢(-25)"
            0 -> "正常(0)"
        ...
        BiliClient.prefs.v37DanmakuScrollSpeed = speed
        AppToast.show(this, "滚动速度：$speed")
    }
}
...
internal fun PlayerActivity.showV37ColorTonemapDialog() {
    ...
    showSettingsChoiceDialog(title = "色阶映射", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { tonemap ->
        BiliClient.prefs.v37ColorTonemap = tonemap
        AppToast.show(this, "色阶映射：${labels[options.indexOf(tonemap)]}")
    }
}
...
internal fun PlayerActivity.showV37ProgressBarHeightDialog() {
    ...
    showSettingsChoiceDialog(title = "进度条高度", options = options, checkedIndex = currentIndex, label = { v -> "${v}dp" }) { height ->
        BiliClient.prefs.v37ProgressBarHeight = height
...
internal fun PlayerActivity.showV37CastBitrateDialog() {
    ...
    showSettingsChoiceDialog(title = "投射码率", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { bitrate ->
        BiliClient.prefs.v37CastBitrate = bitrate
        AppToast.show(this, "投射码率：${labels[options.indexOf(bitrate)]}")
    }
}
...
internal fun PlayerActivity.showV37DanmakuBorderColorDialog() {
    ...
    showSettingsChoiceDialog(title = "边框颜色", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { color ->
        BiliClient.prefs.v37DanmakuBorderColor = color
        AppToast.show(this, "边框颜色：${labels[options.indexOf(color)]}")
    }
}
...
internal fun PlayerActivity.showV37GestureDoubleTapDialog() {
    ...
    showSettingsChoiceDialog(title = "双击功能", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { func ->
        BiliClient.prefs.v37GestureDoubleTap = func
...
internal fun PlayerActivity.showV37ColorHueSaturationDialog() {
    ...
    showSettingsChoiceDialog(title = "色调饱和度", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            -50 -> "灰度(-50)"
            -25 -> "淡雅(-25)"
            0 -> "标准(0)"
        ...
        BiliClient.prefs.v37ColorHueSaturation = sat
        AppToast.show(this, "色调饱和度：$sat")
    }
}
...
internal fun PlayerActivity.showV37DanmakuGlowIntensityDialog() {
    ...
    showSettingsChoiceDialog(title = "发光强度", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            0 -> "关闭"
            25 -> "弱(25)"
            50 -> "中(50)"
        ...
        BiliClient.prefs.v37DanmakuGlowIntensity = intensity
        AppToast.show(this, "发光强度：$intensity")
    }
}
...
internal fun PlayerActivity.showV38PlaylistLoopModeDialog() {
    ...
    showSettingsChoiceDialog(title = "循环模式", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { mode ->
        BiliClient.prefs.v38PlaylistLoopMode = mode
...
internal fun PlayerActivity.showV38DanmakuBackgroundRadiusDialog() {
    ...
    showSettingsChoiceDialog(title = "背景圆角", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            0 -> "直角"
            4 -> "微圆(4)"
            8 -> "圆角(8)"
        ...
        BiliClient.prefs.v38DanmakuBackgroundRadius = radius
        AppToast.show(this, "背景圆角：$radius")
    }
}
...
internal fun PlayerActivity.showV38ColorContrastCurveDialog() {
    ...
    showSettingsChoiceDialog(title = "对比度曲线", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { curve ->
        BiliClient.prefs.v38ColorContrastCurve = curve
        AppToast.show(this, "对比度曲线：${labels[options.indexOf(curve)]}")
    }
}
...
internal fun PlayerActivity.showV38VibrationFrequencyDialog() {
    ...
    showSettingsChoiceDialog(title = "震动频率", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            0 -> "关闭"
            25 -> "低频(25)"
            50 -> "中频(50)"
        ...
        BiliClient.prefs.v38VibrationFrequency = freq
        AppToast.show(this, "震动频率：$freq")
    }
}
...
internal fun PlayerActivity.showV38VolumeLimitModeDialog() {
    ...
    showSettingsChoiceDialog(title = "音量限制模式", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { mode ->
        BiliClient.prefs.v38VolumeLimitMode = mode
...
internal fun PlayerActivity.showV38CacheCleanupStrategyDialog() {
    ...
    showSettingsChoiceDialog(title = "清理策略", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { strategy ->
        BiliClient.prefs.v38CacheCleanupStrategy = strategy
...
internal fun PlayerActivity.showV38DanmakuOffsetXDialog() {
    ...
    showSettingsChoiceDialog(title = "水平偏移", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            -100 -> "最左(-100)"
            -50 -> "偏左(-50)"
            0 -> "居中(0)"
        ...
        BiliClient.prefs.v38DanmakuOffsetX = offset
        AppToast.show(this, "水平偏移：$offset")
    }
}
...
internal fun PlayerActivity.showV38ColorBrightnessCurveDialog() {
    ...
    showSettingsChoiceDialog(title = "亮度曲线", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { curve ->
        BiliClient.prefs.v38ColorBrightnessCurve = curve
        AppToast.show(this, "亮度曲线：${labels[options.indexOf(curve)]}")
    }
}
...
internal fun PlayerActivity.showV38HistorySearchModeDialog() {
    ...
    showSettingsChoiceDialog(title = "搜索模式", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { mode ->
        BiliClient.prefs.v38HistorySearchMode = mode
        AppToast.show(this, "搜索模式：${labels[options.indexOf(mode)]}")
    }
}
...
internal fun PlayerActivity.showV38CastLatencyDialog() {
    ...
    showSettingsChoiceDialog(title = "投射延迟", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            0 -> "自动"
            1000 -> "1秒"
            2000 -> "2秒"
        ...
        BiliClient.prefs.v38CastLatency = latency
...
internal fun PlayerActivity.showV38DanmakuGradientDirectionDialog() {
    ...
    showSettingsChoiceDialog(title = "渐变方向", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { direction ->
        BiliClient.prefs.v38DanmakuGradientDirection = direction
        AppToast.show(this, "渐变方向：${labels[options.indexOf(direction)]}")
    }
}
...
internal fun PlayerActivity.showV38GestureSwipeSensitivityDialog() {
    ...
    showSettingsChoiceDialog(title = "滑动灵敏度", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            10 -> "极低(10)"
            25 -> "较低(25)"
            50 -> "中等(50)"
        ...
        BiliClient.prefs.v38GestureSwipeSensitivity = sensitivity
...
internal fun PlayerActivity.showV38ColorSaturationCurveDialog() {
    ...
    showSettingsChoiceDialog(title = "饱和度曲线", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { curve ->
        BiliClient.prefs.v38ColorSaturationCurve = curve
        AppToast.show(this, "饱和度曲线：${labels[options.indexOf(curve)]}")
    }
}
...
internal fun PlayerActivity.showV38DanmakuFontStrokeWidthDialog() {
    ...
    showSettingsChoiceDialog(title = "描边宽度", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            0 -> "关闭"
            1 -> "极细(1)"
            2 -> "细(2)"
        ...
        BiliClient.prefs.v38DanmakuFontStrokeWidth = width
        AppToast.show(this, "描边宽度：$width")
    }
}
...
internal fun PlayerActivity.showV39DanmakuBackgroundAlphaCurveDialog() {
    ...
    showSettingsChoiceDialog(title = "透明度曲线", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { curve ->
        BiliClient.prefs.v39DanmakuBackgroundAlphaCurve = curve
        AppToast.show(this, "透明度曲线：${labels[options.indexOf(curve)]}")
    }
}
...
internal fun PlayerActivity.showV39ColorSharpenDialog() {
    ...
    showSettingsChoiceDialog(title = "锐化强度", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            0 -> "关闭"
            25 -> "轻微(25)"
            50 -> "中等(50)"
        ...
        BiliClient.prefs.v39ColorSharpen = sharpen
        AppToast.show(this, "锐化强度：$sharpen")
    }
}
...
internal fun PlayerActivity.showV39VibrationPatternCurveDialog() {
    ...
    showSettingsChoiceDialog(title = "震动曲线", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { curve ->
        BiliClient.prefs.v39VibrationPatternCurve = curve
        AppToast.show(this, "震动曲线：${labels[options.indexOf(curve)]}")
    }
}
...
internal fun PlayerActivity.showV39VolumeBalanceDialog() {
    ...
    showSettingsChoiceDialog(title = "音量平衡", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            -100 -> "全左(-100)"
            -50 -> "偏左(-50)"
            0 -> "居中(0)"
        ...
        BiliClient.prefs.v39VolumeBalance = balance
        AppToast.show(this, "音量平衡：$balance")
    }
}
...
internal fun PlayerActivity.showV39CachePreloadSizeDialog() {
    ...
    showSettingsChoiceDialog(title = "预加载大小", options = options, checkedIndex = currentIndex, label = { v -> "${v}MB" }) { size ->
        BiliClient.prefs.v39CachePreloadSize = size
...
internal fun PlayerActivity.showV39DanmakuOffsetYDialog() {
    ...
    showSettingsChoiceDialog(title = "垂直偏移", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            -100 -> "最上(-100)"
            -50 -> "偏上(-50)"
            0 -> "居中(0)"
        ...
        BiliClient.prefs.v39DanmakuOffsetY = offset
        AppToast.show(this, "垂直偏移：$offset")
    }
}
...
internal fun PlayerActivity.showV39ColorDenoiseDialog() {
    ...
    showSettingsChoiceDialog(title = "降噪强度", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            0 -> "关闭"
            25 -> "轻微(25)"
            50 -> "中等(50)"
        ...
        BiliClient.prefs.v39ColorDenoise = denoise
        AppToast.show(this, "降噪强度：$denoise")
    }
}
...
internal fun PlayerActivity.showV39CastBufferStrategyDialog() {
    ...
    showSettingsChoiceDialog(title = "缓冲策略", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { strategy ->
        BiliClient.prefs.v39CastBufferStrategy = strategy
...
internal fun PlayerActivity.showV39DanmakuGradientSpeedDialog() {
    ...
    showSettingsChoiceDialog(title = "渐变速度", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            0 -> "关闭"
            25 -> "慢速(25)"
            50 -> "中速(50)"
        ...
        BiliClient.prefs.v39DanmakuGradientSpeed = speed
        AppToast.show(this, "渐变速度：$speed")
    }
}
...
internal fun PlayerActivity.showV39GestureLongPressDialog() {
    ...
    showSettingsChoiceDialog(title = "长按功能", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { func ->
        BiliClient.prefs.v39GestureLongPress = func
...
internal fun PlayerActivity.showV39ColorBlurDialog() {
    ...
    showSettingsChoiceDialog(title = "模糊强度", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            0 -> "关闭"
            5 -> "轻微(5)"
            10 -> "中等(10)"
        ...
        BiliClient.prefs.v39ColorBlur = blur
        AppToast.show(this, "模糊强度：$blur")
    }
}
...
internal fun PlayerActivity.showV39DanmakuGlowModeDialog() {
    ...
    showSettingsChoiceDialog(title = "发光模式", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { mode ->
        BiliClient.prefs.v39DanmakuGlowMode = mode
        AppToast.show(this, "发光模式：${labels[options.indexOf(mode)]}")
    }
}
...
internal fun PlayerActivity.showV40DanmakuGradientColorDialog() {
    ...
    showSettingsChoiceDialog(title = "渐变颜色", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { color ->
        BiliClient.prefs.v40DanmakuGradientColor = color
        AppToast.show(this, "渐变颜色：${labels[options.indexOf(color)]}")
    }
}
...
internal fun PlayerActivity.showV40ColorHueCurveDialog() {
    ...
    showSettingsChoiceDialog(title = "色调曲线", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { curve ->
        BiliClient.prefs.v40ColorHueCurve = curve
        AppToast.show(this, "色调曲线：${labels[options.indexOf(curve)]}")
    }
}
...
internal fun PlayerActivity.showV40VibrationIntensityCurveDialog() {
    ...
    showSettingsChoiceDialog(title = "震动强度曲线", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { curve ->
        BiliClient.prefs.v40VibrationIntensityCurve = curve
        AppToast.show(this, "震动强度曲线：${labels[options.indexOf(curve)]}")
    }
}
...
internal fun PlayerActivity.showV40VolumeLimitCurveDialog() {
    ...
    showSettingsChoiceDialog(title = "音量限制曲线", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { curve ->
        BiliClient.prefs.v40VolumeLimitCurve = curve
        AppToast.show(this, "音量限制曲线：${labels[options.indexOf(curve)]}")
    }
}
...
internal fun PlayerActivity.showV40CacheCleanupCurveDialog() {
    ...
    showSettingsChoiceDialog(title = "清理策略曲线", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { curve ->
        BiliClient.prefs.v40CacheCleanupCurve = curve
        AppToast.show(this, "清理策略曲线：${labels[options.indexOf(curve)]}")
    }
}
...
internal fun PlayerActivity.showV40DanmakuAlignCurveDialog() {
    ...
    showSettingsChoiceDialog(title = "对齐方式曲线", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { curve ->
        BiliClient.prefs.v40DanmakuAlignCurve = curve
        AppToast.show(this, "对齐方式曲线：${labels[options.indexOf(curve)]}")
    }
}
...
internal fun PlayerActivity.showV40ColorDenoiseCurveDialog() {
    ...
    showSettingsChoiceDialog(title = "降噪曲线", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { curve ->
        BiliClient.prefs.v40ColorDenoiseCurve = curve
        AppToast.show(this, "降噪曲线：${labels[options.indexOf(curve)]}")
    }
}
...
internal fun PlayerActivity.showV40HistoryExportFormatDialog() {
    ...
    showSettingsChoiceDialog(title = "导出格式", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { format ->
        BiliClient.prefs.v40HistoryExportFormat = format
        AppToast.show(this, "导出格式：${labels[options.indexOf(format)]}")
    }
}
...
internal fun PlayerActivity.showV40ProgressBarGradientDirectionDialog() {
    ...
    showSettingsChoiceDialog(title = "渐变方向", options = options, checkedIndex = currentIndex, label = { v ->
        ...
        BiliClient.prefs.v40ProgressBarGradientDirection = direction
        AppToast.show(this, "渐变方向：${labels[options.indexOf(direction)]}")
    }
}
...
internal fun PlayerActivity.showV40CastLatencyStrategyDialog() {
    ...
    showSettingsChoiceDialog(title = "延迟策略", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { strategy ->
        BiliClient.prefs.v40CastLatencyStrategy = strategy
        AppToast.show(this, "延迟策略：${labels[options.indexOf(strategy)]}")
    }
}
...
internal fun PlayerActivity.showV40DanmakuGradientAlphaDialog() {
    ...
    showSettingsChoiceDialog(title = "渐变透明度", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            0 -> "关闭"
            25 -> "25%"
            50 -> "50%"
        ...
        BiliClient.prefs.v40DanmakuGradientAlpha = alpha
        AppToast.show(this, "渐变透明度：$alpha%")
    }
}
...
internal fun PlayerActivity.showV40GestureSwipeSpeedDialog() {
    ...
    showSettingsChoiceDialog(title = "滑动速度", options = options, checkedIndex = currentIndex, label = { v ->
        when (v) {
            10 -> "极慢(10)"
            25 -> "较慢(25)"
            50 -> "中等(50)"
        ...
        BiliClient.prefs.v40GestureSwipeSpeed = speed
        AppToast.show(this, "滑动速度：$speed")
    }
}
...
internal fun PlayerActivity.showV40ColorBlurCurveDialog() {
    ...
    showSettingsChoiceDialog(title = "模糊曲线", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { curve ->
        BiliClient.prefs.v40ColorBlurCurve = curve
        AppToast.show(this, "模糊曲线：${labels[options.indexOf(curve)]}")
    }
}
...
internal fun PlayerActivity.showV40DanmakuGlowIntensityDialog() {
    ...
    showSettingsChoiceDialog(title = "发光强度", options = options, checkedIndex = currentIndex, label = { v ->
        ...
        BiliClient.prefs.v40DanmakuGlowIntensity = intensity
        AppToast.show(this, "发光强度：$intensity")
    }
}
...
internal fun PlayerActivity.showV41DanmakuVibrationModeDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Vibration Mode", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v41DanmakuVibrationMode = value
        AppToast.show(this, "Danmaku Vibration Mode: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV41VolumeBoostModeDialog() {
    ...
    showSettingsChoiceDialog(title = "Volume Boost Mode", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v41VolumeBoostMode = value
        AppToast.show(this, "Volume Boost Mode: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV41DanmakuStrokeStyleDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Stroke Style", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v41DanmakuStrokeStyle = value
        AppToast.show(this, "Danmaku Stroke Style: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV41CastColorCorrectionDialog() {
    ...
    showSettingsChoiceDialog(title = "Cast Color Correction", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v41CastColorCorrection = value
        AppToast.show(this, "Cast Color Correction: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV41GestureCustomMappingDialog() {
    ...
    showSettingsChoiceDialog(title = "Gesture Custom Mapping", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v41GestureCustomMapping = value
        AppToast.show(this, "Gesture Custom Mapping: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV41DanmakuDensityLimitDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Density Limit", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v41DanmakuDensityLimit = value
        AppToast.show(this, "Danmaku Density Limit: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV41ColorHdrSimulationDialog() {
    ...
    showSettingsChoiceDialog(title = "Color HDR Simulation", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v41ColorHdrSimulation = value
        AppToast.show(this, "Color HDR Simulation: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV41VolumeLimitEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Volume Limit Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v41VolumeLimitEnhanced = value
        AppToast.show(this, "Volume Limit Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV41DanmakuBgRadiusDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Background Radius", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v41DanmakuBgRadius = value
        AppToast.show(this, "Danmaku Background Radius: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV41CastAudioCodecDialog() {
    ...
    showSettingsChoiceDialog(title = "Cast Audio Codec", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v41CastAudioCodec = value
        AppToast.show(this, "Cast Audio Codec: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV42DanmakuStrokeColorDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Stroke Color", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v42DanmakuStrokeColor = value
        AppToast.show(this, "Danmaku Stroke Color: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV42ProgressBarColorDialog() {
    ...
    showSettingsChoiceDialog(title = "Progress Bar Color", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v42ProgressBarColor = value
        AppToast.show(this, "Progress Bar Color: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV42DanmakuGradientEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Gradient Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v42DanmakuGradientEnhanced = value
        AppToast.show(this, "Danmaku Gradient Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV42CastColorEnhanceDialog() {
    ...
    showSettingsChoiceDialog(title = "Cast Color Enhance", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v42CastColorEnhance = value
        AppToast.show(this, "Cast Color Enhance: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV42VolumeStepCustomDialog() {
    ...
    showSettingsChoiceDialog(title = "Volume Step Custom", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v42VolumeStepCustom = value
        AppToast.show(this, "Volume Step Custom: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV42DanmakuVibrationDurationDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Vibration Duration", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v42DanmakuVibrationDuration = value
        AppToast.show(this, "Danmaku Vibration Duration: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV42CachePreloadStrategyDialog() {
    ...
    showSettingsChoiceDialog(title = "Cache Preload Strategy", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v42CachePreloadStrategy = value
        AppToast.show(this, "Cache Preload Strategy: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV42ProgressBarBufferColorDialog() {
    ...
    showSettingsChoiceDialog(title = "Progress Bar Buffer Color", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v42ProgressBarBufferColor = value
        AppToast.show(this, "Progress Bar Buffer Color: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV43DanmakuBgAlphaDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Background Alpha", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v43DanmakuBgAlpha = value
        AppToast.show(this, "Danmaku Background Alpha: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV43CacheCleanupEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Cache Cleanup Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v43CacheCleanupEnhanced = value
        AppToast.show(this, "Cache Cleanup Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV43ProgressBarGradientEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Progress Bar Gradient Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v43ProgressBarGradientEnhanced = value
        AppToast.show(this, "Progress Bar Gradient Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV43DanmakuShadowEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Shadow Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v43DanmakuShadowEnhanced = value
        AppToast.show(this, "Danmaku Shadow Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV43CastResolutionEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Cast Resolution Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v43CastResolutionEnhanced = value
        AppToast.show(this, "Cast Resolution Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV43VolumeLimitCurveEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Volume Limit Curve Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v43VolumeLimitCurveEnhanced = value
        AppToast.show(this, "Volume Limit Curve Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV43DanmakuGlowEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Glow Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v43DanmakuGlowEnhanced = value
        AppToast.show(this, "Danmaku Glow Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV43DanmakuVibrationModeEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Vibration Mode Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v43DanmakuVibrationModeEnhanced = value
        AppToast.show(this, "Danmaku Vibration Mode Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV43CachePreloadSizeEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Cache Preload Size Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v43CachePreloadSizeEnhanced = value
        AppToast.show(this, "Cache Preload Size Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV43ProgressBarAnimationEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Progress Bar Animation Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v43ProgressBarAnimationEnhanced = value
        AppToast.show(this, "Progress Bar Animation Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV44ColorDenoiseEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Color Denoise Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v44ColorDenoiseEnhanced = value
        AppToast.show(this, "Color Denoise Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV44DanmakuStrokeWidthEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Stroke Width Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v44DanmakuStrokeWidthEnhanced = value
        AppToast.show(this, "Danmaku Stroke Width Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV44GestureLongPressSpeedEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Gesture Long Press Speed Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v44GestureLongPressSpeedEnhanced = value
        AppToast.show(this, "Gesture Long Press Speed Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV44CastBitrateEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Cast Bitrate Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v44CastBitrateEnhanced = value
        AppToast.show(this, "Cast Bitrate Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV44ProgressBarHeightEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Progress Bar Height Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v44ProgressBarHeightEnhanced = value
        AppToast.show(this, "Progress Bar Height Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV44DanmakuBorderEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Border Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v44DanmakuBorderEnhanced = value
        AppToast.show(this, "Danmaku Border Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV44ColorBlurEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Color Blur Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v44ColorBlurEnhanced = value
        AppToast.show(this, "Color Blur Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV44VolumeFadeEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Volume Fade Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v44VolumeFadeEnhanced = value
        AppToast.show(this, "Volume Fade Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV44DanmakuScrollSpeedEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Scroll Speed Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v44DanmakuScrollSpeedEnhanced = value
        AppToast.show(this, "Danmaku Scroll Speed Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV44CastLatencyEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Cast Latency Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v44CastLatencyEnhanced = value
        AppToast.show(this, "Cast Latency Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV44GestureSwipeSensitivityEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Gesture Swipe Sensitivity Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v44GestureSwipeSensitivityEnhanced = value
        AppToast.show(this, "Gesture Swipe Sensitivity Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV44DanmakuVibrationFrequencyEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Vibration Frequency Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v44DanmakuVibrationFrequencyEnhanced = value
        AppToast.show(this, "Danmaku Vibration Frequency Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV44CacheCleanupCurveEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Cache Cleanup Curve Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v44CacheCleanupCurveEnhanced = value
        AppToast.show(this, "Cache Cleanup Curve Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV44ProgressBarGradientDirectionEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Progress Bar Gradient Direction Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v44ProgressBarGradientDirectionEnhanced = value
        AppToast.show(this, "Progress Bar Gradient Direction Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV45ColorSharpenEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Color Sharpen Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v45ColorSharpenEnhanced = value
        AppToast.show(this, "Color Sharpen Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV45DanmakuBgRadiusEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Background Radius Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v45DanmakuBgRadiusEnhanced = value
        AppToast.show(this, "Danmaku Background Radius Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV45GestureDoubleTapEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Gesture Double Tap Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v45GestureDoubleTapEnhanced = value
        AppToast.show(this, "Gesture Double Tap Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV45DanmakuHistoryExportEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku History Export Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v45DanmakuHistoryExportEnhanced = value
        AppToast.show(this, "Danmaku History Export Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV45CastBufferEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Cast Buffer Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v45CastBufferEnhanced = value
        AppToast.show(this, "Cast Buffer Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV45ProgressBarStyleEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Progress Bar Style Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v45ProgressBarStyleEnhanced = value
        AppToast.show(this, "Progress Bar Style Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV45DanmakuGradientSpeedEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Gradient Speed Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v45DanmakuGradientSpeedEnhanced = value
        AppToast.show(this, "Danmaku Gradient Speed Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV45ColorVividnessEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Color Vividness Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v45ColorVividnessEnhanced = value
        AppToast.show(this, "Color Vividness Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV45VolumeBalanceEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Volume Balance Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v45VolumeBalanceEnhanced = value
        AppToast.show(this, "Volume Balance Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV45DanmakuOffsetEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Offset Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v45DanmakuOffsetEnhanced = value
        AppToast.show(this, "Danmaku Offset Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV45CastAudioEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Cast Audio Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v45CastAudioEnhanced = value
        AppToast.show(this, "Cast Audio Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV45GestureVibrationEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Gesture Vibration Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v45GestureVibrationEnhanced = value
        AppToast.show(this, "Gesture Vibration Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV45DanmakuVibrationIntensityEnhancedDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Vibration Intensity Enhanced", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v45DanmakuVibrationIntensityEnhanced = value
        AppToast.show(this, "Danmaku Vibration Intensity Enhanced: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV46DanmakuFontWeightDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Font Weight", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v46DanmakuFontWeight = value
        AppToast.show(this, "Danmaku Font Weight: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV46DanmakuStrokeOffsetDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Stroke Offset", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v46DanmakuStrokeOffset = value
        AppToast.show(this, "Danmaku Stroke Offset: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV46CastColorTemperatureDialog() {
    ...
    showSettingsChoiceDialog(title = "Cast Color Temperature", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v46CastColorTemperature = value
        AppToast.show(this, "Cast Color Temperature: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV46GestureEdgeExclusionDialog() {
    ...
    showSettingsChoiceDialog(title = "Gesture Edge Exclusion", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v46GestureEdgeExclusion = value
        AppToast.show(this, "Gesture Edge Exclusion: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV46DanmakuRowSpacingDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Row Spacing", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v46DanmakuRowSpacing = value
        AppToast.show(this, "Danmaku Row Spacing: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV46ProgressBarThumbSizeDialog() {
    ...
    showSettingsChoiceDialog(title = "Progress Bar Thumb Size", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v46ProgressBarThumbSize = value
        AppToast.show(this, "Progress Bar Thumb Size: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV46ColorWhiteBalanceDialog() {
    ...
    showSettingsChoiceDialog(title = "Color White Balance", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v46ColorWhiteBalance = value
        AppToast.show(this, "Color White Balance: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV46VolumeLimitThresholdDialog() {
    ...
    showSettingsChoiceDialog(title = "Volume Limit Threshold", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v46VolumeLimitThreshold = value
        AppToast.show(this, "Volume Limit Threshold: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV46DanmakuBgPaddingDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Bg Padding", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v46DanmakuBgPadding = value
        AppToast.show(this, "Danmaku Bg Padding: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV46CastVideoCodecDialog() {
    ...
    showSettingsChoiceDialog(title = "Cast Video Codec", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v46CastVideoCodec = value
        AppToast.show(this, "Cast Video Codec: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV47DanmakuFontSpacingDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Font Spacing", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v47DanmakuFontSpacing = value
        AppToast.show(this, "Danmaku Font Spacing: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV47ColorExposureCompensationDialog() {
    ...
    showSettingsChoiceDialog(title = "Color Exposure Compensation", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v47ColorExposureCompensation = value
        AppToast.show(this, "Color Exposure Compensation: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV47VolumeLoudnessEnhancerDialog() {
    ...
    showSettingsChoiceDialog(title = "Volume Loudness Enhancer", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v47VolumeLoudnessEnhancer = value
        AppToast.show(this, "Volume Loudness Enhancer: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV47DanmakuStrokeBlurDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Stroke Blur", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v47DanmakuStrokeBlur = value
        AppToast.show(this, "Danmaku Stroke Blur: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV47CastAudioBitrateDialog() {
    ...
    showSettingsChoiceDialog(title = "Cast Audio Bitrate", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v47CastAudioBitrate = value
        AppToast.show(this, "Cast Audio Bitrate: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV47GestureDeadZoneDialog() {
    ...
    showSettingsChoiceDialog(title = "Gesture Dead Zone", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v47GestureDeadZone = value
        AppToast.show(this, "Gesture Dead Zone: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV47DanmakuMaxLinesDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Max Lines", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v47DanmakuMaxLines = value
        AppToast.show(this, "Danmaku Max Lines: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV47CacheMaxSizeMbDialog() {
    ...
    showSettingsChoiceDialog(title = "Cache Max Size Mb", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v47CacheMaxSizeMb = value
        AppToast.show(this, "Cache Max Size Mb: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV47ColorTintDialog() {
    ...
    showSettingsChoiceDialog(title = "Color Tint", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v47ColorTint = value
        AppToast.show(this, "Color Tint: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV47VolumeChannelBalanceDialog() {
    ...
    showSettingsChoiceDialog(title = "Volume Channel Balance", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v47VolumeChannelBalance = value
        AppToast.show(this, "Volume Channel Balance: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV47DanmakuBgBorderColorDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Bg Border Color", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v47DanmakuBgBorderColor = value
        AppToast.show(this, "Danmaku Bg Border Color: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV48DanmakuFontLineHeightDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Font Line Height", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v48DanmakuFontLineHeight = value
        AppToast.show(this, "Danmaku Font Line Height: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV48ColorBlackLevelDialog() {
    ...
    showSettingsChoiceDialog(title = "Color Black Level", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v48ColorBlackLevel = value
        AppToast.show(this, "Color Black Level: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV48VolumeBassBoostDialog() {
    ...
    showSettingsChoiceDialog(title = "Volume Bass Boost", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v48VolumeBassBoost = value
        AppToast.show(this, "Volume Bass Boost: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV48DanmakuSendMaxLengthDialog() {
    ...
    val labels =
        listOf("20", "30", "40", "50", "60", "70", "80", "90", "100", "110", "120", "130", "140", "150", "160", "170", "180", "190", "200")
    val currentIndex = options.indexOf(BiliClient.prefs.v48DanmakuSendMaxLength).takeIf { it >= 0 } ?: 0
    showSettingsChoiceDialog(title = "Danmaku Send Max Length", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v48DanmakuSendMaxLength = value
        AppToast.show(this, "Danmaku Send Max Length: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV48CacheCleanupIntervalDialog() {
    ...
    showSettingsChoiceDialog(title = "Cache Cleanup Interval", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v48CacheCleanupInterval = value
        AppToast.show(this, "Cache Cleanup Interval: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV48ProgressBarTouchAreaDialog() {
    ...
    showSettingsChoiceDialog(title = "Progress Bar Touch Area", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v48ProgressBarTouchArea = value
        AppToast.show(this, "Progress Bar Touch Area: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV48ColorWhiteLevelDialog() {
    ...
    showSettingsChoiceDialog(title = "Color White Level", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v48ColorWhiteLevel = value
        AppToast.show(this, "Color White Level: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV48VolumeVirtualizerDialog() {
    ...
    showSettingsChoiceDialog(title = "Volume Virtualizer", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v48VolumeVirtualizer = value
        AppToast.show(this, "Volume Virtualizer: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV48DanmakuBgShadowSizeDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Bg Shadow Size", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v48DanmakuBgShadowSize = value
        AppToast.show(this, "Danmaku Bg Shadow Size: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV48CastMirrorQualityDialog() {
    ...
    showSettingsChoiceDialog(title = "Cast Mirror Quality", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v48CastMirrorQuality = value
        AppToast.show(this, "Cast Mirror Quality: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV49DanmakuFontLetterSpacingDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Font Letter Spacing", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v49DanmakuFontLetterSpacing = value
        AppToast.show(this, "Danmaku Font Letter Spacing: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV49ColorHighlightRecoveryDialog() {
    ...
    showSettingsChoiceDialog(title = "Color Highlight Recovery", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v49ColorHighlightRecovery = value
        AppToast.show(this, "Color Highlight Recovery: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV49VolumeTrebleBoostDialog() {
    ...
    showSettingsChoiceDialog(title = "Volume Treble Boost", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v49VolumeTrebleBoost = value
        AppToast.show(this, "Volume Treble Boost: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV49DanmakuSendFontSizeDialog() {
    ...
    showSettingsChoiceDialog(title = "Danmaku Send Font Size", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v49DanmakuSendFontSize = value
        AppToast.show(this, "Danmaku Send Font Size: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV49CastAudioSyncDialog() {
    ...
    showSettingsChoiceDialog(title = "Cast Audio Sync", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v49CastAudioSync = value
        AppToast.show(this, "Cast Audio Sync: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV49GestureLongPressActionDialog() {
    ...
    showSettingsChoiceDialog(title = "Gesture Long Press Action", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v49GestureLongPressAction = value
        AppToast.show(this, "Gesture Long Press Action: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV49CacheAutoCleanupThresholdDialog() {
    ...
    showSettingsChoiceDialog(title = "Cache Auto Cleanup Threshold", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v49CacheAutoCleanupThreshold = value
        AppToast.show(this, "Cache Auto Cleanup Threshold: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV49ColorShadowRecoveryDialog() {
    ...
    showSettingsChoiceDialog(title = "Color Shadow Recovery", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v49ColorShadowRecovery = value
        AppToast.show(this, "Color Shadow Recovery: ${labels[options.indexOf(value)]}")
    }
}
...
internal fun PlayerActivity.showV49VolumeReplayGainDialog() {
    ...
    showSettingsChoiceDialog(title = "Volume Replay Gain", options = options, checkedIndex = currentIndex, label = { v ->
        labels[options.indexOf(v)]
    }) { value ->
        BiliClient.prefs.v49VolumeReplayGain = value
        AppToast.show(this, "Volume Replay Gain: ${labels[options.indexOf(value)]}")
    }
}
