...
class SponsorSubmitThumbnailStripView
    @JvmOverloads
    constructor(
        context: Context,
        ...
        private fun childCenterX(child: View): Float = (thumbnailLayoutManager.getDecoratedLeft(child) + thumbnailLayoutManager.getDecoratedRight(child)) / 2f
...
private class SponsorSubmitThumbnailAdapter(
    ...
    class Vh(
        private val view: SponsorSubmitThumbnailItemView,
...
private class SponsorSubmitThumbnailItemView(
    context: Context,
) : View(context) {
...
class SponsorSubmitTimelineView
    @JvmOverloads
    constructor(
        context: Context,
        attrs: AttributeSet? = null,
        ...
        private fun movedPastTouchSlop(
            x: Float,
            y: Float,
        ): Boolean = abs(x - touchDownX) > touchSlopPx || abs(y - touchDownY) > touchSlopPx
        ...
        private fun drawCompleteRanges(
            canvas: Canvas,
            left: Float,
            right: Float,
            centerY: Float,
