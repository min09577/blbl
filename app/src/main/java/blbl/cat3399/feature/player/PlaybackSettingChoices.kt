...
internal object PlaybackSettingChoices {
    ...
    val danmakuFontWeights: List<DanmakuFontWeight> = listOf(
        DanmakuFontWeight.Normal, DanmakuFontWeight.Bold,
        DanmakuFontWeight.SerifNormal, DanmakuFontWeight.SerifBold,
        DanmakuFontWeight.MonospaceNormal, DanmakuFontWeight.MonospaceBold
    )
    val danmakuLaneDensities: List<DanmakuLaneDensity> =
        listOf(DanmakuLaneDensity.VerySparse, DanmakuLaneDensity.Sparse, DanmakuLaneDensity.Standard, DanmakuLaneDensity.Dense, DanmakuLaneDensity.VeryDense)
