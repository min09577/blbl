...
enum class VideoFilterPreset(val label: String, val matrix: FloatArray) {
    NONE("无滤镜", floatArrayOf(
        1f, 0f, 0f, 0f, 0f,
        0f, 1f, 0f, 0f, 0f,
        0f, 0f, 1f, 0f, 0f,
        0f, 0f, 0f, 1f, 0f
    )),
    VINTAGE("复古", floatArrayOf(
        0.6f, 0.3f, 0.1f, 0f, 20f,
        0.2f, 0.7f, 0.1f, 0f, 10f,
        0.1f, 0.2f, 0.5f, 0f, 30f,
        0f, 0f, 0f, 1f, 0f
    )),
    GRAYSCALE("黑白", floatArrayOf(
        0.3f, 0.3f, 0.3f, 0f, 0f,
        0.3f, 0.3f, 0.3f, 0f, 0f,
        0.3f, 0.3f, 0.3f, 0f, 0f,
        0f, 0f, 0f, 1f, 0f
    )),
    SEPIA("怀旧", floatArrayOf(
        0.39f, 0.77f, 0.19f, 0f, 0f,
        0.35f, 0.69f, 0.17f, 0f, 0f,
        0.27f, 0.53f, 0.13f, 0f, 0f,
        0f, 0f, 0f, 1f, 0f
    )),
    HIGH_CONTRAST("高对比度", floatArrayOf(
        1.5f, 0f, 0f, 0f, -50f,
        0f, 1.5f, 0f, 0f, -50f,
        0f, 0f, 1.5f, 0f, -50f,
        0f, 0f, 0f, 1f, 0f
    )),
    COOL("冷色调", floatArrayOf(
        0.8f, 0f, 0f, 0f, 0f,
        0f, 0.9f, 0f, 0f, 0f,
        0f, 0f, 1.2f, 0f, 20f,
        0f, 0f, 0f, 1f, 0f
    )),
    WARM("暖色调", floatArrayOf(
        1.2f, 0f, 0f, 0f, 20f,
        0f, 1.0f, 0f, 0f, 0f,
        0f, 0f, 0.8f, 0f, 0f,
        0f, 0f, 0f, 1f, 0f
    )),
    VIVID("鲜艳", floatArrayOf(
        1.3f, 0f, 0f, 0f, 0f,
        0f, 1.3f, 0f, 0f, 0f,
        0f, 0f, 1.3f, 0f, 0f,
        0f, 0f, 0f, 1f, 0f
