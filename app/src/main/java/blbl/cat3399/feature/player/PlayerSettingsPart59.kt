...
// v771: curve mode
internal fun PlayerActivity.showV771CurveToggle() {
    val current = FeaturePrefsStore.batch771.v771curve
    FeaturePrefsStore.batch771.v771curve = !current
...
// v771: date level
internal fun PlayerActivity.showV771DateDialog() {
    val options = listOf(0, 1, 2, 3)
    val currentIndex = options.indexOf(FeaturePrefsStore.batch771.v771date).takeIf { it >= 0 } ?: 0
    showSettingsChoiceDialog(
        ...
        FeaturePrefsStore.batch771.v771date = value
        AppToast.show(this, "date: $value")
    }
}
...
// v771: default mode
internal fun PlayerActivity.showV771DefaultToggle() {
    val current = FeaturePrefsStore.batch771.v771default
    FeaturePrefsStore.batch771.v771default = !current
    AppToast.show(this, "default: ${if (!current) "ON" else "OFF"}")
}
...
// v772: curve mode
internal fun PlayerActivity.showV772CurveToggle() {
    val current = FeaturePrefsStore.batch771.v772curve
    FeaturePrefsStore.batch771.v772curve = !current
    AppToast.show(this, "curve: ${if (!current) "ON" else "OFF"}")
}
...
// v772: date level
internal fun PlayerActivity.showV772DateDialog() {
    val options = listOf(0, 1, 2, 3)
    val currentIndex = options.indexOf(FeaturePrefsStore.batch771.v772date).takeIf { it >= 0 } ?: 0
    showSettingsChoiceDialog(
        title = "date level",
        options = options,
        checkedIndex = currentIndex,
        ...
        FeaturePrefsStore.batch771.v772date = value
        AppToast.show(this, "date: $value")
    }
}
...
// v772: default mode
internal fun PlayerActivity.showV772DefaultToggle() {
    val current = FeaturePrefsStore.batch771.v772default
    FeaturePrefsStore.batch771.v772default = !current
    AppToast.show(this, "default: ${if (!current) "ON" else "OFF"}")
}
...
// v773: curve mode
internal fun PlayerActivity.showV773CurveToggle() {
    val current = FeaturePrefsStore.batch771.v773curve
    FeaturePrefsStore.batch771.v773curve = !current
    AppToast.show(this, "curve: ${if (!current) "ON" else "OFF"}")
}
...
// v773: date level
internal fun PlayerActivity.showV773DateDialog() {
    val options = listOf(0, 1, 2, 3)
    val currentIndex = options.indexOf(FeaturePrefsStore.batch771.v773date).takeIf { it >= 0 } ?: 0
    showSettingsChoiceDialog(
        title = "date level",
        options = options,
        checkedIndex = currentIndex,
        ...
        FeaturePrefsStore.batch771.v773date = value
        AppToast.show(this, "date: $value")
    }
}
...
// v773: default mode
internal fun PlayerActivity.showV773DefaultToggle() {
    val current = FeaturePrefsStore.batch771.v773default
    FeaturePrefsStore.batch771.v773default = !current
    AppToast.show(this, "default: ${if (!current) "ON" else "OFF"}")
}
...
// v774: curve mode
internal fun PlayerActivity.showV774CurveToggle() {
    val current = FeaturePrefsStore.batch771.v774curve
    FeaturePrefsStore.batch771.v774curve = !current
    AppToast.show(this, "curve: ${if (!current) "ON" else "OFF"}")
}
...
// v774: date level
internal fun PlayerActivity.showV774DateDialog() {
    val options = listOf(0, 1, 2, 3)
    val currentIndex = options.indexOf(FeaturePrefsStore.batch771.v774date).takeIf { it >= 0 } ?: 0
    showSettingsChoiceDialog(
        title = "date level",
        options = options,
        checkedIndex = currentIndex,
        ...
        FeaturePrefsStore.batch771.v774date = value
        AppToast.show(this, "date: $value")
    }
}
...
// v774: default mode
internal fun PlayerActivity.showV774DefaultToggle() {
    val current = FeaturePrefsStore.batch771.v774default
    FeaturePrefsStore.batch771.v774default = !current
    AppToast.show(this, "default: ${if (!current) "ON" else "OFF"}")
}
...
// v775: curve mode
internal fun PlayerActivity.showV775CurveToggle() {
    val current = FeaturePrefsStore.batch771.v775curve
    FeaturePrefsStore.batch771.v775curve = !current
    AppToast.show(this, "curve: ${if (!current) "ON" else "OFF"}")
}
...
// v775: date level
internal fun PlayerActivity.showV775DateDialog() {
    val options = listOf(0, 1, 2, 3)
    val currentIndex = options.indexOf(FeaturePrefsStore.batch771.v775date).takeIf { it >= 0 } ?: 0
    showSettingsChoiceDialog(
        title = "date level",
        options = options,
        checkedIndex = currentIndex,
        ...
        FeaturePrefsStore.batch771.v775date = value
        AppToast.show(this, "date: $value")
    }
}
...
// v775: default mode
internal fun PlayerActivity.showV775DefaultToggle() {
    val current = FeaturePrefsStore.batch771.v775default
    FeaturePrefsStore.batch771.v775default = !current
    AppToast.show(this, "default: ${if (!current) "ON" else "OFF"}")
}
...
// v776: curve mode
internal fun PlayerActivity.showV776CurveToggle() {
    val current = FeaturePrefsStore.batch771.v776curve
    FeaturePrefsStore.batch771.v776curve = !current
    AppToast.show(this, "curve: ${if (!current) "ON" else "OFF"}")
}
...
// v776: date level
internal fun PlayerActivity.showV776DateDialog() {
    val options = listOf(0, 1, 2, 3)
    val currentIndex = options.indexOf(FeaturePrefsStore.batch771.v776date).takeIf { it >= 0 } ?: 0
    showSettingsChoiceDialog(
        title = "date level",
        options = options,
        checkedIndex = currentIndex,
        ...
        FeaturePrefsStore.batch771.v776date = value
        AppToast.show(this, "date: $value")
    }
}
...
// v776: default mode
internal fun PlayerActivity.showV776DefaultToggle() {
    val current = FeaturePrefsStore.batch771.v776default
    FeaturePrefsStore.batch771.v776default = !current
    AppToast.show(this, "default: ${if (!current) "ON" else "OFF"}")
}
...
// v777: curve mode
internal fun PlayerActivity.showV777CurveToggle() {
    val current = FeaturePrefsStore.batch771.v777curve
    FeaturePrefsStore.batch771.v777curve = !current
    AppToast.show(this, "curve: ${if (!current) "ON" else "OFF"}")
}
...
// v777: date level
internal fun PlayerActivity.showV777DateDialog() {
    val options = listOf(0, 1, 2, 3)
    val currentIndex = options.indexOf(FeaturePrefsStore.batch771.v777date).takeIf { it >= 0 } ?: 0
    showSettingsChoiceDialog(
        title = "date level",
        options = options,
        checkedIndex = currentIndex,
        ...
        FeaturePrefsStore.batch771.v777date = value
        AppToast.show(this, "date: $value")
    }
}
...
// v777: default mode
internal fun PlayerActivity.showV777DefaultToggle() {
    val current = FeaturePrefsStore.batch771.v777default
    FeaturePrefsStore.batch771.v777default = !current
    AppToast.show(this, "default: ${if (!current) "ON" else "OFF"}")
}
...
// v778: curve mode
internal fun PlayerActivity.showV778CurveToggle() {
    val current = FeaturePrefsStore.batch771.v778curve
    FeaturePrefsStore.batch771.v778curve = !current
    AppToast.show(this, "curve: ${if (!current) "ON" else "OFF"}")
}
...
// v778: date level
internal fun PlayerActivity.showV778DateDialog() {
    val options = listOf(0, 1, 2, 3)
    val currentIndex = options.indexOf(FeaturePrefsStore.batch771.v778date).takeIf { it >= 0 } ?: 0
    showSettingsChoiceDialog(
        title = "date level",
        options = options,
        checkedIndex = currentIndex,
        ...
        FeaturePrefsStore.batch771.v778date = value
        AppToast.show(this, "date: $value")
    }
}
...
// v778: default mode
internal fun PlayerActivity.showV778DefaultToggle() {
    val current = FeaturePrefsStore.batch771.v778default
    FeaturePrefsStore.batch771.v778default = !current
    AppToast.show(this, "default: ${if (!current) "ON" else "OFF"}")
}
...
// v779: curve mode
internal fun PlayerActivity.showV779CurveToggle() {
    val current = FeaturePrefsStore.batch771.v779curve
    FeaturePrefsStore.batch771.v779curve = !current
    AppToast.show(this, "curve: ${if (!current) "ON" else "OFF"}")
}
...
// v779: date level
internal fun PlayerActivity.showV779DateDialog() {
    val options = listOf(0, 1, 2, 3)
    val currentIndex = options.indexOf(FeaturePrefsStore.batch771.v779date).takeIf { it >= 0 } ?: 0
    showSettingsChoiceDialog(
        title = "date level",
        options = options,
        checkedIndex = currentIndex,
        ...
        FeaturePrefsStore.batch771.v779date = value
        AppToast.show(this, "date: $value")
    }
}
...
// v779: default mode
internal fun PlayerActivity.showV779DefaultToggle() {
    val current = FeaturePrefsStore.batch771.v779default
    FeaturePrefsStore.batch771.v779default = !current
    AppToast.show(this, "default: ${if (!current) "ON" else "OFF"}")
}
...
// v780: curve mode
internal fun PlayerActivity.showV780CurveToggle() {
    val current = FeaturePrefsStore.batch771.v780curve
    FeaturePrefsStore.batch771.v780curve = !current
    AppToast.show(this, "curve: ${if (!current) "ON" else "OFF"}")
}
...
// v780: date level
internal fun PlayerActivity.showV780DateDialog() {
    val options = listOf(0, 1, 2, 3)
    val currentIndex = options.indexOf(FeaturePrefsStore.batch771.v780date).takeIf { it >= 0 } ?: 0
    showSettingsChoiceDialog(
        title = "date level",
        options = options,
        checkedIndex = currentIndex,
        ...
        FeaturePrefsStore.batch771.v780date = value
        AppToast.show(this, "date: $value")
    }
}
...
// v780: default mode
internal fun PlayerActivity.showV780DefaultToggle() {
    val current = FeaturePrefsStore.batch771.v780default
    FeaturePrefsStore.batch771.v780default = !current
    AppToast.show(this, "default: ${if (!current) "ON" else "OFF"}")
}
