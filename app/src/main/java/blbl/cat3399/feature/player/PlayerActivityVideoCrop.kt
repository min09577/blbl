...
internal fun PlayerActivity.showVideoCropDialog() {
    ...
    val leftLabel = TextView(this).apply { text = "左边距: ${cropLeft}%"; textSize = 14f }
    val leftSlider = SeekBar(this).apply { max = 50; progress = cropLeft }
    val topLabel = TextView(this).apply { text = "上边距: ${cropTop}%"; textSize = 14f; setPadding(0, 16, 0, 0) }
    val topSlider = SeekBar(this).apply { max = 50; progress = cropTop }
    val rightLabel = TextView(this).apply { text = "右边距: ${cropRight}%"; textSize = 14f; setPadding(0, 16, 0, 0) }
    val rightSlider = SeekBar(this).apply { max = 50; progress = cropRight }
    val bottomLabel = TextView(this).apply { text = "下边距: ${cropBottom}%"; textSize = 14f; setPadding(0, 16, 0, 0) }
    val bottomSlider = SeekBar(this).apply { max = 50; progress = cropBottom }
    
    layout.addView(leftLabel); layout.addView(leftSlider)
    layout.addView(topLabel); layout.addView(topSlider)
    layout.addView(rightLabel); layout.addView(rightSlider)
    layout.addView(bottomLabel); layout.addView(bottomSlider)
