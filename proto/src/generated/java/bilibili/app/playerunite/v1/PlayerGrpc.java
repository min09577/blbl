...
public final class PlayerGrpc {
   ...
   */
  public static PlayerBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PlayerBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<PlayerBlockingV2Stub>() {
        @java.lang.Override
        public PlayerBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new PlayerBlockingV2Stub(channel, callOptions);
        }
      };
    return PlayerBlockingV2Stub.newStub(factory, channel);
  }
   ...
   * </pre>
   */
  public static final class PlayerBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<PlayerBlockingV2Stub> {
    private PlayerBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected PlayerBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new PlayerBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service Player.
   * <pre>
   * 统一视频url
   * </pre>
   */
