...
public final class PlayURLGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.pgc.gateway.player.v2.PlayViewReq,
      bilibili.pgc.gateway.player.v2.PlayViewReply> getPlayViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PlayView",
      requestType = bilibili.pgc.gateway.player.v2.PlayViewReq.class,
      responseType = bilibili.pgc.gateway.player.v2.PlayViewReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.pgc.gateway.player.v2.PlayViewReq,
      bilibili.pgc.gateway.player.v2.PlayViewReply> getPlayViewMethod() {
    io.grpc.MethodDescriptor<bilibili.pgc.gateway.player.v2.PlayViewReq, bilibili.pgc.gateway.player.v2.PlayViewReply> getPlayViewMethod;
      ...
      synchronized (PlayURLGrpc.class) {
        if ((getPlayViewMethod = PlayURLGrpc.getPlayViewMethod) == null) {
          PlayURLGrpc.getPlayViewMethod = getPlayViewMethod =
              io.grpc.MethodDescriptor.<bilibili.pgc.gateway.player.v2.PlayViewReq, bilibili.pgc.gateway.player.v2.PlayViewReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PlayView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  bilibili.pgc.gateway.player.v2.PlayViewReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  bilibili.pgc.gateway.player.v2.PlayViewReply.getDefaultInstance()))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.pgc.gateway.player.v2.PlayViewReq,
      bilibili.pgc.gateway.player.v2.PlayViewReply> getPlayViewComicMethod;
  ...
  public static io.grpc.MethodDescriptor<bilibili.pgc.gateway.player.v2.PlayViewReq,
      bilibili.pgc.gateway.player.v2.PlayViewReply> getPlayViewComicMethod() {
    io.grpc.MethodDescriptor<bilibili.pgc.gateway.player.v2.PlayViewReq, bilibili.pgc.gateway.player.v2.PlayViewReply> getPlayViewComicMethod;
   ...
   */
  public static PlayURLBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PlayURLBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<PlayURLBlockingV2Stub>() {
        @java.lang.Override
        public PlayURLBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new PlayURLBlockingV2Stub(channel, callOptions);
        }
      };
    return PlayURLBlockingV2Stub.newStub(factory, channel);
  }
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void playView(bilibili.pgc.gateway.player.v2.PlayViewReq request,
        io.grpc.stub.StreamObserver<bilibili.pgc.gateway.player.v2.PlayViewReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getPlayViewMethod(), responseObserver);
    }

    /**
     */
    default void playViewComic(bilibili.pgc.gateway.player.v2.PlayViewReq request,
        io.grpc.stub.StreamObserver<bilibili.pgc.gateway.player.v2.PlayViewReply> responseObserver) {
  ...
  public static final class PlayURLStub
     ...
     * </pre>
     */
    public void playView(bilibili.pgc.gateway.player.v2.PlayViewReq request,
        io.grpc.stub.StreamObserver<bilibili.pgc.gateway.player.v2.PlayViewReply> responseObserver) {
    ...
    /**
     */
    public void playViewComic(bilibili.pgc.gateway.player.v2.PlayViewReq request,
        io.grpc.stub.StreamObserver<bilibili.pgc.gateway.player.v2.PlayViewReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
   ...
   * </pre>
   */
  public static final class PlayURLBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<PlayURLBlockingV2Stub> {
    private PlayURLBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected PlayURLBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new PlayURLBlockingV2Stub(channel, callOptions);
    }
     ...
     * </pre>
     */
    public bilibili.pgc.gateway.player.v2.PlayViewReply playView(bilibili.pgc.gateway.player.v2.PlayViewReq request) {
    ...
    /**
     */
    public bilibili.pgc.gateway.player.v2.PlayViewReply playViewComic(bilibili.pgc.gateway.player.v2.PlayViewReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service PlayURL.
   * <pre>
   * 视频url
   * </pre>
   */
  ...
  public static final class PlayURLFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.pgc.gateway.player.v2.PlayViewReply> playView(
        bilibili.pgc.gateway.player.v2.PlayViewReq request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.pgc.gateway.player.v2.PlayViewReply> playViewComic(
        bilibili.pgc.gateway.player.v2.PlayViewReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PLAY_VIEW:
          serviceImpl.playView((bilibili.pgc.gateway.player.v2.PlayViewReq) request,
              (io.grpc.stub.StreamObserver<bilibili.pgc.gateway.player.v2.PlayViewReply>) responseObserver);
          break;
        case METHODID_PLAY_VIEW_COMIC:
          serviceImpl.playViewComic((bilibili.pgc.gateway.player.v2.PlayViewReq) request,
              (io.grpc.stub.StreamObserver<bilibili.pgc.gateway.player.v2.PlayViewReply>) responseObserver);
          break;
        default:
