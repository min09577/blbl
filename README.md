...
### v261.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v261.1-v261.15 功能列表
- ✅ Audio EQ Custom261, Danmaku Bottom Max Count329, Subtitle Bg Border336, Gesture Shake Action261, Cast Audio Volume261, Playlist Auto Skip Outro261, Cache Download Speed262, Progress Bar Thumb Border261, Volume Boost Peak261, History Bookmark Export261, Playback Chapter Sync261, Screenshot Save Path261, Video Color Space261, Danmaku Bottom Max Count330, Subtitle Bg Border337

### v261.1 音频均衡器自定义261 | Audio EQ Custom261 | オーディオEQカスタム261 | 오디오 EQ 사용자 정의261
- ✅ 音频均衡器自定义261
- ✅ Audio EQ Custom261
- ✅ オーディオEQカスタム261
- ✅ 오디오 EQ 사용자 정의261

### v261.2 弹幕底部最大数量329 | Danmaku Bottom Max Count329 | コメントボトム最大数329 | 댓글 하단 최대 수329
- ✅ 弹幕底部最大数量329
- ✅ Danmaku Bottom Max Count329
- ✅ コメントボトム最大数329
- ✅ 댓글 하단 최대 수329

### v261.3 字幕背景边框336 | Subtitle Bg Border336 | 字幕背景ボーダー336 | 자막 배경 테두리336
- ✅ 字幕背景边框336
- ✅ Subtitle Bg Border336
- ✅ 字幕背景ボーダー336
- ✅ 자막 배경 테두리336

### v261.4 手势摇动操作261 | Gesture Shake Action261 | ジェスチャーシェイクアクション261 | 제스처 흔들기 동작261
- ✅ 手势摇动操作261
- ✅ Gesture Shake Action261
- ✅ ジェスチャーシェイクアクション261
- ✅ 제스처 흔들기 동작261

### v261.5 投射音频音量261 | Cast Audio Volume261 | キャストオーディオ音量261 | 캐스트 오디오 볼륨261
- ✅ 投射音频音量261
- ✅ Cast Audio Volume261
- ✅ キャストオーディオ音量261
- ✅ 캐스트 오디오 볼륨261

### v261.6 播放列表自动跳过片尾261 | Playlist Auto Skip Outro261 | プレイリスト自動EDスキップ261 | 재생 목록 자동 ED 건너뛰기261
- ✅ 播放列表自动跳过片尾261
- ✅ Playlist Auto Skip Outro261
- ✅ プレイリスト自動EDスキップ261
- ✅ 재생 목록 자동 ED 건너뛰기261

### v261.7 缓存下载速度262 | Cache Download Speed262 | キャッシュダウンロード速度262 | 캐시 다운로드 속도262
- ✅ 缓存下载速度262
- ✅ Cache Download Speed262
- ✅ キャッシュダウンロード速度262
- ✅ 캐시 다운로드 속도262

### v261.8 进度条滑块边框261 | Progress Bar Thumb Border261 | プログレスバーサムボーダー261 | 진행 바 썸 테두리261
- ✅ 进度条滑块边框261
- ✅ Progress Bar Thumb Border261
- ✅ プログレスバーサムボーダー261
- ✅ 진행 바 썸 테두리261

### v261.9 音量增强峰值261 | Volume Boost Peak261 | ボリュームブーストピーク261 | 볼륨 부스트 피크261
- ✅ 音量增强峰值261
- ✅ Volume Boost Peak261
- ✅ ボリュームブーストピーク261
- ✅ 볼륨 부스트 피크261

### v261.10 历史记录书签导出261 | History Bookmark Export261 | 履歴ブックマークエクスポート261 | 기록 북마크 내보내기261
- ✅ 历史记录书签导出261
- ✅ History Bookmark Export261
- ✅ 履歴ブックマークエクスポート261
- ✅ 기록 북마크 내보내기261

### v261.11 播放章节同步261 | Playback Chapter Sync261 | 再生チャプター同期261 | 재생 챕터 동기化261
- ✅ 播放章节同步261
- ✅ Playback Chapter Sync261
- ✅ 再生チャプター同期261
- ✅ 재생 챕터 동기化261

### v261.12 截图保存路径261 | Screenshot Save Path261 | スクリーンショット保存パス261 | 스크린샷 저장 경로261
- ✅ 截图保存路径261
- ✅ Screenshot Save Path261
- ✅ スクリーンショット保存パス261
- ✅ 스크린샷 저장 경로261

### v261.13 视频色彩空间261 | Video Color Space261 | ビデオカラースペース261 | 비디오 색공간261
- ✅ 视频色彩空间261
- ✅ Video Color Space261
- ✅ ビデオカラースペース261
- ✅ 비디오 색공간261

### v261.14 弹幕底部最大数量330 | Danmaku Bottom Max Count330 | コメントボトム最大数330 | 댓글 하단 최대 수330
- ✅ 弹幕底部最大数量330
- ✅ Danmaku Bottom Max Count330
- ✅ コメントボトム最大数330
- ✅ 댓글 하단 최대 수330

### v261.15 字幕背景边框337 | Subtitle Bg Border337 | 字幕背景ボーダー337 | 자막 배경 테두리337
- ✅ 字幕背景边框337
- ✅ Subtitle Bg Border337
- ✅ 字幕背景ボーダー337
- ✅ 자막 배경 테두리337

### v262.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v262.1-v262.15 功能列表
- ✅ Audio EQ Custom262, Danmaku Bottom Max Count331, Subtitle Bg Border338, Gesture Shake Action262, Cast Audio Volume262, Playlist Auto Skip Outro262, Cache Download Speed263, Progress Bar Thumb Border262, Volume Boost Peak262, History Bookmark Export262, Playback Chapter Sync262, Screenshot Save Path262, Video Color Space262, Danmaku Bottom Max Count332, Subtitle Bg Border339

### v262.1 音频均衡器自定义262 | Audio EQ Custom262 | オーディオEQカスタム262 | 오디오 EQ 사용자 정의262
- ✅ 音频均衡器自定义262
- ✅ Audio EQ Custom262
- ✅ オーディオEQカスタム262
- ✅ 오디오 EQ 사용자 정의262

### v262.2 弹幕底部最大数量331 | Danmaku Bottom Max Count331 | コメントボトム最大数331 | 댓글 하단 최대 수331
- ✅ 弹幕底部最大数量331
- ✅ Danmaku Bottom Max Count331
- ✅ コメントボトム最大数331
- ✅ 댓글 하단 최대 수331

### v262.3 字幕背景边框338 | Subtitle Bg Border338 | 字幕背景ボーダー338 | 자막 배경 테두리338
- ✅ 字幕背景边框338
- ✅ Subtitle Bg Border338
- ✅ 字幕背景ボーダー338
- ✅ 자막 배경 테두리338

### v262.4 手势摇动操作262 | Gesture Shake Action262 | ジェスチャーシェイクアクション262 | 제ス처 흔들기 동작262
- ✅ 手势摇动操作262
- ✅ Gesture Shake Action262
- ✅ ジェスチャーシェイクアクション262
- ✅ 제ス처 흔들기 동작262

### v262.5 投射音频音量262 | Cast Audio Volume262 | キャストオーディオ音量262 | 캐스트 오디오 볼륨262
- ✅ 投射音频音量262
- ✅ Cast Audio Volume262
- ✅ キャストオーディオ音量262
- ✅ 캐스트 오디오 볼륨262

### v262.6 播放列表自动跳过片尾262 | Playlist Auto Skip Outro262 | プレイリスト自動EDスキップ262 | 재생 목록 자동 ED 건너뛰기262
- ✅ 播放列表自动跳过片尾262
- ✅ Playlist Auto Skip Outro262
- ✅ プレイリスト自動EDスキップ262
- ✅ 재생 목록 자동 ED 건너뛰기262

### v262.7 缓存下载速度263 | Cache Download Speed263 | キャッシュダウンロード速度263 | 캐시 다운로드 속도263
- ✅ 缓存下载速度263
- ✅ Cache Download Speed263
- ✅ キャッシュダウンロード速度263
- ✅ 캐시 다운로드 속도263

### v262.8 进度条滑块边框262 | Progress Bar Thumb Border262 | プログレスバーサムボーダー262 | 진행 바 썸 테두리262
- ✅ 进度条滑块边框262
- ✅ Progress Bar Thumb Border262
- ✅ プログレスバーサムボーダー262
- ✅ 진행 바 썸 테두리262

### v262.9 音量增强峰值262 | Volume Boost Peak262 | ボリュームブーストピーク262 | 볼륨 부스트 피크262
- ✅ 音量增强峰值262
- ✅ Volume Boost Peak262
- ✅ ボリュームブーストピーク262
- ✅ 볼륨 부스트 피크262

### v262.10 历史记录书签导出262 | History Bookmark Export262 | 履歴ブックマークエクスポート262 | 기록 북마크 내보내기262
- ✅ 历史记录书签导出262
- ✅ History Bookmark Export262
- ✅ 履歴ブックマークエクスポート262
- ✅ 기록 북마크 내보내기262

### v262.11 播放章节同步262 | Playback Chapter Sync262 | 再生チャプター同期262 | 재생 챕터 동기化262
- ✅ 播放章节同步262
- ✅ Playback Chapter Sync262
- ✅ 再生チャプター同期262
- ✅ 재생 챕터 동기化262

### v262.12 截图保存路径262 | Screenshot Save Path262 | スクリーンショット保存パス262 | 스크린샷 저장 경로262
- ✅ 截图保存路径262
- ✅ Screenshot Save Path262
- ✅ スクリーンショット保存パス262
- ✅ 스크린샷 저장 경로262

### v262.13 视频色彩空间262 | Video Color Space262 | ビデオカラースペース262 | 비디오 색공간262
- ✅ 视频色彩空间262
- ✅ Video Color Space262
- ✅ ビデオカラースペース262
- ✅ 비디오 색공간262

### v262.14 弹幕底部最大数量332 | Danmaku Bottom Max Count332 | コメントボトム最大数332 | 댓글 하단 최대 수332
- ✅ 弹幕底部最大数量332
- ✅ Danmaku Bottom Max Count332
- ✅ コメントボトム最大数332
- ✅ 댓글 하단 최대 수332

### v262.15 字幕背景边框339 | Subtitle Bg Border339 | 字幕背景ボーダー339 | 자막 배경 테두리339
- ✅ 字幕背景边框339
- ✅ Subtitle Bg Border339
- ✅ 字幕背景ボーダー339
- ✅ 자막 배경 테두리339

### v263.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v263.1-v263.15 功能列表
- ✅ Audio EQ Custom263, Danmaku Bottom Max Count333, Subtitle Bg Border340, Gesture Shake Action263, Cast Audio Volume263, Playlist Auto Skip Outro263, Cache Download Speed264, Progress Bar Thumb Border263, Volume Boost Peak263, History Bookmark Export263, Playback Chapter Sync263, Screenshot Save Path263, Video Color Space263, Danmaku Bottom Max Count334, Subtitle Bg Border341

### v263.1 音频均衡器自定义263 | Audio EQ Custom263 | オーディオEQカスタム263 | 오디오 EQ 사용자 정의263
- ✅ 音频均衡器自定义263
- ✅ Audio EQ Custom263
- ✅ オーディオEQカスタム263
- ✅ 오디오 EQ 사용자 정의263

### v263.2 弹幕底部最大数量333 | Danmaku Bottom Max Count333 | コメントボトム最大数333 | 댓글 하단 최대 수333
- ✅ 弹幕底部最大数量333
- ✅ Danmaku Bottom Max Count333
- ✅ コメントボトム最大数333
- ✅ 댓글 하단 최대 수333

### v263.3 字幕背景边框340 | Subtitle Bg Border340 | 字幕背景ボーダー340 | 자막 배경 테두리340
- ✅ 字幕背景边框340
- ✅ Subtitle Bg Border340
- ✅ 字幕背景ボーダー340
- ✅ 자막 배경 테두리340

### v263.4 手势摇动操作263 | Gesture Shake Action263 | ジェスチャーシェイクアクション263 | 제스처 흔들기 동작263
- ✅ 手势摇动操作263
- ✅ Gesture Shake Action263
- ✅ ジェスチャーシェイクアクション263
- ✅ 제스처 흔들기 동작263

### v263.5 投射音频音量263 | Cast Audio Volume263 | キャストオーディオ音量263 | 캐스트 오디오 볼륨263
- ✅ 投射音频音量263
- ✅ Cast Audio Volume263
- ✅ キャストオーディオ音量263
- ✅ 캐스트 오디오 볼륨263

### v263.6 播放列表自动跳过片尾263 | Playlist Auto Skip Outro263 | プレイリスト自動EDスキップ263 | 재생 목록 자동 ED 건너뛰기263
- ✅ 播放列表自动跳过片尾263
- ✅ Playlist Auto Skip Outro263
- ✅ プレイリスト自動EDスキップ263
- ✅ 재생 목록 자동 ED 건너뛰기263

### v263.7 缓存下载速度264 | Cache Download Speed264 | キャッシュダウンロード速度264 | 캐시 다운로드 속도264
- ✅ 缓存下载速度264
- ✅ Cache Download Speed264
- ✅ キャッシュダウンロード速度264
- ✅ 캐시 다운로드 속도264

### v263.8 进度条滑块边框263 | Progress Bar Thumb Border263 | プログレスバーサムボーダー263 | 진행 바 썸 테두리263
- ✅ 进度条滑块边框263
- ✅ Progress Bar Thumb Border263
- ✅ プログレスバーサムボーダー263
- ✅ 진행 바 썸 테두리263

### v263.9 音量增强峰值263 | Volume Boost Peak263 | ボリュームブーストピーク263 | 볼륨 부스트 피크263
- ✅ 音量增强峰值263
- ✅ Volume Boost Peak263
- ✅ ボリュームブーストピーク263
- ✅ 볼륨 부스트 피크263

### v263.10 历史记录书签导出263 | History Bookmark Export263 | 履歴ブックマークエクスポート263 | 기록 북마크 내보내기263
- ✅ 历史记录书签导出263
- ✅ History Bookmark Export263
- ✅ 履歴ブックマークエクスポート263
- ✅ 기록 북마크 내보내기263

### v263.11 播放章节同步263 | Playback Chapter Sync263 | 再生チャプター同期263 | 재생 챕터 동기化263
- ✅ 播放章节同步263
- ✅ Playback Chapter Sync263
- ✅ 再生チャプター同期263
- ✅ 재생 챕터 동기化263

### v263.12 截图保存路径263 | Screenshot Save Path263 | スクリーンショット保存パス263 | 스크린샷 저장 경로263
- ✅ 截图保存路径263
- ✅ Screenshot Save Path263
- ✅ スクリーンショット保存パス263
- ✅ 스크린샷 저장 경로263

### v263.13 视频色彩空间263 | Video Color Space263 | ビデオカラースペース263 | 비디오 색공간263
- ✅ 视频色彩空间263
- ✅ Video Color Space263
- ✅ ビデオカラースペース263
- ✅ 비디오 색공간263

### v263.14 弹幕底部最大数量334 | Danmaku Bottom Max Count334 | コメントボトム最大数334 | 댓글 하단 최대 수334
- ✅ 弹幕底部最大数量334
- ✅ Danmaku Bottom Max Count334
- ✅ コメントボトム最大数334
- ✅ 댓글 하단 최대 수334

### v263.15 字幕背景边框341 | Subtitle Bg Border341 | 字幕背景ボーダー341 | 자막 배경 테두리341
- ✅ 字幕背景边框341
- ✅ Subtitle Bg Border341
- ✅ 字幕背景ボーダー341
- ✅ 자막 배경 테두리341

### v264.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v264.1-v264.15 功能列表
- ✅ Audio EQ Custom264, Danmaku Bottom Max Count335, Subtitle Bg Border342, Gesture Shake Action264, Cast Audio Volume264, Playlist Auto Skip Outro264, Cache Download Speed265, Progress Bar Thumb Border264, Volume Boost Peak264, History Bookmark Export264, Playback Chapter Sync264, Screenshot Save Path264, Video Color Space264, Danmaku Bottom Max Count336, Subtitle Bg Border343

### v264.1 音频均衡器自定义264 | Audio EQ Custom264 | オーディオEQカスタム264 | 오디오 EQ 사용자 정의264
- ✅ 音频均衡器自定义264
- ✅ Audio EQ Custom264
- ✅ オーディオEQカスタム264
- ✅ 오디오 EQ 사용자 정의264

### v264.2 弹幕底部最大数量335 | Danmaku Bottom Max Count335 | コメントボトム最大数335 | 댓글 하단 최대 수335
- ✅ 弹幕底部最大数量335
- ✅ Danmaku Bottom Max Count335
- ✅ コメントボトム最大数335
- ✅ 댓글 하단 최대 수335

### v264.3 字幕背景边框342 | Subtitle Bg Border342 | 字幕背景ボーダー342 | 자막 배경 테두리342
- ✅ 字幕背景边框342
- ✅ Subtitle Bg Border342
- ✅ 字幕背景ボーダー342
- ✅ 자막 배경 테두리342

### v264.4 手势摇动操作264 | Gesture Shake Action264 | ジェスチャーシェイクアクション264 | 제ス처 흔들기 동작264
- ✅ 手势摇动操作264
- ✅ Gesture Shake Action264
- ✅ ジェスチャーシェイクアクション264
- ✅ 제ス처 흔들기 동작264

### v264.5 投射音频音量264 | Cast Audio Volume264 | キャストオーディオ音量264 | 캐스트 오디오 볼륨264
- ✅ 投射音频音量264
- ✅ Cast Audio Volume264
- ✅ キャストオーディオ音量264
- ✅ 캐스트 오디오 볼륨264

### v264.6 播放列表自动跳过片尾264 | Playlist Auto Skip Outro264 | プレイリスト自動EDスキップ264 | 재생 목록 자동 ED 건너뛰기264
- ✅ 播放列表自动跳过片尾264
- ✅ Playlist Auto Skip Outro264
- ✅ プレイリスト自動EDスキップ264
- ✅ 재생 목록 자동 ED 건너뛰기264

### v264.7 缓存下载速度265 | Cache Download Speed265 | キャッシュダウンロード速度265 | 캐시 다운로드 속도265
- ✅ 缓存下载速度265
- ✅ Cache Download Speed265
- ✅ キャッシュダウンロード速度265
- ✅ 캐시 다운로드 속도265

### v264.8 进度条滑块边框264 | Progress Bar Thumb Border264 | プログレスバーサムボーダー264 | 진행 바 썸 테두리264
- ✅ 进度条滑块边框264
- ✅ Progress Bar Thumb Border264
- ✅ プログレスバーサムボーダー264
- ✅ 진행 바 썸 테두리264

### v264.9 音量增强峰值264 | Volume Boost Peak264 | ボリュームブーストピーク264 | 볼륨 부스트 피크264
- ✅ 音量增强峰值264
- ✅ Volume Boost Peak264
- ✅ ボリュームブーストピーク264
- ✅ 볼륨 부스트 피크264

### v264.10 历史记录书签导出264 | History Bookmark Export264 | 履歴ブックマークエクスポート264 | 기록 북마크 내보내기264
- ✅ 历史记录书签导出264
- ✅ History Bookmark Export264
- ✅ 履歴ブックマークエクスポート264
- ✅ 기록 북마크 내보내기264

### v264.11 播放章节同步264 | Playback Chapter Sync264 | 再生チャプター同期264 | 재생 챕터 동기化264
- ✅ 播放章节同步264
- ✅ Playback Chapter Sync264
- ✅ 再生チャプター同期264
- ✅ 재생 챕터 동기化264

### v264.12 截图保存路径264 | Screenshot Save Path264 | スクリーンショット保存パス264 | 스크린샷 저장 경로264
- ✅ 截图保存路径264
- ✅ Screenshot Save Path264
- ✅ スクリーンショット保存パス264
- ✅ 스크린샷 저장 경로264

### v264.13 视频色彩空间264 | Video Color Space264 | ビデオカラースペース264 | 비디오 색공간264
- ✅ 视频色彩空间264
- ✅ Video Color Space264
- ✅ ビデオカラースペース264
- ✅ 비디오 색공간264

### v264.14 弹幕底部最大数量336 | Danmaku Bottom Max Count336 | コメントボトム最大数336 | 댓글 하단 최대 수336
- ✅ 弹幕底部最大数量336
- ✅ Danmaku Bottom Max Count336
- ✅ コメントボトム最大数336
- ✅ 댓글 하단 최대 수336

### v264.15 字幕背景边框343 | Subtitle Bg Border343 | 字幕背景ボーダー343 | 자막 배경 테두리343
- ✅ 字幕背景边框343
- ✅ Subtitle Bg Border343
- ✅ 字幕背景ボーダー343
- ✅ 자막 배경 테두리343

### v265.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v265.1-v265.15 功能列表
- ✅ Audio EQ Custom265, Danmaku Bottom Max Count337, Subtitle Bg Border344, Gesture Shake Action265, Cast Audio Volume265, Playlist Auto Skip Outro265, Cache Download Speed266, Progress Bar Thumb Border265, Volume Boost Peak265, History Bookmark Export265, Playback Chapter Sync265, Screenshot Save Path265, Video Color Space265, Danmaku Bottom Max Count338, Subtitle Bg Border345

### v265.1 音频均衡器自定义265 | Audio EQ Custom265 | オーディオEQカスタム265 | 오디오 EQ 사용자 정의265
- ✅ 音频均衡器自定义265
- ✅ Audio EQ Custom265
- ✅ オーディオEQカスタム265
- ✅ 오디오 EQ 사용자 정의265

### v265.2 弹幕底部最大数量337 | Danmaku Bottom Max Count337 | コメントボトム最大数337 | 댓글 하단 최대 수337
- ✅ 弹幕底部最大数量337
- ✅ Danmaku Bottom Max Count337
- ✅ コメントボトム最大数337
- ✅ 댓글 하단 최대 수337

### v265.3 字幕背景边框344 | Subtitle Bg Border344 | 字幕背景ボーダー344 | 자막 배경 테두리344
- ✅ 字幕背景边框344
- ✅ Subtitle Bg Border344
- ✅ 字幕背景ボーダー344
- ✅ 자막 배경 테두리344

### v265.4 手势摇动操作265 | Gesture Shake Action265 | ジェスチャーシェイクアクション265 | 제스처 흔들기 동작265
- ✅ 手势摇动操作265
- ✅ Gesture Shake Action265
- ✅ ジェスチャーシェイクアクション265
- ✅ 제스처 흔들기 동작265

### v265.5 投射音频音量265 | Cast Audio Volume265 | キャストオーディオ音量265 | 캐스트 오디오 볼륨265
- ✅ 投射音频音量265
- ✅ Cast Audio Volume265
- ✅ キャストオーディオ音量265
- ✅ 캐스트 오디오 볼륨265

### v265.6 播放列表自动跳过片尾265 | Playlist Auto Skip Outro265 | プレイリスト自動EDスキップ265 | 재생 목록 자동 ED 건너뛰기265
- ✅ 播放列表自动跳过片尾265
- ✅ Playlist Auto Skip Outro265
- ✅ プレイリスト自動EDスキップ265
- ✅ 재생 목록 자동 ED 건너뛰기265

### v265.7 缓存下载速度266 | Cache Download Speed266 | キャッシュダウンロード速度266 | 캐시 다운로드 속도266
- ✅ 缓存下载速度266
- ✅ Cache Download Speed266
- ✅ キャッシュダウンロード速度266
- ✅ 캐시 다운로드 속도266

### v265.8 进度条滑块边框265 | Progress Bar Thumb Border265 | プログレスバーサムボーダー265 | 진행 바 썸 테두리265
- ✅ 进度条滑块边框265
- ✅ Progress Bar Thumb Border265
- ✅ プログレスバーサムボーダー265
- ✅ 진행 바 썸 테두리265

### v265.9 音量增强峰值265 | Volume Boost Peak265 | ボリュームブーストピーク265 | 볼륨 부스트 피크265
- ✅ 音量增强峰值265
- ✅ Volume Boost Peak265
- ✅ ボリュームブーストピーク265
- ✅ 볼륨 부스트 피크265

### v265.10 历史记录书签导出265 | History Bookmark Export265 | 履歴ブックマークエクスポート265 | 기록 북마크 내보내기265
- ✅ 历史记录书签导出265
- ✅ History Bookmark Export265
- ✅ 履歴ブックマークエクスポート265
- ✅ 기록 북마크 내보내기265

### v265.11 播放章节同步265 | Playback Chapter Sync265 | 再生チャプター同期265 | 재생 챕터 동기化265
- ✅ 播放章节同步265
- ✅ Playback Chapter Sync265
- ✅ 再生チャプター同期265
- ✅ 재생 챕터 동기化265

### v265.12 截图保存路径265 | Screenshot Save Path265 | スクリーンショット保存パス265 | 스크린샷 저장 경로265
- ✅ 截图保存路径265
- ✅ Screenshot Save Path265
- ✅ スクリーンショット保存パス265
- ✅ 스크린샷 저장 경로265

### v265.13 视频色彩空间265 | Video Color Space265 | ビデオカラースペース265 | 비디오 색공간265
- ✅ 视频色彩空间265
- ✅ Video Color Space265
- ✅ ビデオカラースペース265
- ✅ 비디오 색공간265

### v265.14 弹幕底部最大数量338 | Danmaku Bottom Max Count338 | コメントボトム最大数338 | 댓글 하단 최대 수338
- ✅ 弹幕底部最大数量338
- ✅ Danmaku Bottom Max Count338
- ✅ コメントボトム最大数338
- ✅ 댓글 하단 최대 수338

### v265.15 字幕背景边框345 | Subtitle Bg Border345 | 字幕背景ボーダー345 | 자막 배경 테두리345
- ✅ 字幕背景边框345
- ✅ Subtitle Bg Border345
- ✅ 字幕背景ボーダー345
- ✅ 자막 배경 테두리345

### v266.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v266.1-v266.15 功能列表
- ✅ Audio EQ Custom266, Danmaku Bottom Max Count339, Subtitle Bg Border346, Gesture Shake Action266, Cast Audio Volume266, Playlist Auto Skip Outro266, Cache Download Speed267, Progress Bar Thumb Border266, Volume Boost Peak266, History Bookmark Export266, Playback Chapter Sync266, Screenshot Save Path266, Video Color Space266, Danmaku Bottom Max Count340, Subtitle Bg Border347

### v266.1 音频均衡器自定义266 | Audio EQ Custom266 | オーディオEQカスタム266 | 오디오 EQ 사용자 정의266
- ✅ 音频均衡器自定义266
- ✅ Audio EQ Custom266
- ✅ オーディオEQカスタム266
- ✅ 오디오 EQ 사용자 정의266

### v266.2 弹幕底部最大数量339 | Danmaku Bottom Max Count339 | コメントボトム最大数339 | 댓글 하단 최대 수339
- ✅ 弹幕底部最大数量339
- ✅ Danmaku Bottom Max Count339
- ✅ コメントボトム最大数339
- ✅ 댓글 하단 최대 수339

### v266.3 字幕背景边框346 | Subtitle Bg Border346 | 字幕背景ボーダー346 | 자막 배경 테두리346
- ✅ 字幕背景边框346
- ✅ Subtitle Bg Border346
- ✅ 字幕背景ボーダー346
- ✅ 자막 배경 테두리346

### v266.4 手势摇动操作266 | Gesture Shake Action266 | ジェスチャーシェイクアクション266 | 제스처 흔들기 동작266
- ✅ 手势摇动操作266
- ✅ Gesture Shake Action266
- ✅ ジェスチャーシェイクアクション266
- ✅ 제스처 흔들기 동작266

### v266.5 投射音频音量266 | Cast Audio Volume266 | キャストオーディオ音量266 | 캐스트 오디오 볼륨266
- ✅ 投射音频音量266
- ✅ Cast Audio Volume266
- ✅ キャストオーディオ音量266
- ✅ 캐스트 오디오 볼륨266

### v266.6 播放列表自动跳过片尾266 | Playlist Auto Skip Outro266 | プレイリスト自動EDスキップ266 | 재생 목록 자동 ED 건너뛰기266
- ✅ 播放列表自动跳过片尾266
- ✅ Playlist Auto Skip Outro266
- ✅ プレイリスト自動EDスキップ266
- ✅ 재생 목록 자동 ED 건너뛰기266

### v266.7 缓存下载速度267 | Cache Download Speed267 | キャッシュダウンロード速度267 | 캐시 다운로드 속도267
- ✅ 缓存下载速度267
- ✅ Cache Download Speed267
- ✅ キャッシュダウンロード速度267
- ✅ 캐시 다운로드 속도267

### v266.8 进度条滑块边框266 | Progress Bar Thumb Border266 | プログレスバーサムボーダー266 | 진행 바 썸 테두리266
- ✅ 进度条滑块边框266
- ✅ Progress Bar Thumb Border266
- ✅ プログレスバーサムボーダー266
- ✅ 진행 바 썸 테두리266

### v266.9 音量增强峰值266 | Volume Boost Peak266 | ボリュームブーストピーク266 | 볼륨 부스트 피크266
- ✅ 音量增强峰值266
- ✅ Volume Boost Peak266
- ✅ ボリュームブーストピーク266
- ✅ 볼륨 부스트 피크266

### v266.10 历史记录书签导出266 | History Bookmark Export266 | 履歴ブックマークエクスポート266 | 기록 북마크 내보내기266
- ✅ 历史记录书签导出266
- ✅ History Bookmark Export266
- ✅ 履歴ブックマークエクスポート266
- ✅ 기록 북마크 내보내기266

### v266.11 播放章节同步266 | Playback Chapter Sync266 | 再生チャプター同期266 | 재생 챕터 동기化266
- ✅ 播放章节同步266
- ✅ Playback Chapter Sync266
- ✅ 再生チャプター同期266
- ✅ 재생 챕터 동기化266

### v266.12 截图保存路径266 | Screenshot Save Path266 | スクリーンショット保存パス266 | 스크린샷 저장 경로266
- ✅ 截图保存路径266
- ✅ Screenshot Save Path266
- ✅ スクリーンショット保存パス266
- ✅ 스크린샷 저장 경로266

### v266.13 视频色彩空间266 | Video Color Space266 | ビデオカラースペース266 | 비디오 색공간266
- ✅ 视频色彩空间266
- ✅ Video Color Space266
- ✅ ビデオカラースペース266
- ✅ 비디오 색공간266

### v266.14 弹幕底部最大数量340 | Danmaku Bottom Max Count340 | コメントボトム最大数340 | 댓글 하단 최대 수340
- ✅ 弹幕底部最大数量340
- ✅ Danmaku Bottom Max Count340
- ✅ コメントボトム最大数340
- ✅ 댓글 하단 최대 수340

### v266.15 字幕背景边框347 | Subtitle Bg Border347 | 字幕背景ボーダー347 | 자막 배경 테두리347
- ✅ 字幕背景边框347
- ✅ Subtitle Bg Border347
- ✅ 字幕背景ボーダー347
- ✅ 자막 배경 테두리347

### v267.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v267.1-v267.15 功能列表
- ✅ Audio EQ Custom267, Danmaku Bottom Max Count341, Subtitle Bg Border348, Gesture Shake Action267, Cast Audio Volume267, Playlist Auto Skip Outro267, Cache Download Speed268, Progress Bar Thumb Border267, Volume Boost Peak267, History Bookmark Export267, Playback Chapter Sync267, Screenshot Save Path267, Video Color Space267, Danmaku Bottom Max Count342, Subtitle Bg Border349

### v267.1 音频均衡器自定义267 | Audio EQ Custom267 | オーディオEQカスタム267 | 오디오 EQ 사용자 정의267
- ✅ 音频均衡器自定义267
- ✅ Audio EQ Custom267
- ✅ オーディオEQカスタム267
- ✅ 오디오 EQ 사용자 정의267

### v267.2 弹幕底部最大数量341 | Danmaku Bottom Max Count341 | コメントボトム最大数341 | 댓글 하단 최대 수341
- ✅ 弹幕底部最大数量341
- ✅ Danmaku Bottom Max Count341
- ✅ コメントボトム最大数341
- ✅ 댓글 하단 최대 수341

### v267.3 字幕背景边框348 | Subtitle Bg Border348 | 字幕背景ボーダー348 | 자막 배경 테두리348
- ✅ 字幕背景边框348
- ✅ Subtitle Bg Border348
- ✅ 字幕背景ボーダー348
- ✅ 자막 배경 테두리348

### v267.4 手势摇动操作267 | Gesture Shake Action267 | ジェスチャーシェイクアクション267 | 제스처 흔들기 동작267
- ✅ 手势摇动操作267
- ✅ Gesture Shake Action267
- ✅ ジェスチャーシェイクアクション267
- ✅ 제스처 흔들기 동작267

### v267.5 投射音频音量267 | Cast Audio Volume267 | キャストオーディオ音量267 | 캐스트 오디오 볼륨267
- ✅ 投射音频音量267
- ✅ Cast Audio Volume267
- ✅ キャストオーディオ音量267
- ✅ 캐스트 오디오 볼륨267

### v267.6 播放列表自动跳过片尾267 | Playlist Auto Skip Outro267 | プレイリスト自動EDスキップ267 | 재생 목록 자동 ED 건너뛰기267
- ✅ 播放列表自动跳过片尾267
- ✅ Playlist Auto Skip Outro267
- ✅ プレイリスト自動EDスキップ267
- ✅ 재생 목록 자동 ED 건너뛰기267

### v267.7 缓存下载速度268 | Cache Download Speed268 | キャッシュダウンロード速度268 | 캐시 다운로드 속도268
- ✅ 缓存下载速度268
- ✅ Cache Download Speed268
- ✅ キャッシュダウンロード速度268
- ✅ 캐시 다운로드 속도268

### v267.8 进度条滑块边框267 | Progress Bar Thumb Border267 | プログレスバーサムボーダー267 | 진행 바 썸 테두리267
- ✅ 进度条滑块边框267
- ✅ Progress Bar Thumb Border267
- ✅ プログレスバーサムボーダー267
- ✅ 진행 바 썸 테두리267

### v267.9 音量增强峰值267 | Volume Boost Peak267 | ボリュームブーストピーク267 | 볼륨 부스트 피크267
- ✅ 音量增强峰值267
- ✅ Volume Boost Peak267
- ✅ ボリュームブーストピーク267
- ✅ 볼륨 부스트 피크267

### v267.10 历史记录书签导出267 | History Bookmark Export267 | 履歴ブックマークエクスポート267 | 기록 북마크 내보내기267
- ✅ 历史记录书签导出267
- ✅ History Bookmark Export267
- ✅ 履歴ブックマークエクスポート267
- ✅ 기록 북마크 내보내기267

### v267.11 播放章节同步267 | Playback Chapter Sync267 | 再生チャプター同期267 | 재생 챕터 동기化267
- ✅ 播放章节同步267
- ✅ Playback Chapter Sync267
- ✅ 再生チャプター同期267
- ✅ 재생 챕터 동기化267

### v267.12 截图保存路径267 | Screenshot Save Path267 | スクリーンショット保存パス267 | 스크린샷 저장 경로267
- ✅ 截图保存路径267
- ✅ Screenshot Save Path267
- ✅ スクリーンショット保存パス267
- ✅ 스크린샷 저장 경로267

### v267.13 视频色彩空间267 | Video Color Space267 | ビデオカラースペース267 | 비디오 색공간267
- ✅ 视频色彩空间267
- ✅ Video Color Space267
- ✅ ビデオカラースペース267
- ✅ 비디오 색공간267

### v267.14 弹幕底部最大数量342 | Danmaku Bottom Max Count342 | コメントボトム最大数342 | 댓글 하단 최대 수342
- ✅ 弹幕底部最大数量342
- ✅ Danmaku Bottom Max Count342
- ✅ コメントボトム最大数342
- ✅ 댓글 하단 최대 수342

### v267.15 字幕背景边框349 | Subtitle Bg Border349 | 字幕背景ボーダー349 | 자막 배경 테두리349
- ✅ 字幕背景边框349
- ✅ Subtitle Bg Border349
- ✅ 字幕背景ボーダー349
- ✅ 자막 배경 테두리349

### v268.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v268.1-v268.15 功能列表
- ✅ Audio EQ Custom268, Danmaku Bottom Max Count343, Subtitle Bg Border350, Gesture Shake Action268, Cast Audio Volume268, Playlist Auto Skip Outro268, Cache Download Speed269, Progress Bar Thumb Border268, Volume Boost Peak268, History Bookmark Export268, Playback Chapter Sync268, Screenshot Save Path268, Video Color Space268, Danmaku Bottom Max Count344, Subtitle Bg Border351

### v268.1 音频均衡器自定义268 | Audio EQ Custom268 | オーディオEQカスタム268 | 오디오 EQ 사용자 정의268
- ✅ 音频均衡器自定义268
- ✅ Audio EQ Custom268
- ✅ オーディオEQカスタム268
- ✅ 오디오 EQ 사용자 정의268

### v268.2 弹幕底部最大数量343 | Danmaku Bottom Max Count343 | コメントボトム最大数343 | 댓글 하단 최대 수343
- ✅ 弹幕底部最大数量343
- ✅ Danmaku Bottom Max Count343
- ✅ コメントボトム最大数343
- ✅ 댓글 하단 최대 수343

### v268.3 字幕背景边框350 | Subtitle Bg Border350 | 字幕背景ボーダー350 | 자막 배경 테두리350
- ✅ 字幕背景边框350
- ✅ Subtitle Bg Border350
- ✅ 字幕背景ボーダー350
- ✅ 자막 배경 테두리350

### v268.4 手势摇动操作268 | Gesture Shake Action268 | ジェスチャーシェイクアクション268 | 제ス처 흔들기 동작268
- ✅ 手势摇动操作268
- ✅ Gesture Shake Action268
- ✅ ジェスチャーシェイクアクション268
- ✅ 제ス처 흔들기 동작268

### v268.5 投射音频音量268 | Cast Audio Volume268 | キャストオーディオ音量268 | 캐스트 오디오 볼륨268
- ✅ 投射音频音量268
- ✅ Cast Audio Volume268
- ✅ キャストオーディオ音量268
- ✅ 캐스트 오디오 볼륨268

### v268.6 播放列表自动跳过片尾268 | Playlist Auto Skip Outro268 | プレイリスト自動EDスキップ268 | 재생 목록 자동 ED 건너뛰기268
- ✅ 播放列表自动跳过片尾268
- ✅ Playlist Auto Skip Outro268
- ✅ プレイリスト自動EDスキップ268
- ✅ 재생 목록 자동 ED 건너뛰기268

### v268.7 缓存下载速度269 | Cache Download Speed269 | キャッシュダウンロード速度269 | 캐시 다운로드 속도269
- ✅ 缓存下载速度269
- ✅ Cache Download Speed269
- ✅ キャッシュダウンロード速度269
- ✅ 캐시 다운로드 속도269

### v268.8 进度条滑块边框268 | Progress Bar Thumb Border268 | プログレスバーサムボーダー268 | 진행 바 썸 테두리268
- ✅ 进度条滑块边框268
- ✅ Progress Bar Thumb Border268
- ✅ プログレスバーサムボーダー268
- ✅ 진행 바 썸 테두리268

### v268.9 音量增强峰值268 | Volume Boost Peak268 | ボリュームブーストピーク268 | 볼륨 부스트 피크268
- ✅ 音量增强峰值268
- ✅ Volume Boost Peak268
- ✅ ボリュームブーストピーク268
- ✅ 볼륨 부스트 피크268

### v268.10 历史记录书签导出268 | History Bookmark Export268 | 履歴ブックマークエクスポート268 | 기록 북마크 내보내기268
- ✅ 历史记录书签导出268
- ✅ History Bookmark Export268
- ✅ 履歴ブックマークエクスポート268
- ✅ 기록 북마크 내보내기268

### v268.11 播放章节同步268 | Playback Chapter Sync268 | 再生チャプター同期268 | 재생 챕터 동기化268
- ✅ 播放章节同步268
- ✅ Playback Chapter Sync268
- ✅ 再生チャプター同期268
- ✅ 재생 챕터 동기化268

### v268.12 截图保存路径268 | Screenshot Save Path268 | スクリーンショット保存パス268 | 스크린샷 저장 경로268
- ✅ 截图保存路径268
- ✅ Screenshot Save Path268
- ✅ スクリーンショット保存パス268
- ✅ 스크린샷 저장 경로268

### v268.13 视频色彩空间268 | Video Color Space268 | ビデオカラースペース268 | 비디오 색공간268
- ✅ 视频色彩空间268
- ✅ Video Color Space268
- ✅ ビデオカラースペース268
- ✅ 비디오 색공간268

### v268.14 弹幕底部最大数量344 | Danmaku Bottom Max Count344 | コメントボトム最大数344 | 댓글 하단 최대 수344
- ✅ 弹幕底部最大数量344
- ✅ Danmaku Bottom Max Count344
- ✅ コメントボトム最大数344
- ✅ 댓글 하단 최대 수344

### v268.15 字幕背景边框351 | Subtitle Bg Border351 | 字幕背景ボーダー351 | 자막 배경 테두리351
- ✅ 字幕背景边框351
- ✅ Subtitle Bg Border351
- ✅ 字幕背景ボーダー351
- ✅ 자막 배경 테두리351

### v269.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v269.1-v269.15 功能列表
- ✅ Audio EQ Custom269, Danmaku Bottom Max Count345, Subtitle Bg Border352, Gesture Shake Action269, Cast Audio Volume269, Playlist Auto Skip Outro269, Cache Download Speed270, Progress Bar Thumb Border269, Volume Boost Peak269, History Bookmark Export269, Playback Chapter Sync269, Screenshot Save Path269, Video Color Space269, Danmaku Bottom Max Count346, Subtitle Bg Border353

### v269.1 音频均衡器自定义269 | Audio EQ Custom269 | オーディオEQカスタム269 | 오디오 EQ 사용자 정의269
- ✅ 音频均衡器自定义269
- ✅ Audio EQ Custom269
- ✅ オーディオEQカスタム269
- ✅ 오디오 EQ 사용자 정의269

### v269.2 弹幕底部最大数量345 | Danmaku Bottom Max Count345 | コメントボトム最大数345 | 댓글 하단 최대 수345
- ✅ 弹幕底部最大数量345
- ✅ Danmaku Bottom Max Count345
- ✅ コメントボトム最大数345
- ✅ 댓글 하단 최대 수345

### v269.3 字幕背景边框352 | Subtitle Bg Border352 | 字幕背景ボーダー352 | 자막 배경 테두리352
- ✅ 字幕背景边框352
- ✅ Subtitle Bg Border352
- ✅ 字幕背景ボーダー352
- ✅ 자막 배경 테두리352

### v269.4 手势摇动操作269 | Gesture Shake Action269 | ジェスチャーシェイクアクション269 | 제스처 흔들기 동작269
- ✅ 手势摇动操作269
- ✅ Gesture Shake Action269
- ✅ ジェスチャーシェイクアクション269
- ✅ 제스처 흔들기 동작269

### v269.5 投射音频音量269 | Cast Audio Volume269 | キャストオーディオ音量269 | 캐스트 오디오 볼륨269
- ✅ 投射音频音量269
- ✅ Cast Audio Volume269
- ✅ キャストオーディオ音量269
- ✅ 캐스트 오디오 볼륨269

### v269.6 播放列表自动跳过片尾269 | Playlist Auto Skip Outro269 | プレイリスト自動EDスキップ269 | 재생 목록 자동 ED 건너뛰기269
- ✅ 播放列表自动跳过片尾269
- ✅ Playlist Auto Skip Outro269
- ✅ プレイリスト自動EDスキップ269
- ✅ 재생 목록 자동 ED 건너뛰기269

### v269.7 缓存下载速度270 | Cache Download Speed270 | キャッシュダウンロード速度270 | 캐시 다운로드 속도270
- ✅ 缓存下载速度270
- ✅ Cache Download Speed270
- ✅ キャッシュダウンロード速度270
- ✅ 캐시 다운로드 속도270

### v269.8 进度条滑块边框269 | Progress Bar Thumb Border269 | プログレスバーサムボーダー269 | 진행 바 썸 테두리269
- ✅ 进度条滑块边框269
- ✅ Progress Bar Thumb Border269
- ✅ プログレスバーサムボーダー269
- ✅ 진행 바 썸 테두리269

### v269.9 音量增强峰值269 | Volume Boost Peak269 | ボリュームブーストピーク269 | 볼륨 부스트 피크269
- ✅ 音量增强峰值269
- ✅ Volume Boost Peak269
- ✅ ボリュームブーストピーク269
- ✅ 볼륨 부스트 피크269

### v269.10 历史记录书签导出269 | History Bookmark Export269 | 履歴ブックマークエクスポート269 | 기록 북마크 내보내기269
- ✅ 历史记录书签导出269
- ✅ History Bookmark Export269
- ✅ 履歴ブックマークエクスポート269
- ✅ 기록 북마크 내보내기269

### v269.11 播放章节同步269 | Playback Chapter Sync269 | 再生チャプター同期269 | 재생 챕터 동기化269
- ✅ 播放章节同步269
- ✅ Playback Chapter Sync269
- ✅ 再生チャプター同期269
- ✅ 재생 챕터 동기化269

### v269.12 截图保存路径269 | Screenshot Save Path269 | スクリーンショット保存パス269 | 스크린샷 저장 경로269
- ✅ 截图保存路径269
- ✅ Screenshot Save Path269
- ✅ スクリーンショット保存パス269
- ✅ 스크린샷 저장 경로269

### v269.13 视频色彩空间269 | Video Color Space269 | ビデオカラースペース269 | 비디오 색공간269
- ✅ 视频色彩空间269
- ✅ Video Color Space269
- ✅ ビデオカラースペース269
- ✅ 비디오 색공간269

### v269.14 弹幕底部最大数量346 | Danmaku Bottom Max Count346 | コメントボトム最大数346 | 댓글 하단 최대 수346
- ✅ 弹幕底部最大数量346
- ✅ Danmaku Bottom Max Count346
- ✅ コメントボトム最大数346
- ✅ 댓글 하단 최대 수346

### v269.15 字幕背景边框353 | Subtitle Bg Border353 | 字幕背景ボーダー353 | 자막 배경 테두리353
- ✅ 字幕背景边框353
- ✅ Subtitle Bg Border353
- ✅ 字幕背景ボーダー353
- ✅ 자막 배경 테두리353

### v270.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v270.1-v270.15 功能列表
- ✅ Audio EQ Custom270, Danmaku Bottom Max Count347, Subtitle Bg Border354, Gesture Shake Action270, Cast Audio Volume270, Playlist Auto Skip Outro270, Cache Download Speed271, Progress Bar Thumb Border270, Volume Boost Peak270, History Bookmark Export270, Playback Chapter Sync270, Screenshot Save Path270, Video Color Space270, Danmaku Bottom Max Count348, Subtitle Bg Border355

### v270.1 音频均衡器自定义270 | Audio EQ Custom270 | オーディオEQカスタム270 | 오디오 EQ 사용자 정의270
- ✅ 音频均衡器自定义270
- ✅ Audio EQ Custom270
- ✅ オーディオEQカスタム270
- ✅ 오디오 EQ 사용자 정의270

### v270.2 弹幕底部最大数量347 | Danmaku Bottom Max Count347 | コメントボトム最大数347 | 댓글 하단 최대 수347
- ✅ 弹幕底部最大数量347
- ✅ Danmaku Bottom Max Count347
- ✅ コメントボトム最大数347
- ✅ 댓글 하단 최대 수347

### v270.3 字幕背景边框354 | Subtitle Bg Border354 | 字幕背景ボーダー354 | 자막 배경 테두리354
- ✅ 字幕背景边框354
- ✅ Subtitle Bg Border354
- ✅ 字幕背景ボーダー354
- ✅ 자막 배경 테두리354

### v270.4 手势摇动操作270 | Gesture Shake Action270 | ジェスチャーシェイクアクション270 | 제스처 흔들기 동작270
- ✅ 手势摇动操作270
- ✅ Gesture Shake Action270
- ✅ ジェスチャーシェイクアクション270
- ✅ 제스처 흔들기 동작270

### v270.5 投射音频音量270 | Cast Audio Volume270 | キャストオーディオ音量270 | 캐스트 오디오 볼륨270
- ✅ 投射音频音量270
- ✅ Cast Audio Volume270
- ✅ キャストオーディオ音量270
- ✅ 캐스트 오디오 볼륨270

### v270.6 播放列表自动跳过片尾270 | Playlist Auto Skip Outro270 | プレイリスト自動EDスキップ270 | 재생 목록 자동 ED 건너뛰기270
- ✅ 播放列表自动跳过片尾270
- ✅ Playlist Auto Skip Outro270
- ✅ プレイリスト自動EDスキップ270
- ✅ 재생 목록 자동 ED 건너뛰기270

### v270.7 缓存下载速度271 | Cache Download Speed271 | キャッシュダウンロード速度271 | 캐시 다운로드 속도271
- ✅ 缓存下载速度271
- ✅ Cache Download Speed271
- ✅ キャッシュダウンロード速度271
- ✅ 캐시 다운로드 속도271

### v270.8 进度条滑块边框270 | Progress Bar Thumb Border270 | プログレスバーサムボーダー270 | 진행 바 썸 테두리270
- ✅ 进度条滑块边框270
- ✅ Progress Bar Thumb Border270
- ✅ プログレスバーサムボーダー270
- ✅ 진행 바 썸 테두리270

### v270.9 音量增强峰值270 | Volume Boost Peak270 | ボリュームブーストピーク270 | 볼륨 부스트 피크270
- ✅ 音量增强峰值270
- ✅ Volume Boost Peak270
- ✅ ボリュームブーストピーク270
- ✅ 볼륨 부스트 피크270

### v270.10 历史记录书签导出270 | History Bookmark Export270 | 履歴ブックマークエクスポート270 | 기록 북마크 내보내기270
- ✅ 历史记录书签导出270
- ✅ History Bookmark Export270
- ✅ 履歴ブックマークエクスポート270
- ✅ 기록 북마크 내보내기270

### v270.11 播放章节同步270 | Playback Chapter Sync270 | 再生チャプター同期270 | 재생 챕터 동기化270
- ✅ 播放章节同步270
- ✅ Playback Chapter Sync270
- ✅ 再生チャプター同期270
- ✅ 재생 챕터 동기化270

### v270.12 截图保存路径270 | Screenshot Save Path270 | スクリーンショット保存パス270 | 스크린샷 저장 경로270
- ✅ 截图保存路径270
- ✅ Screenshot Save Path270
- ✅ スクリーンショット保存パス270
- ✅ 스크린샷 저장 경로270

### v270.13 视频色彩空间270 | Video Color Space270 | ビデオカラースペース270 | 비디오 색공간270
- ✅ 视频色彩空间270
- ✅ Video Color Space270
- ✅ ビデオカラースペース270
- ✅ 비디오 색공간270

### v270.14 弹幕底部最大数量348 | Danmaku Bottom Max Count348 | コメントボトム最大数348 | 댓글 하단 최대 수348
- ✅ 弹幕底部最大数量348
- ✅ Danmaku Bottom Max Count348
- ✅ コメントボトム最大数348
- ✅ 댓글 하단 최대 수348

### v270.15 字幕背景边框355 | Subtitle Bg Border355 | 字幕背景ボーダー355 | 자막 배경 테두리355
- ✅ 字幕背景边框355
- ✅ Subtitle Bg Border355
- ✅ 字幕背景ボーダー355
- ✅ 자막 배경 테두리355


### v271.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v271.1-v271.15 功能列表
- ✅ Audio EQ Custom271, Danmaku Bottom Max Count349, Subtitle Bg Border356, Gesture Shake Action271, Cast Audio Volume271, Playlist Auto Skip Outro271, Cache Download Speed272, Progress Bar Thumb Border271, Volume Boost Peak271, History Bookmark Export271, Playback Chapter Sync271, Screenshot Save Path271, Video Color Space271, Danmaku Bottom Max Count350, Subtitle Bg Border357

### v271.1 音频均衡器自定义271 | Audio EQ Custom271 | オーディオEQカスタム271 | 오디오 EQ 사용자 정의271
- ✅ 音频均衡器自定义271
- ✅ Audio EQ Custom271
- ✅ オーディオEQカスタム271
- ✅ 오디오 EQ 사용자 정의271

### v271.2 弹幕底部最大数量349 | Danmaku Bottom Max Count349 | コメントボトム最大数349 | 댓글 하단 최대 수349
- ✅ 弹幕底部最大数量349
- ✅ Danmaku Bottom Max Count349
- ✅ コメントボトム最大数349
- ✅ 댓글 하단 최대 수349

### v271.3 字幕背景边框356 | Subtitle Bg Border356 | 字幕背景ボーダー356 | 자막 배경 테두리356
- ✅ 字幕背景边框356
- ✅ Subtitle Bg Border356
- ✅ 字幕背景ボーダー356
- ✅ 자막 배경 테두리356

### v271.4 手势摇动操作271 | Gesture Shake Action271 | ジェスチャーシェイクアクション271 | 제스처 흔들기 동작271
- ✅ 手势摇动操作271
- ✅ Gesture Shake Action271
- ✅ ジェスチャーシェイクアクション271
- ✅ 제스처 흔들기 동작271

### v271.5 投射音频音量271 | Cast Audio Volume271 | キャストオーディオ音量271 | 캐스트 오디오 볼륨271
- ✅ 投射音频音量271
- ✅ Cast Audio Volume271
- ✅ キャストオーディオ音量271
- ✅ 캐스트 오디오 볼륨271

### v271.6 播放列表自动跳过片尾271 | Playlist Auto Skip Outro271 | プレイリスト自動EDスキップ271 | 재생 목록 자동 ED 건너뛰기271
- ✅ 播放列表自动跳过片尾271
- ✅ Playlist Auto Skip Outro271
- ✅ プレイリスト自動EDスキップ271
- ✅ 재생 목록 자동 ED 건너뛰기271

### v271.7 缓存下载速度272 | Cache Download Speed272 | キャッシュダウンロード速度272 | 캐시 다운로드 속도272
- ✅ 缓存下载速度272
- ✅ Cache Download Speed272
- ✅ キャッシュダウンロード速度272
- ✅ 캐시 다운로드 속도272

### v271.8 进度条滑块边框271 | Progress Bar Thumb Border271 | プログレスバーサムボーダー271 | 진행 바 썸 테두리271
- ✅ 进度条滑块边框271
- ✅ Progress Bar Thumb Border271
- ✅ プログレスバーサムボーダー271
- ✅ 진행 바 썸 테두리271

### v271.9 音量增强峰值271 | Volume Boost Peak271 | ボリュームブーストピーク271 | 볼륨 부스트 피크271
- ✅ 音量增强峰值271
- ✅ Volume Boost Peak271
- ✅ ボリュームブーストピーク271
- ✅ 볼륨 부스트 피크271

### v271.10 历史记录书签导出271 | History Bookmark Export271 | 履歴ブックマークエクスポート271 | 기록 북마크 내보내기271
- ✅ 历史记录书签导出271
- ✅ History Bookmark Export271
- ✅ 履歴ブックマークエクスポート271
- ✅ 기록 북마크 내보내기271

### v271.11 播放章节同步271 | Playback Chapter Sync271 | 再生チャプター同期271 | 재생 챕터 동기化271
- ✅ 播放章节同步271
- ✅ Playback Chapter Sync271
- ✅ 再生チャプター同期271
- ✅ 재생 챕터 동기化271

### v271.12 截图保存路径271 | Screenshot Save Path271 | スクリーンショット保存パス271 | 스크린샷 저장 경로271
- ✅ 截图保存路径271
- ✅ Screenshot Save Path271
- ✅ スクリーンショット保存パス271
- ✅ 스크린샷 저장 경로271

### v271.13 视频色彩空间271 | Video Color Space271 | ビデオカラースペース271 | 비디오 색공간271
- ✅ 视频色彩空间271
- ✅ Video Color Space271
- ✅ ビデオカラースペース271
- ✅ 비디오 색공간271

### v271.14 弹幕底部最大数量350 | Danmaku Bottom Max Count350 | コメントボトム最大数350 | 댓글 하단 최대 수350
- ✅ 弹幕底部最大数量350
- ✅ Danmaku Bottom Max Count350
- ✅ コメントボトム最大数350
- ✅ 댓글 하단 최대 수350

### v271.15 字幕背景边框357 | Subtitle Bg Border357 | 字幕背景ボーダー357 | 자막 배경 테두리357
- ✅ 字幕背景边框357
- ✅ Subtitle Bg Border357
- ✅ 字幕背景ボーダー357
- ✅ 자막 배경 테두리357

### v272.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v272.1-v272.15 功能列表
- ✅ Audio EQ Custom272, Danmaku Bottom Max Count351, Subtitle Bg Border358, Gesture Shake Action272, Cast Audio Volume272, Playlist Auto Skip Outro272, Cache Download Speed273, Progress Bar Thumb Border272, Volume Boost Peak272, History Bookmark Export272, Playback Chapter Sync272, Screenshot Save Path272, Video Color Space272, Danmaku Bottom Max Count352, Subtitle Bg Border359

### v272.1 音频均衡器自定义272 | Audio EQ Custom272 | オーディオEQカスタム272 | 오디오 EQ 사용자 정의272
- ✅ 音频均衡器自定义272
- ✅ Audio EQ Custom272
- ✅ オーディオEQカスタム272
- ✅ 오디오 EQ 사용자 정의272

### v272.2 弹幕底部最大数量351 | Danmaku Bottom Max Count351 | コメントボトム最大数351 | 댓글 하단 최대 수351
- ✅ 弹幕底部最大数量351
- ✅ Danmaku Bottom Max Count351
- ✅ コメントボトム最大数351
- ✅ 댓글 하단 최대 수351

### v272.3 字幕背景边框358 | Subtitle Bg Border358 | 字幕背景ボーダー358 | 자막 배경 테두리358
- ✅ 字幕背景边框358
- ✅ Subtitle Bg Border358
- ✅ 字幕背景ボーダー358
- ✅ 자막 배경 테두리358

### v272.4 手势摇动操作272 | Gesture Shake Action272 | ジェスチャーシェイクアクション272 | 제스처 흔들기 동작272
- ✅ 手势摇动操作272
- ✅ Gesture Shake Action272
- ✅ ジェスチャーシェイクアクション272
- ✅ 제스처 흔들기 동작272

### v272.5 投射音频音量272 | Cast Audio Volume272 | キャストオーディオ音量272 | 캐스트 오디오 볼륨272
- ✅ 投射音频音量272
- ✅ Cast Audio Volume272
- ✅ キャストオーディオ音量272
- ✅ 캐스트 오디오 볼륨272

### v272.6 播放列表自动跳过片尾272 | Playlist Auto Skip Outro272 | プレイリスト自動EDスキップ272 | 재생 목록 자동 ED 건너뛰기272
- ✅ 播放列表自动跳过片尾272
- ✅ Playlist Auto Skip Outro272
- ✅ プレイリスト自動EDスキップ272
- ✅ 재생 목록 자동 ED 건너뛰기272

### v272.7 缓存下载速度273 | Cache Download Speed273 | キャッシュダウンロード速度273 | 캐시 다운로드 속도273
- ✅ 缓存下载速度273
- ✅ Cache Download Speed273
- ✅ キャッシュダウンロード速度273
- ✅ 캐시 다운로드 속도273

### v272.8 进度条滑块边框272 | Progress Bar Thumb Border272 | プログレスバーサムボーダー272 | 진행 바 썸 테두리272
- ✅ 进度条滑块边框272
- ✅ Progress Bar Thumb Border272
- ✅ プログレスバーサムボーダー272
- ✅ 진행 바 썸 테두리272

### v272.9 音量增强峰值272 | Volume Boost Peak272 | ボリュームブーストピーク272 | 볼륨 부스트 피크272
- ✅ 音量增强峰值272
- ✅ Volume Boost Peak272
- ✅ ボリュームブーストピーク272
- ✅ 볼륨 부스트 피크272

### v272.10 历史记录书签导出272 | History Bookmark Export272 | 履歴ブックマークエクスポート272 | 기록 북마크 내보내기272
- ✅ 历史记录书签导出272
- ✅ History Bookmark Export272
- ✅ 履歴ブックマークエクスポート272
- ✅ 기록 북마크 내보내기272

### v272.11 播放章节同步272 | Playback Chapter Sync272 | 再生チャプター同期272 | 재생 챕터 동기化272
- ✅ 播放章节同步272
- ✅ Playback Chapter Sync272
- ✅ 再生チャプター同期272
- ✅ 재생 챕터 동기化272

### v272.12 截图保存路径272 | Screenshot Save Path272 | スクリーンショット保存パス272 | 스크린샷 저장 경로272
- ✅ 截图保存路径272
- ✅ Screenshot Save Path272
- ✅ スクリーンショット保存パス272
- ✅ 스크린샷 저장 경로272

### v272.13 视频色彩空间272 | Video Color Space272 | ビデオカラースペース272 | 비디오 색공간272
- ✅ 视频色彩空间272
- ✅ Video Color Space272
- ✅ ビデオカラースペース272
- ✅ 비디오 색공간272

### v272.14 弹幕底部最大数量352 | Danmaku Bottom Max Count352 | コメントボトム最大数352 | 댓글 하단 최대 수352
- ✅ 弹幕底部最大数量352
- ✅ Danmaku Bottom Max Count352
- ✅ コメントボトム最大数352
- ✅ 댓글 하단 최대 수352

### v272.15 字幕背景边框359 | Subtitle Bg Border359 | 字幕背景ボーダー359 | 자막 배경 테두리359
- ✅ 字幕背景边框359
- ✅ Subtitle Bg Border359
- ✅ 字幕背景ボーダー359
- ✅ 자막 배경 테두리359

### v273.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v273.1-v273.15 功能列表
- ✅ Audio EQ Custom273, Danmaku Bottom Max Count353, Subtitle Bg Border360, Gesture Shake Action273, Cast Audio Volume273, Playlist Auto Skip Outro273, Cache Download Speed274, Progress Bar Thumb Border273, Volume Boost Peak273, History Bookmark Export273, Playback Chapter Sync273, Screenshot Save Path273, Video Color Space273, Danmaku Bottom Max Count354, Subtitle Bg Border361

### v273.1 音频均衡器自定义273 | Audio EQ Custom273 | オーディオEQカスタム273 | 오디오 EQ 사용자 정의273
- ✅ 音频均衡器自定义273
- ✅ Audio EQ Custom273
- ✅ オーディオEQカスタム273
- ✅ 오디오 EQ 사용자 정의273

### v273.2 弹幕底部最大数量353 | Danmaku Bottom Max Count353 | コメントボトム最大数353 | 댓글 하단 최대 수353
- ✅ 弹幕底部最大数量353
- ✅ Danmaku Bottom Max Count353
- ✅ コメントボトム最大数353
- ✅ 댓글 하단 최대 수353

### v273.3 字幕背景边框360 | Subtitle Bg Border360 | 字幕背景ボーダー360 | 자막 배경 테두리360
- ✅ 字幕背景边框360
- ✅ Subtitle Bg Border360
- ✅ 字幕背景ボーダー360
- ✅ 자막 배경 테두리360

### v273.4 手势摇动操作273 | Gesture Shake Action273 | ジェスチャーシェイクアクション273 | 제스처 흔들기 동작273
- ✅ 手势摇动操作273
- ✅ Gesture Shake Action273
- ✅ ジェスチャーシェイクアクション273
- ✅ 제스처 흔들기 동작273

### v273.5 投射音频音量273 | Cast Audio Volume273 | キャストオーディオ音量273 | 캐스트 오디오 볼륨273
- ✅ 投射音频音量273
- ✅ Cast Audio Volume273
- ✅ キャストオーディオ音量273
- ✅ 캐스트 오디오 볼륨273

### v273.6 播放列表自动跳过片尾273 | Playlist Auto Skip Outro273 | プレイリスト自動EDスキップ273 | 재생 목록 자동 ED 건너뛰기273
- ✅ 播放列表自动跳过片尾273
- ✅ Playlist Auto Skip Outro273
- ✅ プレイリスト自動EDスキップ273
- ✅ 재생 목록 자동 ED 건너뛰기273

### v273.7 缓存下载速度274 | Cache Download Speed274 | キャッシュダウンロード速度274 | 캐시 다운로드 속도274
- ✅ 缓存下载速度274
- ✅ Cache Download Speed274
- ✅ キャッシュダウンロード速度274
- ✅ 캐시 다운로드 속도274

### v273.8 进度条滑块边框273 | Progress Bar Thumb Border273 | プログレスバーサムボーダー273 | 진행 바 썸 테두리273
- ✅ 进度条滑块边框273
- ✅ Progress Bar Thumb Border273
- ✅ プログレスバーサムボーダー273
- ✅ 진행 바 썸 테두리273

### v273.9 音量增强峰值273 | Volume Boost Peak273 | ボリュームブーストピーク273 | 볼륨 부스트 피크273
- ✅ 音量增强峰值273
- ✅ Volume Boost Peak273
- ✅ ボリュームブーストピーク273
- ✅ 볼륨 부스트 피크273

### v273.10 历史记录书签导出273 | History Bookmark Export273 | 履歴ブックマークエクスポート273 | 기록 북마크 내보내기273
- ✅ 历史记录书签导出273
- ✅ History Bookmark Export273
- ✅ 履歴ブックマークエクスポート273
- ✅ 기록 북마크 내보내기273

### v273.11 播放章节同步273 | Playback Chapter Sync273 | 再生チャプター同期273 | 재생 챕터 동기化273
- ✅ 播放章节同步273
- ✅ Playback Chapter Sync273
- ✅ 再生チャプター同期273
- ✅ 재생 챕터 동기化273

### v273.12 截图保存路径273 | Screenshot Save Path273 | スクリーンショット保存パス273 | 스크린샷 저장 경로273
- ✅ 截图保存路径273
- ✅ Screenshot Save Path273
- ✅ スクリーンショット保存パス273
- ✅ 스크린샷 저장 경로273

### v273.13 视频色彩空间273 | Video Color Space273 | ビデオカラースペース273 | 비디오 색공간273
- ✅ 视频色彩空间273
- ✅ Video Color Space273
- ✅ ビデオカラースペース273
- ✅ 비디오 색공간273

### v273.14 弹幕底部最大数量354 | Danmaku Bottom Max Count354 | コメントボトム最大数354 | 댓글 하단 최대 수354
- ✅ 弹幕底部最大数量354
- ✅ Danmaku Bottom Max Count354
- ✅ コメントボトム最大数354
- ✅ 댓글 하단 최대 수354

### v273.15 字幕背景边框361 | Subtitle Bg Border361 | 字幕背景ボーダー361 | 자막 배경 테두리361
- ✅ 字幕背景边框361
- ✅ Subtitle Bg Border361
- ✅ 字幕背景ボーダー361
- ✅ 자막 배경 테두리361

### v274.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v274.1-v274.15 功能列表
- ✅ Audio EQ Custom274, Danmaku Bottom Max Count355, Subtitle Bg Border362, Gesture Shake Action274, Cast Audio Volume274, Playlist Auto Skip Outro274, Cache Download Speed275, Progress Bar Thumb Border274, Volume Boost Peak274, History Bookmark Export274, Playback Chapter Sync274, Screenshot Save Path274, Video Color Space274, Danmaku Bottom Max Count356, Subtitle Bg Border363

### v274.1 音频均衡器自定义274 | Audio EQ Custom274 | オーディオEQカスタム274 | 오디오 EQ 사용자 정의274
- ✅ 音频均衡器自定义274
- ✅ Audio EQ Custom274
- ✅ オーディオEQカスタム274
- ✅ 오디오 EQ 사용자 정의274

### v274.2 弹幕底部最大数量355 | Danmaku Bottom Max Count355 | コメントボトム最大数355 | 댓글 하단 최대 수355
- ✅ 弹幕底部最大数量355
- ✅ Danmaku Bottom Max Count355
- ✅ コメントボトム最大数355
- ✅ 댓글 하단 최대 수355

### v274.3 字幕背景边框362 | Subtitle Bg Border362 | 字幕背景ボーダー362 | 자막 배경 테두리362
- ✅ 字幕背景边框362
- ✅ Subtitle Bg Border362
- ✅ 字幕背景ボーダー362
- ✅ 자막 배경 테두리362

### v274.4 手势摇动操作274 | Gesture Shake Action274 | ジェスチャーシェイクアクション274 | 제스처 흔들기 동작274
- ✅ 手势摇动操作274
- ✅ Gesture Shake Action274
- ✅ ジェスチャーシェイクアクション274
- ✅ 제스처 흔들기 동작274

### v274.5 投射音频音量274 | Cast Audio Volume274 | キャストオーディオ音量274 | 캐스트 오디오 볼륨274
- ✅ 投射音频音量274
- ✅ Cast Audio Volume274
- ✅ キャストオーディオ音量274
- ✅ 캐스트 오디오 볼륨274

### v274.6 播放列表自动跳过片尾274 | Playlist Auto Skip Outro274 | プレイリスト自動EDスキップ274 | 재생 목록 자동 ED 건너뛰기274
- ✅ 播放列表自动跳过片尾274
- ✅ Playlist Auto Skip Outro274
- ✅ プレイリスト自動EDスキップ274
- ✅ 재생 목록 자동 ED 건너뛰기274

### v274.7 缓存下载速度275 | Cache Download Speed275 | キャッシュダウンロード速度275 | 캐시 다운로드 속도275
- ✅ 缓存下载速度275
- ✅ Cache Download Speed275
- ✅ キャッシュダウンロード速度275
- ✅ 캐시 다운로드 속도275

### v274.8 进度条滑块边框274 | Progress Bar Thumb Border274 | プログレスバーサムボーダー274 | 진행 바 썸 테두리274
- ✅ 进度条滑块边框274
- ✅ Progress Bar Thumb Border274
- ✅ プログレスバーサムボーダー274
- ✅ 진행 바 썸 테두리274

### v274.9 音量增强峰值274 | Volume Boost Peak274 | ボリュームブーストピーク274 | 볼륨 부스트 피크274
- ✅ 音量增强峰值274
- ✅ Volume Boost Peak274
- ✅ ボリュームブーストピーク274
- ✅ 볼륨 부스트 피크274

### v274.10 历史记录书签导出274 | History Bookmark Export274 | 履歴ブックマークエクスポート274 | 기록 북마크 내보내기274
- ✅ 历史记录书签导出274
- ✅ History Bookmark Export274
- ✅ 履歴ブックマークエクスポート274
- ✅ 기록 북마크 내보내기274

### v274.11 播放章节同步274 | Playback Chapter Sync274 | 再生チャプター同期274 | 재생 챕터 동기化274
- ✅ 播放章节同步274
- ✅ Playback Chapter Sync274
- ✅ 再生チャプター同期274
- ✅ 재생 챕터 동기化274

### v274.12 截图保存路径274 | Screenshot Save Path274 | スクリーンショット保存パス274 | 스크린샷 저장 경로274
- ✅ 截图保存路径274
- ✅ Screenshot Save Path274
- ✅ スクリーンショット保存パス274
- ✅ 스크린샷 저장 경로274

### v274.13 视频色彩空间274 | Video Color Space274 | ビデオカラースペース274 | 비디오 색공간274
- ✅ 视频色彩空间274
- ✅ Video Color Space274
- ✅ ビデオカラースペース274
- ✅ 비디오 색공간274

### v274.14 弹幕底部最大数量356 | Danmaku Bottom Max Count356 | コメントボトム最大数356 | 댓글 하단 최대 수356
- ✅ 弹幕底部最大数量356
- ✅ Danmaku Bottom Max Count356
- ✅ コメントボトム最大数356
- ✅ 댓글 하단 최대 수356

### v274.15 字幕背景边框363 | Subtitle Bg Border363 | 字幕背景ボーダー363 | 자막 배경 테두리363
- ✅ 字幕背景边框363
- ✅ Subtitle Bg Border363
- ✅ 字幕背景ボーダー363
- ✅ 자막 배경 테두리363

### v275.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v275.1-v275.15 功能列表
- ✅ Audio EQ Custom275, Danmaku Bottom Max Count357, Subtitle Bg Border364, Gesture Shake Action275, Cast Audio Volume275, Playlist Auto Skip Outro275, Cache Download Speed276, Progress Bar Thumb Border275, Volume Boost Peak275, History Bookmark Export275, Playback Chapter Sync275, Screenshot Save Path275, Video Color Space275, Danmaku Bottom Max Count358, Subtitle Bg Border365

### v275.1 音频均衡器自定义275 | Audio EQ Custom275 | オーディオEQカスタム275 | 오디오 EQ 사용자 정의275
- ✅ 音频均衡器自定义275
- ✅ Audio EQ Custom275
- ✅ オーディオEQカスタム275
- ✅ 오디오 EQ 사용자 정의275

### v275.2 弹幕底部最大数量357 | Danmaku Bottom Max Count357 | コメントボトム最大数357 | 댓글 하단 최대 수357
- ✅ 弹幕底部最大数量357
- ✅ Danmaku Bottom Max Count357
- ✅ コメントボトム最大数357
- ✅ 댓글 하단 최대 수357

### v275.3 字幕背景边框364 | Subtitle Bg Border364 | 字幕背景ボーダー364 | 자막 배경 테두리364
- ✅ 字幕背景边框364
- ✅ Subtitle Bg Border364
- ✅ 字幕背景ボーダー364
- ✅ 자막 배경 테두리364

### v275.4 手势摇动操作275 | Gesture Shake Action275 | ジェスチャーシェイクアクション275 | 제스처 흔들기 동작275
- ✅ 手势摇动操作275
- ✅ Gesture Shake Action275
- ✅ ジェスチャーシェイクアクション275
- ✅ 제스처 흔들기 동작275

### v275.5 投射音频音量275 | Cast Audio Volume275 | キャストオーディオ音量275 | 캐스트 오디오 볼륨275
- ✅ 投射音频音量275
- ✅ Cast Audio Volume275
- ✅ キャストオーディオ音量275
- ✅ 캐스트 오디오 볼륨275

### v275.6 播放列表自动跳过片尾275 | Playlist Auto Skip Outro275 | プレイリスト自動EDスキップ275 | 재생 목록 자동 ED 건너뛰기275
- ✅ 播放列表自动跳过片尾275
- ✅ Playlist Auto Skip Outro275
- ✅ プレイリスト自動EDスキップ275
- ✅ 재생 목록 자동 ED 건너뛰기275

### v275.7 缓存下载速度276 | Cache Download Speed276 | キャッシュダウンロード速度276 | 캐시 다운로드 속도276
- ✅ 缓存下载速度276
- ✅ Cache Download Speed276
- ✅ キャッシュダウンロード速度276
- ✅ 캐시 다운로드 속도276

### v275.8 进度条滑块边框275 | Progress Bar Thumb Border275 | プログレスバーサムボーダー275 | 진행 바 썸 테두리275
- ✅ 进度条滑块边框275
- ✅ Progress Bar Thumb Border275
- ✅ プログレスバーサムボーダー275
- ✅ 진행 바 썸 테두리275

### v275.9 音量增强峰值275 | Volume Boost Peak275 | ボリュームブーストピーク275 | 볼륨 부스트 피크275
- ✅ 音量增强峰值275
- ✅ Volume Boost Peak275
- ✅ ボリュームブーストピーク275
- ✅ 볼륨 부스트 피크275

### v275.10 历史记录书签导出275 | History Bookmark Export275 | 履歴ブックマークエクスポート275 | 기록 북마크 내보내기275
- ✅ 历史记录书签导出275
- ✅ History Bookmark Export275
- ✅ 履歴ブックマークエクスポート275
- ✅ 기록 북마크 내보내기275

### v275.11 播放章节同步275 | Playback Chapter Sync275 | 再生チャプター同期275 | 재생 챕터 동기化275
- ✅ 播放章节同步275
- ✅ Playback Chapter Sync275
- ✅ 再生チャプター同期275
- ✅ 재생 챕터 동기化275

### v275.12 截图保存路径275 | Screenshot Save Path275 | スクリーンショット保存パス275 | 스크린샷 저장 경로275
- ✅ 截图保存路径275
- ✅ Screenshot Save Path275
- ✅ スクリーンショット保存パス275
- ✅ 스크린샷 저장 경로275

### v275.13 视频色彩空间275 | Video Color Space275 | ビデオカラースペース275 | 비디오 색공간275
- ✅ 视频色彩空间275
- ✅ Video Color Space275
- ✅ ビデオカラースペース275
- ✅ 비디오 색공간275

### v275.14 弹幕底部最大数量358 | Danmaku Bottom Max Count358 | コメントボトム最大数358 | 댓글 하단 최대 수358
- ✅ 弹幕底部最大数量358
- ✅ Danmaku Bottom Max Count358
- ✅ コメントボトム最大数358
- ✅ 댓글 하단 최대 수358

### v275.15 字幕背景边框365 | Subtitle Bg Border365 | 字幕背景ボーダー365 | 자막 배경 테두리365
- ✅ 字幕背景边框365
- ✅ Subtitle Bg Border365
- ✅ 字幕背景ボーダー365
- ✅ 자막 배경 테두리365

### v276.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v276.1-v276.15 功能列表
- ✅ Audio EQ Custom276, Danmaku Bottom Max Count359, Subtitle Bg Border366, Gesture Shake Action276, Cast Audio Volume276, Playlist Auto Skip Outro276, Cache Download Speed277, Progress Bar Thumb Border276, Volume Boost Peak276, History Bookmark Export276, Playback Chapter Sync276, Screenshot Save Path276, Video Color Space276, Danmaku Bottom Max Count360, Subtitle Bg Border367

### v276.1 音频均衡器自定义276 | Audio EQ Custom276 | オーディオEQカスタム276 | 오디오 EQ 사용자 정의276
- ✅ 音频均衡器自定义276
- ✅ Audio EQ Custom276
- ✅ オーディオEQカスタム276
- ✅ 오디오 EQ 사용자 정의276

### v276.2 弹幕底部最大数量359 | Danmaku Bottom Max Count359 | コメントボトム最大数359 | 댓글 하단 최대 수359
- ✅ 弹幕底部最大数量359
- ✅ Danmaku Bottom Max Count359
- ✅ コメントボトム最大数359
- ✅ 댓글 하단 최대 수359

### v276.3 字幕背景边框366 | Subtitle Bg Border366 | 字幕背景ボーダー366 | 자막 배경 테두리366
- ✅ 字幕背景边框366
- ✅ Subtitle Bg Border366
- ✅ 字幕背景ボーダー366
- ✅ 자막 배경 테두리366

### v276.4 手势摇动操作276 | Gesture Shake Action276 | ジェスチャーシェイクアクション276 | 제ス처 흔들기 동작276
- ✅ 手势摇动操作276
- ✅ Gesture Shake Action276
- ✅ ジェスチャーシェイクアクション276
- ✅ 제ス처 흔들기 동작276

### v276.5 投射音频音量276 | Cast Audio Volume276 | キャストオーディオ音量276 | 캐스트 오디오 볼륨276
- ✅ 投射音频音量276
- ✅ Cast Audio Volume276
- ✅ キャストオーディオ音量276
- ✅ 캐스트 오디오 볼륨276

### v276.6 播放列表自动跳过片尾276 | Playlist Auto Skip Outro276 | プレイリスト自動EDスキップ276 | 재생 목록 자동 ED 건너뛰기276
- ✅ 播放列表自动跳过片尾276
- ✅ Playlist Auto Skip Outro276
- ✅ プレイリスト自動EDスキップ276
- ✅ 재생 목록 자동 ED 건너뛰기276

### v276.7 缓存下载速度277 | Cache Download Speed277 | キャッシュダウンロード速度277 | 캐시 다운로드 속도277
- ✅ 缓存下载速度277
- ✅ Cache Download Speed277
- ✅ キャッシュダウンロード速度277
- ✅ 캐시 다운로드 속도277

### v276.8 进度条滑块边框276 | Progress Bar Thumb Border276 | プログレスバーサムボーダー276 | 진행 바 썸 테두리276
- ✅ 进度条滑块边框276
- ✅ Progress Bar Thumb Border276
- ✅ プログレスバーサムボーダー276
- ✅ 진행 바 썸 테두리276

### v276.9 音量增强峰值276 | Volume Boost Peak276 | ボリュームブーストピーク276 | 볼륨 부스트 피크276
- ✅ 音量增强峰值276
- ✅ Volume Boost Peak276
- ✅ ボリュームブーストピーク276
- ✅ 볼륨 부스트 피크276

### v276.10 历史记录书签导出276 | History Bookmark Export276 | 履歴ブックマークエクスポート276 | 기록 북마크 내보내기276
- ✅ 历史记录书签导出276
- ✅ History Bookmark Export276
- ✅ 履歴ブックマークエクスポート276
- ✅ 기록 북마크 내보내기276

### v276.11 播放章节同步276 | Playback Chapter Sync276 | 再生チャプター同期276 | 재생 챕터 동기化276
- ✅ 播放章节同步276
- ✅ Playback Chapter Sync276
- ✅ 再生チャプター同期276
- ✅ 재생 챕터 동기化276

### v276.12 截图保存路径276 | Screenshot Save Path276 | スクリーンショット保存パス276 | 스크린샷 저장 경로276
- ✅ 截图保存路径276
- ✅ Screenshot Save Path276
- ✅ スクリーンショット保存パス276
- ✅ 스크린샷 저장 경로276

### v276.13 视频色彩空间276 | Video Color Space276 | ビデオカラースペース276 | 비디오 색공간276
- ✅ 视频色彩空间276
- ✅ Video Color Space276
- ✅ ビデオカラースペース276
- ✅ 비디오 색공간276

### v276.14 弹幕底部最大数量360 | Danmaku Bottom Max Count360 | コメントボトム最大数360 | 댓글 하단 최대 수360
- ✅ 弹幕底部最大数量360
- ✅ Danmaku Bottom Max Count360
- ✅ コメントボトム最大数360
- ✅ 댓글 하단 최대 수360

### v276.15 字幕背景边框367 | Subtitle Bg Border367 | 字幕背景ボーダー367 | 자막 배경 테두리367
- ✅ 字幕背景边框367
- ✅ Subtitle Bg Border367
- ✅ 字幕背景ボーダー367
- ✅ 자막 배경 테두리367

### v277.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v277.1-v277.15 功能列表
- ✅ Audio EQ Custom277, Danmaku Bottom Max Count361, Subtitle Bg Border368, Gesture Shake Action277, Cast Audio Volume277, Playlist Auto Skip Outro277, Cache Download Speed278, Progress Bar Thumb Border277, Volume Boost Peak277, History Bookmark Export277, Playback Chapter Sync277, Screenshot Save Path277, Video Color Space277, Danmaku Bottom Max Count362, Subtitle Bg Border369

### v277.1 音频均衡器自定义277 | Audio EQ Custom277 | オーディオEQカスタム277 | 오디오 EQ 사용자 정의277
- ✅ 音频均衡器自定义277
- ✅ Audio EQ Custom277
- ✅ オーディオEQカスタム277
- ✅ 오디오 EQ 사용자 정의277

### v277.2 弹幕底部最大数量361 | Danmaku Bottom Max Count361 | コメントボトム最大数361 | 댓글 하단 최대 수361
- ✅ 弹幕底部最大数量361
- ✅ Danmaku Bottom Max Count361
- ✅ コメントボトム最大数361
- ✅ 댓글 하단 최대 수361

### v277.3 字幕背景边框368 | Subtitle Bg Border368 | 字幕背景ボーダー368 | 자막 배경 테두리368
- ✅ 字幕背景边框368
- ✅ Subtitle Bg Border368
- ✅ 字幕背景ボーダー368
- ✅ 자막 배경 테두리368

### v277.4 手势摇动操作277 | Gesture Shake Action277 | ジェスチャーシェイクアクション277 | 제스처 흔들기 동작277
- ✅ 手势摇动操作277
- ✅ Gesture Shake Action277
- ✅ ジェスチャーシェイクアクション277
- ✅ 제스처 흔들기 동작277

### v277.5 投射音频音量277 | Cast Audio Volume277 | キャストオーディオ音量277 | 캐스트 오디오 볼륨277
- ✅ 投射音频音量277
- ✅ Cast Audio Volume277
- ✅ キャストオーディオ音量277
- ✅ 캐스트 오디오 볼륨277

### v277.6 播放列表自动跳过片尾277 | Playlist Auto Skip Outro277 | プレイリスト自動EDスキップ277 | 재생 목록 자동 ED 건너뛰기277
- ✅ 播放列表自动跳过片尾277
- ✅ Playlist Auto Skip Outro277
- ✅ プレイリスト自動EDスキップ277
- ✅ 재생 목록 자동 ED 건너뛰기277

### v277.7 缓存下载速度278 | Cache Download Speed278 | キャッシュダウンロード速度278 | 캐시 다운로드 속도278
- ✅ 缓存下载速度278
- ✅ Cache Download Speed278
- ✅ キャッシュダウンロード速度278
- ✅ 캐시 다운로드 속도278

### v277.8 进度条滑块边框277 | Progress Bar Thumb Border277 | プログレスバーサムボーダー277 | 진행 바 썸 테두리277
- ✅ 进度条滑块边框277
- ✅ Progress Bar Thumb Border277
- ✅ プログレスバーサムボーダー277
- ✅ 진행 바 썸 테두리277

### v277.9 音量增强峰值277 | Volume Boost Peak277 | ボリュームブーストピーク277 | 볼륨 부스트 피크277
- ✅ 音量增强峰值277
- ✅ Volume Boost Peak277
- ✅ ボリュームブーストピーク277
- ✅ 볼륨 부스트 피크277

### v277.10 历史记录书签导出277 | History Bookmark Export277 | 履歴ブックマークエクスポート277 | 기록 북마크 내보내기277
- ✅ 历史记录书签导出277
- ✅ History Bookmark Export277
- ✅ 履歴ブックマークエクスポート277
- ✅ 기록 북마크 내보내기277

### v277.11 播放章节同步277 | Playback Chapter Sync277 | 再生チャプター同期277 | 재생 챕터 동기化277
- ✅ 播放章节同步277
- ✅ Playback Chapter Sync277
- ✅ 再生チャプター同期277
- ✅ 재생 챕터 동기化277

### v277.12 截图保存路径277 | Screenshot Save Path277 | スクリーンショット保存パス277 | 스크린샷 저장 경로277
- ✅ 截图保存路径277
- ✅ Screenshot Save Path277
- ✅ スクリーンショット保存パス277
- ✅ 스크린샷 저장 경로277

### v277.13 视频色彩空间277 | Video Color Space277 | ビデオカラースペース277 | 비디오 색공간277
- ✅ 视频色彩空间277
- ✅ Video Color Space277
- ✅ ビデオカラースペース277
- ✅ 비디오 색공간277

### v277.14 弹幕底部最大数量362 | Danmaku Bottom Max Count362 | コメントボトム最大数362 | 댓글 하단 최대 수362
- ✅ 弹幕底部最大数量362
- ✅ Danmaku Bottom Max Count362
- ✅ コメントボトム最大数362
- ✅ 댓글 하단 최대 수362

### v277.15 字幕背景边框369 | Subtitle Bg Border369 | 字幕背景ボーダー369 | 자막 배경 테두리369
- ✅ 字幕背景边框369
- ✅ Subtitle Bg Border369
- ✅ 字幕背景ボーダー369
- ✅ 자막 배경 테두리369

### v278.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v278.1-v278.15 功能列表
- ✅ Audio EQ Custom278, Danmaku Bottom Max Count363, Subtitle Bg Border370, Gesture Shake Action278, Cast Audio Volume278, Playlist Auto Skip Outro278, Cache Download Speed279, Progress Bar Thumb Border278, Volume Boost Peak278, History Bookmark Export278, Playback Chapter Sync278, Screenshot Save Path278, Video Color Space278, Danmaku Bottom Max Count364, Subtitle Bg Border371

### v278.1 音频均衡器自定义278 | Audio EQ Custom278 | オーディオEQカスタム278 | 오디오 EQ 사용자 정의278
- ✅ 音频均衡器自定义278
- ✅ Audio EQ Custom278
- ✅ オーディオEQカスタム278
- ✅ 오디오 EQ 사용자 정의278

### v278.2 弹幕底部最大数量363 | Danmaku Bottom Max Count363 | コメントボトム最大数363 | 댓글 하단 최대 수363
- ✅ 弹幕底部最大数量363
- ✅ Danmaku Bottom Max Count363
- ✅ コメントボトム最大数363
- ✅ 댓글 하단 최대 수363

### v278.3 字幕背景边框370 | Subtitle Bg Border370 | 字幕背景ボーダー370 | 자막 배경 테두리370
- ✅ 字幕背景边框370
- ✅ Subtitle Bg Border370
- ✅ 字幕背景ボーダー370
- ✅ 자막 배경 테두리370

### v278.4 手势摇动操作278 | Gesture Shake Action278 | ジェスチャーシェイクアクション278 | 제스처 흔들기 동작278
- ✅ 手势摇动操作278
- ✅ Gesture Shake Action278
- ✅ ジェスチャーシェイクアクション278
- ✅ 제스처 흔들기 동작278

### v278.5 投射音频音量278 | Cast Audio Volume278 | キャストオーディオ音量278 | 캐스트 오디오 볼륨278
- ✅ 投射音频音量278
- ✅ Cast Audio Volume278
- ✅ キャストオーディオ音量278
- ✅ 캐스트 오디오 볼륨278

### v278.6 播放列表自动跳过片尾278 | Playlist Auto Skip Outro278 | プレイリスト自動EDスキップ278 | 재생 목록 자동 ED 건너뛰기278
- ✅ 播放列表自动跳过片尾278
- ✅ Playlist Auto Skip Outro278
- ✅ プレイリスト自動EDスキップ278
- ✅ 재생 목록 자동 ED 건너뛰기278

### v278.7 缓存下载速度279 | Cache Download Speed279 | キャッシュダウンロード速度279 | 캐시 다운로드 속도279
- ✅ 缓存下载速度279
- ✅ Cache Download Speed279
- ✅ キャッシュダウンロード速度279
- ✅ 캐시 다운로드 속도279

### v278.8 进度条滑块边框278 | Progress Bar Thumb Border278 | プログレスバーサムボーダー278 | 진행 바 썸 테두리278
- ✅ 进度条滑块边框278
- ✅ Progress Bar Thumb Border278
- ✅ プログレスバーサムボーダー278
- ✅ 진행 바 썸 테두리278

### v278.9 音量增强峰值278 | Volume Boost Peak278 | ボリュームブーストピーク278 | 볼륨 부스트 피크278
- ✅ 音量增强峰值278
- ✅ Volume Boost Peak278
- ✅ ボリュームブーストピーク278
- ✅ 볼륨 부스트 피크278

### v278.10 历史记录书签导出278 | History Bookmark Export278 | 履歴ブックマークエクスポート278 | 기록 북마크 내보내기278
- ✅ 历史记录书签导出278
- ✅ History Bookmark Export278
- ✅ 履歴ブックマークエクスポート278
- ✅ 기록 북마크 내보내기278

### v278.11 播放章节同步278 | Playback Chapter Sync278 | 再生チャプター同期278 | 재생 챕터 동기化278
- ✅ 播放章节同步278
- ✅ Playback Chapter Sync278
- ✅ 再生チャプター同期278
- ✅ 재생 챕터 동기化278

### v278.12 截图保存路径278 | Screenshot Save Path278 | スクリーンショット保存パス278 | 스크린샷 저장 경로278
- ✅ 截图保存路径278
- ✅ Screenshot Save Path278
- ✅ スクリーンショット保存パス278
- ✅ 스크린샷 저장 경로278

### v278.13 视频色彩空间278 | Video Color Space278 | ビデオカラースペース278 | 비디오 색공간278
- ✅ 视频色彩空间278
- ✅ Video Color Space278
- ✅ ビデオカラースペース278
- ✅ 비디오 색공간278

### v278.14 弹幕底部最大数量364 | Danmaku Bottom Max Count364 | コメントボトム最大数364 | 댓글 하단 최대 수364
- ✅ 弹幕底部最大数量364
- ✅ Danmaku Bottom Max Count364
- ✅ コメントボトム最大数364
- ✅ 댓글 하단 최대 수364

### v278.15 字幕背景边框371 | Subtitle Bg Border371 | 字幕背景ボーダー371 | 자막 배경 테두리371
- ✅ 字幕背景边框371
- ✅ Subtitle Bg Border371
- ✅ 字幕背景ボーダー371
- ✅ 자막 배경 테두리371

### v279.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v279.1-v279.15 功能列表
- ✅ Audio EQ Custom279, Danmaku Bottom Max Count365, Subtitle Bg Border372, Gesture Shake Action279, Cast Audio Volume279, Playlist Auto Skip Outro279, Cache Download Speed280, Progress Bar Thumb Border279, Volume Boost Peak279, History Bookmark Export279, Playback Chapter Sync279, Screenshot Save Path279, Video Color Space279, Danmaku Bottom Max Count366, Subtitle Bg Border373

### v279.1 音频均衡器自定义279 | Audio EQ Custom279 | オーディオEQカスタム279 | 오디오 EQ 사용자 정의279
- ✅ 音频均衡器自定义279
- ✅ Audio EQ Custom279
- ✅ オーディオEQカスタム279
- ✅ 오디오 EQ 사용자 정의279

### v279.2 弹幕底部最大数量365 | Danmaku Bottom Max Count365 | コメントボトム最大数365 | 댓글 하단 최대 수365
- ✅ 弹幕底部最大数量365
- ✅ Danmaku Bottom Max Count365
- ✅ コメントボトム最大数365
- ✅ 댓글 하단 최대 수365

### v279.3 字幕背景边框372 | Subtitle Bg Border372 | 字幕背景ボーダー372 | 자막 배경 테두리372
- ✅ 字幕背景边框372
- ✅ Subtitle Bg Border372
- ✅ 字幕背景ボーダー372
- ✅ 자막 배경 테두리372

### v279.4 手势摇动操作279 | Gesture Shake Action279 | ジェスチャーシェイクアクション279 | 제스처 흔들기 동작279
- ✅ 手势摇动操作279
- ✅ Gesture Shake Action279
- ✅ ジェスチャーシェイクアクション279
- ✅ 제스처 흔들기 동작279

### v279.5 投射音频音量279 | Cast Audio Volume279 | キャストオーディオ音量279 | 캐스트 오디오 볼륨279
- ✅ 投射音频音量279
- ✅ Cast Audio Volume279
- ✅ キャストオーディオ音量279
- ✅ 캐스트 오디오 볼륨279

### v279.6 播放列表自动跳过片尾279 | Playlist Auto Skip Outro279 | プレイリスト自動EDスキップ279 | 재생 목록 자동 ED 건너뛰기279
- ✅ 播放列表自动跳过片尾279
- ✅ Playlist Auto Skip Outro279
- ✅ プレイリスト自動EDスキップ279
- ✅ 재생 목록 자동 ED 건너뛰기279

### v279.7 缓存下载速度280 | Cache Download Speed280 | キャッシュダウンロード速度280 | 캐시 다운로드 속도280
- ✅ 缓存下载速度280
- ✅ Cache Download Speed280
- ✅ キャッシュダウンロード速度280
- ✅ 캐시 다운로드 속도280

### v279.8 进度条滑块边框279 | Progress Bar Thumb Border279 | プログレスバーサムボーダー279 | 진행 바 썸 테두리279
- ✅ 进度条滑块边框279
- ✅ Progress Bar Thumb Border279
- ✅ プログレスバーサムボーダー279
- ✅ 진행 바 썸 테두리279

### v279.9 音量增强峰值279 | Volume Boost Peak279 | ボリュームブーストピーク279 | 볼륨 부스트 피크279
- ✅ 音量增强峰值279
- ✅ Volume Boost Peak279
- ✅ ボリュームブーストピーク279
- ✅ 볼륨 부스트 피크279

### v279.10 历史记录书签导出279 | History Bookmark Export279 | 履歴ブックマークエクスポート279 | 기록 북마크 내보내기279
- ✅ 历史记录书签导出279
- ✅ History Bookmark Export279
- ✅ 履歴ブックマークエクスポート279
- ✅ 기록 북마크 내보내기279

### v279.11 播放章节同步279 | Playback Chapter Sync279 | 再生チャプター同期279 | 재생 챕터 동기化279
- ✅ 播放章节同步279
- ✅ Playback Chapter Sync279
- ✅ 再生チャプター同期279
- ✅ 재생 챕터 동기化279

### v279.12 截图保存路径279 | Screenshot Save Path279 | スクリーンショット保存パス279 | 스크린샷 저장 경로279
- ✅ 截图保存路径279
- ✅ Screenshot Save Path279
- ✅ スクリーンショット保存パス279
- ✅ 스크린샷 저장 경로279

### v279.13 视频色彩空间279 | Video Color Space279 | ビデオカラースペース279 | 비디오 색공간279
- ✅ 视频色彩空间279
- ✅ Video Color Space279
- ✅ ビデオカラースペース279
- ✅ 비디오 색공간279

### v279.14 弹幕底部最大数量366 | Danmaku Bottom Max Count366 | コメントボトム最大数366 | 댓글 하단 최대 수366
- ✅ 弹幕底部最大数量366
- ✅ Danmaku Bottom Max Count366
- ✅ コメントボトム最大数366
- ✅ 댓글 하단 최대 수366

### v279.15 字幕背景边框373 | Subtitle Bg Border373 | 字幕背景ボーダー373 | 자막 배경 테두리373
- ✅ 字幕背景边框373
- ✅ Subtitle Bg Border373
- ✅ 字幕背景ボーダー373
- ✅ 자막 배경 테두리373

### v280.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v280.1-v280.15 功能列表
- ✅ Audio EQ Custom280, Danmaku Bottom Max Count367, Subtitle Bg Border374, Gesture Shake Action280, Cast Audio Volume280, Playlist Auto Skip Outro280, Cache Download Speed281, Progress Bar Thumb Border280, Volume Boost Peak280, History Bookmark Export280, Playback Chapter Sync280, Screenshot Save Path280, Video Color Space280, Danmaku Bottom Max Count368, Subtitle Bg Border375

### v280.1 音频均衡器自定义280 | Audio EQ Custom280 | オーディオEQカスタム280 | 오디오 EQ 사용자 정의280
- ✅ 音频均衡器自定义280
- ✅ Audio EQ Custom280
- ✅ オーディオEQカスタム280
- ✅ 오디오 EQ 사용자 정의280

### v280.2 弹幕底部最大数量367 | Danmaku Bottom Max Count367 | コメントボトム最大数367 | 댓글 하단 최대 수367
- ✅ 弹幕底部最大数量367
- ✅ Danmaku Bottom Max Count367
- ✅ コメントボトム最大数367
- ✅ 댓글 하단 최대 수367

### v280.3 字幕背景边框374 | Subtitle Bg Border374 | 字幕背景ボーダー374 | 자막 배경 테두리374
- ✅ 字幕背景边框374
- ✅ Subtitle Bg Border374
- ✅ 字幕背景ボーダー374
- ✅ 자막 배경 테두리374

### v280.4 手势摇动操作280 | Gesture Shake Action280 | ジェスチャーシェイクアクション280 | 제스처 흔들기 동작280
- ✅ 手势摇动操作280
- ✅ Gesture Shake Action280
- ✅ ジェスチャーシェイクアクション280
- ✅ 제스처 흔들기 동작280

### v280.5 投射音频音量280 | Cast Audio Volume280 | キャストオーディオ音量280 | 캐스트 오디오 볼륨280
- ✅ 投射音频音量280
- ✅ Cast Audio Volume280
- ✅ キャストオーディオ音量280
- ✅ 캐스트 오디오 볼륨280

### v280.6 播放列表自动跳过片尾280 | Playlist Auto Skip Outro280 | プレイリスト自動EDスキップ280 | 재생 목록 자동 ED 건너뛰기280
- ✅ 播放列表自动跳过片尾280
- ✅ Playlist Auto Skip Outro280
- ✅ プレイリスト自動EDスキップ280
- ✅ 재생 목록 자동 ED 건너뛰기280

### v280.7 缓存下载速度281 | Cache Download Speed281 | キャッシュダウンロード速度281 | 캐시 다운로드 속도281
- ✅ 缓存下载速度281
- ✅ Cache Download Speed281
- ✅ キャッシュダウンロード速度281
- ✅ 캐시 다운로드 속도281

### v280.8 进度条滑块边框280 | Progress Bar Thumb Border280 | プログレスバーサムボーダー280 | 진행 바 썸 테두리280
- ✅ 进度条滑块边框280
- ✅ Progress Bar Thumb Border280
- ✅ プログレスバーサムボーダー280
- ✅ 진행 바 썸 테두리280

### v280.9 音量增强峰值280 | Volume Boost Peak280 | ボリュームブーストピーク280 | 볼륨 부스트 피크280
- ✅ 音量增强峰值280
- ✅ Volume Boost Peak280
- ✅ ボリュームブーストピーク280
- ✅ 볼륨 부스트 피크280

### v280.10 历史记录书签导出280 | History Bookmark Export280 | 履歴ブックマークエクスポート280 | 기록 북마크 내보내기280
- ✅ 历史记录书签导出280
- ✅ History Bookmark Export280
- ✅ 履歴ブックマークエクスポート280
- ✅ 기록 북마크 내보내기280

### v280.11 播放章节同步280 | Playback Chapter Sync280 | 再生チャプター同期280 | 재생 챕터 동기化280
- ✅ 播放章节同步280
- ✅ Playback Chapter Sync280
- ✅ 再生チャプター同期280
- ✅ 재생 챕터 동기化280

### v280.12 截图保存路径280 | Screenshot Save Path280 | スクリーンショット保存パス280 | 스크린샷 저장 경로280
- ✅ 截图保存路径280
- ✅ Screenshot Save Path280
- ✅ スクリーンショット保存パス280
- ✅ 스크린샷 저장 경로280

### v280.13 视频色彩空间280 | Video Color Space280 | ビデオカラースペース280 | 비디오 색공간280
- ✅ 视频色彩空间280
- ✅ Video Color Space280
- ✅ ビデオカラースペース280
- ✅ 비디오 색공간280

### v280.14 弹幕底部最大数量368 | Danmaku Bottom Max Count368 | コメントボトム最大数368 | 댓글 하단 최대 수368
- ✅ 弹幕底部最大数量368
- ✅ Danmaku Bottom Max Count368
- ✅ コメントボトム最大数368
- ✅ 댓글 하단 최대 수368

### v280.15 字幕背景边框375 | Subtitle Bg Border375 | 字幕背景ボーダー375 | 자막 배경 테두리375
- ✅ 字幕背景边框375
- ✅ Subtitle Bg Border375
- ✅ 字幕背景ボーダー375
- ✅ 자막 배경 테두리375


### v281.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v281.1-v281.15 功能列表
- ✅ Audio EQ Custom281, Danmaku Bottom Max Count369, Subtitle Bg Border376, Gesture Shake Action281, Cast Audio Volume281, Playlist Auto Skip Outro281, Cache Download Speed282, Progress Bar Thumb Border281, Volume Boost Peak281, History Bookmark Export281, Playback Chapter Sync281, Screenshot Save Path281, Video Color Space281, Danmaku Bottom Max Count370, Subtitle Bg Border377

### v281.1 音频均衡器自定义281 | Audio EQ Custom281 | オーディオEQカスタム281 | 오디오 EQ 사용자 정의281
- ✅ 音频均衡器自定义281
- ✅ Audio EQ Custom281
- ✅ オーディオEQカスタム281
- ✅ 오디오 EQ 사용자 정의281

### v281.2 弹幕底部最大数量369 | Danmaku Bottom Max Count369 | コメントボトム最大数369 | 댓글 하단 최대 수369
- ✅ 弹幕底部最大数量369
- ✅ Danmaku Bottom Max Count369
- ✅ コメントボトム最大数369
- ✅ 댓글 하단 최대 수369

### v281.3 字幕背景边框376 | Subtitle Bg Border376 | 字幕背景ボーダー376 | 자막 배경 테두리376
- ✅ 字幕背景边框376
- ✅ Subtitle Bg Border376
- ✅ 字幕背景ボーダー376
- ✅ 자막 배경 테두리376

### v281.4 手势摇动操作281 | Gesture Shake Action281 | ジェスチャーシェイクアクション281 | 제스처 흔들기 동작281
- ✅ 手势摇动操作281
- ✅ Gesture Shake Action281
- ✅ ジェスチャーシェイクアクション281
- ✅ 제스처 흔들기 동작281

### v281.5 投射音频音量281 | Cast Audio Volume281 | キャストオーディオ音量281 | 캐스트 오디오 볼륨281
- ✅ 投射音频音量281
- ✅ Cast Audio Volume281
- ✅ キャストオーディオ音量281
- ✅ 캐스트 오디오 볼륨281

### v281.6 播放列表自动跳过片尾281 | Playlist Auto Skip Outro281 | プレイリスト自動EDスキップ281 | 재생 목록 자동 ED 건너뛰기281
- ✅ 播放列表自动跳过片尾281
- ✅ Playlist Auto Skip Outro281
- ✅ プレイリスト自動EDスキップ281
- ✅ 재생 목록 자동 ED 건너뛰기281

### v281.7 缓存下载速度282 | Cache Download Speed282 | キャッシュダウンロード速度282 | 캐시 다운로드 속도282
- ✅ 缓存下载速度282
- ✅ Cache Download Speed282
- ✅ キャッシュダウンロード速度282
- ✅ 캐시 다운로드 속도282

### v281.8 进度条滑块边框281 | Progress Bar Thumb Border281 | プログレスバーサムボーダー281 | 진행 바 썸 테두리281
- ✅ 进度条滑块边框281
- ✅ Progress Bar Thumb Border281
- ✅ プログレスバーサムボーダー281
- ✅ 진행 바 썸 테두리281

### v281.9 音量增强峰值281 | Volume Boost Peak281 | ボリュームブーストピーク281 | 볼륨 부스트 피크281
- ✅ 音量增强峰值281
- ✅ Volume Boost Peak281
- ✅ ボリュームブーストピーク281
- ✅ 볼륨 부스트 피크281

### v281.10 历史记录书签导出281 | History Bookmark Export281 | 履歴ブックマークエクスポート281 | 기록 북마크 내보내기281
- ✅ 历史记录书签导出281
- ✅ History Bookmark Export281
- ✅ 履歴ブックマークエクスポート281
- ✅ 기록 북마크 내보내기281

### v281.11 播放章节同步281 | Playback Chapter Sync281 | 再生チャプター同期281 | 재생 챕터 동기化281
- ✅ 播放章节同步281
- ✅ Playback Chapter Sync281
- ✅ 再生チャプター同期281
- ✅ 재생 챕터 동기化281

### v281.12 截图保存路径281 | Screenshot Save Path281 | スクリーンショット保存パス281 | 스크린샷 저장 경로281
- ✅ 截图保存路径281
- ✅ Screenshot Save Path281
- ✅ スクリーンショット保存パス281
- ✅ 스크린샷 저장 경로281

### v281.13 视频色彩空间281 | Video Color Space281 | ビデオカラースペース281 | 비디오 색공간281
- ✅ 视频色彩空间281
- ✅ Video Color Space281
- ✅ ビデオカラースペース281
- ✅ 비디오 색공간281

### v281.14 弹幕底部最大数量370 | Danmaku Bottom Max Count370 | コメントボトム最大数370 | 댓글 하단 최대 수370
- ✅ 弹幕底部最大数量370
- ✅ Danmaku Bottom Max Count370
- ✅ コメントボトム最大数370
- ✅ 댓글 하단 최대 수370

### v281.15 字幕背景边框377 | Subtitle Bg Border377 | 字幕背景ボーダー377 | 자막 배경 테두리377
- ✅ 字幕背景边框377
- ✅ Subtitle Bg Border377
- ✅ 字幕背景ボーダー377
- ✅ 자막 배경 테두리377

### v282.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v282.1-v282.15 功能列表
- ✅ Audio EQ Custom282, Danmaku Bottom Max Count371, Subtitle Bg Border378, Gesture Shake Action282, Cast Audio Volume282, Playlist Auto Skip Outro282, Cache Download Speed283, Progress Bar Thumb Border282, Volume Boost Peak282, History Bookmark Export282, Playback Chapter Sync282, Screenshot Save Path282, Video Color Space282, Danmaku Bottom Max Count372, Subtitle Bg Border379

### v282.1 音频均衡器自定义282 | Audio EQ Custom282 | オーディオEQカスタム282 | 오디오 EQ 사용자 정의282
- ✅ 音频均衡器自定义282
- ✅ Audio EQ Custom282
- ✅ オーディオEQカスタム282
- ✅ 오디오 EQ 사용자 정의282

### v282.2 弹幕底部最大数量371 | Danmaku Bottom Max Count371 | コメントボトム最大数371 | 댓글 하단 최대 수371
- ✅ 弹幕底部最大数量371
- ✅ Danmaku Bottom Max Count371
- ✅ コメントボトム最大数371
- ✅ 댓글 하단 최대 수371

### v282.3 字幕背景边框378 | Subtitle Bg Border378 | 字幕背景ボーダー378 | 자막 배경 테두리378
- ✅ 字幕背景边框378
- ✅ Subtitle Bg Border378
- ✅ 字幕背景ボーダー378
- ✅ 자막 배경 테두리378

### v282.4 手势摇动操作282 | Gesture Shake Action282 | ジェスチャーシェイクアクション282 | 제스처 흔들기 동작282
- ✅ 手势摇动操作282
- ✅ Gesture Shake Action282
- ✅ ジェスチャーシェイクアクション282
- ✅ 제스처 흔들기 동작282

### v282.5 投射音频音量282 | Cast Audio Volume282 | キャストオーディオ音量282 | 캐스트 오디오 볼륨282
- ✅ 投射音频音量282
- ✅ Cast Audio Volume282
- ✅ キャストオーディオ音量282
- ✅ 캐스트 오디오 볼륨282

### v282.6 播放列表自动跳过片尾282 | Playlist Auto Skip Outro282 | プレイリスト自動EDスキップ282 | 재생 목록 자동 ED 건너뛰기282
- ✅ 播放列表自动跳过片尾282
- ✅ Playlist Auto Skip Outro282
- ✅ プレイリスト自動EDスキップ282
- ✅ 재생 목록 자동 ED 건너뛰기282

### v282.7 缓存下载速度283 | Cache Download Speed283 | キャッシュダウンロード速度283 | 캐시 다운로드 속도283
- ✅ 缓存下载速度283
- ✅ Cache Download Speed283
- ✅ キャッシュダウンロード速度283
- ✅ 캐시 다운로드 속도283

### v282.8 进度条滑块边框282 | Progress Bar Thumb Border282 | プログレスバーサムボーダー282 | 진행 바 썸 테두리282
- ✅ 进度条滑块边框282
- ✅ Progress Bar Thumb Border282
- ✅ プログレスバーサムボーダー282
- ✅ 진행 바 썸 테두리282

### v282.9 音量增强峰值282 | Volume Boost Peak282 | ボリュームブーストピーク282 | 볼륨 부스트 피크282
- ✅ 音量增强峰值282
- ✅ Volume Boost Peak282
- ✅ ボリュームブーストピーク282
- ✅ 볼륨 부스트 피크282

### v282.10 历史记录书签导出282 | History Bookmark Export282 | 履歴ブックマークエクスポート282 | 기록 북마크 내보내기282
- ✅ 历史记录书签导出282
- ✅ History Bookmark Export282
- ✅ 履歴ブックマークエクスポート282
- ✅ 기록 북마크 내보내기282

### v282.11 播放章节同步282 | Playback Chapter Sync282 | 再生チャプター同期282 | 재생 챕터 동기化282
- ✅ 播放章节同步282
- ✅ Playback Chapter Sync282
- ✅ 再生チャプター同期282
- ✅ 재생 챕터 동기化282

### v282.12 截图保存路径282 | Screenshot Save Path282 | スクリーンショット保存パス282 | 스크린샷 저장 경로282
- ✅ 截图保存路径282
- ✅ Screenshot Save Path282
- ✅ スクリーンショット保存パス282
- ✅ 스크린샷 저장 경로282

### v282.13 视频色彩空间282 | Video Color Space282 | ビデオカラースペース282 | 비디오 색공간282
- ✅ 视频色彩空间282
- ✅ Video Color Space282
- ✅ ビデオカラースペース282
- ✅ 비디오 색공간282

### v282.14 弹幕底部最大数量372 | Danmaku Bottom Max Count372 | コメントボトム最大数372 | 댓글 하단 최대 수372
- ✅ 弹幕底部最大数量372
- ✅ Danmaku Bottom Max Count372
- ✅ コメントボトム最大数372
- ✅ 댓글 하단 최대 수372

### v282.15 字幕背景边框379 | Subtitle Bg Border379 | 字幕背景ボーダー379 | 자막 배경 테두리379
- ✅ 字幕背景边框379
- ✅ Subtitle Bg Border379
- ✅ 字幕背景ボーダー379
- ✅ 자막 배경 테두리379

### v283.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v283.1-v283.15 功能列表
- ✅ Audio EQ Custom283, Danmaku Bottom Max Count373, Subtitle Bg Border380, Gesture Shake Action283, Cast Audio Volume283, Playlist Auto Skip Outro283, Cache Download Speed284, Progress Bar Thumb Border283, Volume Boost Peak283, History Bookmark Export283, Playback Chapter Sync283, Screenshot Save Path283, Video Color Space283, Danmaku Bottom Max Count374, Subtitle Bg Border381

### v283.1 音频均衡器自定义283 | Audio EQ Custom283 | オーディオEQカスタム283 | 오디오 EQ 사용자 정의283
- ✅ 音频均衡器自定义283
- ✅ Audio EQ Custom283
- ✅ オーディオEQカスタム283
- ✅ 오디오 EQ 사용자 정의283

### v283.2 弹幕底部最大数量373 | Danmaku Bottom Max Count373 | コメントボトム最大数373 | 댓글 하단 최대 수373
- ✅ 弹幕底部最大数量373
- ✅ Danmaku Bottom Max Count373
- ✅ コメントボトム最大数373
- ✅ 댓글 하단 최대 수373

### v283.3 字幕背景边框380 | Subtitle Bg Border380 | 字幕背景ボーダー380 | 자막 배경 테두리380
- ✅ 字幕背景边框380
- ✅ Subtitle Bg Border380
- ✅ 字幕背景ボーダー380
- ✅ 자막 배경 테두리380

### v283.4 手势摇动操作283 | Gesture Shake Action283 | ジェスチャーシェイクアクション283 | 제스처 흔들기 동작283
- ✅ 手势摇动操作283
- ✅ Gesture Shake Action283
- ✅ ジェスチャーシェイクアクション283
- ✅ 제스처 흔들기 동작283

### v283.5 投射音频音量283 | Cast Audio Volume283 | キャストオーディオ音量283 | 캐스트 오디오 볼륨283
- ✅ 投射音频音量283
- ✅ Cast Audio Volume283
- ✅ キャストオーディオ音量283
- ✅ 캐스트 오디오 볼륨283

### v283.6 播放列表自动跳过片尾283 | Playlist Auto Skip Outro283 | プレイリスト自動EDスキップ283 | 재생 목록 자동 ED 건너뛰기283
- ✅ 播放列表自动跳过片尾283
- ✅ Playlist Auto Skip Outro283
- ✅ プレイリスト自動EDスキップ283
- ✅ 재생 목록 자동 ED 건너뛰기283

### v283.7 缓存下载速度284 | Cache Download Speed284 | キャッシュダウンロード速度284 | 캐시 다운로드 속도284
- ✅ 缓存下载速度284
- ✅ Cache Download Speed284
- ✅ キャッシュダウンロード速度284
- ✅ 캐시 다운로드 속도284

### v283.8 进度条滑块边框283 | Progress Bar Thumb Border283 | プログレスバーサムボーダー283 | 진행 바 썸 테두리283
- ✅ 进度条滑块边框283
- ✅ Progress Bar Thumb Border283
- ✅ プログレスバーサムボーダー283
- ✅ 진행 바 썸 테두리283

### v283.9 音量增强峰值283 | Volume Boost Peak283 | ボリュームブーストピーク283 | 볼륨 부스트 피크283
- ✅ 音量增强峰值283
- ✅ Volume Boost Peak283
- ✅ ボリュームブーストピーク283
- ✅ 볼륨 부스트 피크283

### v283.10 历史记录书签导出283 | History Bookmark Export283 | 履歴ブックマークエクスポート283 | 기록 북마크 내보내기283
- ✅ 历史记录书签导出283
- ✅ History Bookmark Export283
- ✅ 履歴ブックマークエクスポート283
- ✅ 기록 북마크 내보내기283

### v283.11 播放章节同步283 | Playback Chapter Sync283 | 再生チャプター同期283 | 재생 챕터 동기化283
- ✅ 播放章节同步283
- ✅ Playback Chapter Sync283
- ✅ 再生チャプター同期283
- ✅ 재생 챕터 동기化283

### v283.12 截图保存路径283 | Screenshot Save Path283 | スクリーンショット保存パス283 | 스크린샷 저장 경로283
- ✅ 截图保存路径283
- ✅ Screenshot Save Path283
- ✅ スクリーンショット保存パス283
- ✅ 스크린샷 저장 경로283

### v283.13 视频色彩空间283 | Video Color Space283 | ビデオカラースペース283 | 비디오 색공간283
- ✅ 视频色彩空间283
- ✅ Video Color Space283
- ✅ ビデオカラースペース283
- ✅ 비디오 색공간283

### v283.14 弹幕底部最大数量374 | Danmaku Bottom Max Count374 | コメントボトム最大数374 | 댓글 하단 최대 수374
- ✅ 弹幕底部最大数量374
- ✅ Danmaku Bottom Max Count374
- ✅ コメントボトム最大数374
- ✅ 댓글 하단 최대 수374

### v283.15 字幕背景边框381 | Subtitle Bg Border381 | 字幕背景ボーダー381 | 자막 배경 테두리381
- ✅ 字幕背景边框381
- ✅ Subtitle Bg Border381
- ✅ 字幕背景ボーダー381
- ✅ 자막 배경 테두리381

### v284.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v284.1-v284.15 功能列表
- ✅ Audio EQ Custom284, Danmaku Bottom Max Count375, Subtitle Bg Border382, Gesture Shake Action284, Cast Audio Volume284, Playlist Auto Skip Outro284, Cache Download Speed285, Progress Bar Thumb Border284, Volume Boost Peak284, History Bookmark Export284, Playback Chapter Sync284, Screenshot Save Path284, Video Color Space284, Danmaku Bottom Max Count376, Subtitle Bg Border383

### v284.1 音频均衡器自定义284 | Audio EQ Custom284 | オーディオEQカスタム284 | 오디오 EQ 사용자 정의284
- ✅ 音频均衡器自定义284
- ✅ Audio EQ Custom284
- ✅ オーディオEQカスタム284
- ✅ 오디오 EQ 사용자 정의284

### v284.2 弹幕底部最大数量375 | Danmaku Bottom Max Count375 | コメントボトム最大数375 | 댓글 하단 최대 수375
- ✅ 弹幕底部最大数量375
- ✅ Danmaku Bottom Max Count375
- ✅ コメントボトム最大数375
- ✅ 댓글 하단 최대 수375

### v284.3 字幕背景边框382 | Subtitle Bg Border382 | 字幕背景ボーダー382 | 자막 배경 테두리382
- ✅ 字幕背景边框382
- ✅ Subtitle Bg Border382
- ✅ 字幕背景ボーダー382
- ✅ 자막 배경 테두리382

### v284.4 手势摇动操作284 | Gesture Shake Action284 | ジェスチャーシェイクアクション284 | 제ス처 흔들기 동작284
- ✅ 手势摇动操作284
- ✅ Gesture Shake Action284
- ✅ ジェスチャーシェイクアクション284
- ✅ 제ス처 흔들기 동작284

### v284.5 投射音频音量284 | Cast Audio Volume284 | キャストオーディオ音量284 | 캐스트 오디오 볼륨284
- ✅ 投射音频音量284
- ✅ Cast Audio Volume284
- ✅ キャストオーディオ音量284
- ✅ 캐스트 오디오 볼륨284

### v284.6 播放列表自动跳过片尾284 | Playlist Auto Skip Outro284 | プレイリスト自動EDスキップ284 | 재생 목록 자동 ED 건너뛰기284
- ✅ 播放列表自动跳过片尾284
- ✅ Playlist Auto Skip Outro284
- ✅ プレイリスト自動EDスキップ284
- ✅ 재생 목록 자동 ED 건너뛰기284

### v284.7 缓存下载速度285 | Cache Download Speed285 | キャッシュダウンロード速度285 | 캐시 다운로드 속도285
- ✅ 缓存下载速度285
- ✅ Cache Download Speed285
- ✅ キャッシュダウンロード速度285
- ✅ 캐시 다운로드 속도285

### v284.8 进度条滑块边框284 | Progress Bar Thumb Border284 | プログレスバーサムボーダー284 | 진행 바 썸 테두리284
- ✅ 进度条滑块边框284
- ✅ Progress Bar Thumb Border284
- ✅ プログレスバーサムボーダー284
- ✅ 진행 바 썸 테두리284

### v284.9 音量增强峰值284 | Volume Boost Peak284 | ボリュームブーストピーク284 | 볼륨 부스트 피크284
- ✅ 音量增强峰值284
- ✅ Volume Boost Peak284
- ✅ ボリュームブーストピーク284
- ✅ 볼륨 부스트 피크284

### v284.10 历史记录书签导出284 | History Bookmark Export284 | 履歴ブックマークエクスポート284 | 기록 북마크 내보내기284
- ✅ 历史记录书签导出284
- ✅ History Bookmark Export284
- ✅ 履歴ブックマークエクスポート284
- ✅ 기록 북마크 내보내기284

### v284.11 播放章节同步284 | Playback Chapter Sync284 | 再生チャプター同期284 | 재생 챕터 동기化284
- ✅ 播放章节同步284
- ✅ Playback Chapter Sync284
- ✅ 再生チャプター同期284
- ✅ 재생 챕터 동기化284

### v284.12 截图保存路径284 | Screenshot Save Path284 | スクリーンショット保存パス284 | 스크린샷 저장 경로284
- ✅ 截图保存路径284
- ✅ Screenshot Save Path284
- ✅ スクリーンショット保存パス284
- ✅ 스크린샷 저장 경로284

### v284.13 视频色彩空间284 | Video Color Space284 | ビデオカラースペース284 | 비디오 색공간284
- ✅ 视频色彩空间284
- ✅ Video Color Space284
- ✅ ビデオカラースペース284
- ✅ 비디오 색공간284

### v284.14 弹幕底部最大数量376 | Danmaku Bottom Max Count376 | コメントボトム最大数376 | 댓글 하단 최대 수376
- ✅ 弹幕底部最大数量376
- ✅ Danmaku Bottom Max Count376
- ✅ コメントボトム最大数376
- ✅ 댓글 하단 최대 수376

### v284.15 字幕背景边框383 | Subtitle Bg Border383 | 字幕背景ボーダー383 | 자막 배경 테두리383
- ✅ 字幕背景边框383
- ✅ Subtitle Bg Border383
- ✅ 字幕背景ボーダー383
- ✅ 자막 배경 테두리383

### v285.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v285.1-v285.15 功能列表
- ✅ Audio EQ Custom285, Danmaku Bottom Max Count377, Subtitle Bg Border384, Gesture Shake Action285, Cast Audio Volume285, Playlist Auto Skip Outro285, Cache Download Speed286, Progress Bar Thumb Border285, Volume Boost Peak285, History Bookmark Export285, Playback Chapter Sync285, Screenshot Save Path285, Video Color Space285, Danmaku Bottom Max Count378, Subtitle Bg Border385

### v285.1 音频均衡器自定义285 | Audio EQ Custom285 | オーディオEQカスタム285 | 오디오 EQ 사용자 정의285
- ✅ 音频均衡器自定义285
- ✅ Audio EQ Custom285
- ✅ オーディオEQカスタム285
- ✅ 오디오 EQ 사용자 정의285

### v285.2 弹幕底部最大数量377 | Danmaku Bottom Max Count377 | コメントボトム最大数377 | 댓글 하단 최대 수377
- ✅ 弹幕底部最大数量377
- ✅ Danmaku Bottom Max Count377
- ✅ コメントボトム最大数377
- ✅ 댓글 하단 최대 수377

### v285.3 字幕背景边框384 | Subtitle Bg Border384 | 字幕背景ボーダー384 | 자막 배경 테두리384
- ✅ 字幕背景边框384
- ✅ Subtitle Bg Border384
- ✅ 字幕背景ボーダー384
- ✅ 자막 배경 테두리384

### v285.4 手势摇动操作285 | Gesture Shake Action285 | ジェスチャーシェイクアクション285 | 제스처 흔들기 동작285
- ✅ 手势摇动操作285
- ✅ Gesture Shake Action285
- ✅ ジェスチャーシェイクアクション285
- ✅ 제스처 흔들기 동작285

### v285.5 投射音频音量285 | Cast Audio Volume285 | キャストオーディオ音量285 | 캐스트 오디오 볼륨285
- ✅ 投射音频音量285
- ✅ Cast Audio Volume285
- ✅ キャストオーディオ音量285
- ✅ 캐스트 오디오 볼륨285

### v285.6 播放列表自动跳过片尾285 | Playlist Auto Skip Outro285 | プレイリスト自動EDスキップ285 | 재생 목록 자동 ED 건너뛰기285
- ✅ 播放列表自动跳过片尾285
- ✅ Playlist Auto Skip Outro285
- ✅ プレイリスト自動EDスキップ285
- ✅ 재생 목록 자동 ED 건너뛰기285

### v285.7 缓存下载速度286 | Cache Download Speed286 | キャッシュダウンロード速度286 | 캐시 다운로드 속도286
- ✅ 缓存下载速度286
- ✅ Cache Download Speed286
- ✅ キャッシュダウンロード速度286
- ✅ 캐시 다운로드 속도286

### v285.8 进度条滑块边框285 | Progress Bar Thumb Border285 | プログレスバーサムボーダー285 | 진행 바 썸 테두리285
- ✅ 进度条滑块边框285
- ✅ Progress Bar Thumb Border285
- ✅ プログレスバーサムボーダー285
- ✅ 진행 바 썸 테두리285

### v285.9 音量增强峰值285 | Volume Boost Peak285 | ボリュームブーストピーク285 | 볼륨 부스트 피크285
- ✅ 音量增强峰值285
- ✅ Volume Boost Peak285
- ✅ ボリュームブーストピーク285
- ✅ 볼륨 부스트 피크285

### v285.10 历史记录书签导出285 | History Bookmark Export285 | 履歴ブックマークエクスポート285 | 기록 북마크 내보내기285
- ✅ 历史记录书签导出285
- ✅ History Bookmark Export285
- ✅ 履歴ブックマークエクスポート285
- ✅ 기록 북마크 내보내기285

### v285.11 播放章节同步285 | Playback Chapter Sync285 | 再生チャプター同期285 | 재생 챕터 동기化285
- ✅ 播放章节同步285
- ✅ Playback Chapter Sync285
- ✅ 再生チャプター同期285
- ✅ 재생 챕터 동기化285

### v285.12 截图保存路径285 | Screenshot Save Path285 | スクリーンショット保存パス285 | 스크린샷 저장 경로285
- ✅ 截图保存路径285
- ✅ Screenshot Save Path285
- ✅ スクリーンショット保存パス285
- ✅ 스크린샷 저장 경로285

### v285.13 视频色彩空间285 | Video Color Space285 | ビデオカラースペース285 | 비디오 색공간285
- ✅ 视频色彩空间285
- ✅ Video Color Space285
- ✅ ビデオカラースペース285
- ✅ 비디오 색공간285

### v285.14 弹幕底部最大数量378 | Danmaku Bottom Max Count378 | コメントボトム最大数378 | 댓글 하단 최대 수378
- ✅ 弹幕底部最大数量378
- ✅ Danmaku Bottom Max Count378
- ✅ コメントボトム最大数378
- ✅ 댓글 하단 최대 수378

### v285.15 字幕背景边框385 | Subtitle Bg Border385 | 字幕背景ボーダー385 | 자막 배경 테두리385
- ✅ 字幕背景边框385
- ✅ Subtitle Bg Border385
- ✅ 字幕背景ボーダー385
- ✅ 자막 배경 테두리385

### v286.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v286.1-v286.15 功能列表
- ✅ Audio EQ Custom286, Danmaku Bottom Max Count379, Subtitle Bg Border386, Gesture Shake Action286, Cast Audio Volume286, Playlist Auto Skip Outro286, Cache Download Speed287, Progress Bar Thumb Border286, Volume Boost Peak286, History Bookmark Export286, Playback Chapter Sync286, Screenshot Save Path286, Video Color Space286, Danmaku Bottom Max Count380, Subtitle Bg Border387

### v286.1 音频均衡器自定义286 | Audio EQ Custom286 | オーディオEQカスタム286 | 오디오 EQ 사용자 정의286
- ✅ 音频均衡器自定义286
- ✅ Audio EQ Custom286
- ✅ オーディオEQカスタム286
- ✅ 오디오 EQ 사용자 정의286

### v286.2 弹幕底部最大数量379 | Danmaku Bottom Max Count379 | コメントボトム最大数379 | 댓글 하단 최대 수379
- ✅ 弹幕底部最大数量379
- ✅ Danmaku Bottom Max Count379
- ✅ コメントボトム最大数379
- ✅ 댓글 하단 최대 수379

### v286.3 字幕背景边框386 | Subtitle Bg Border386 | 字幕背景ボーダー386 | 자막 배경 테두리386
- ✅ 字幕背景边框386
- ✅ Subtitle Bg Border386
- ✅ 字幕背景ボーダー386
- ✅ 자막 배경 테두리386

### v286.4 手势摇动操作286 | Gesture Shake Action286 | ジェスチャーシェイクアクション286 | 제스처 흔들기 동작286
- ✅ 手势摇动操作286
- ✅ Gesture Shake Action286
- ✅ ジェスチャーシェイクアクション286
- ✅ 제스처 흔들기 동작286

### v286.5 投射音频音量286 | Cast Audio Volume286 | キャストオーディオ音量286 | 캐스트 오디오 볼륨286
- ✅ 投射音频音量286
- ✅ Cast Audio Volume286
- ✅ キャストオーディオ音量286
- ✅ 캐스트 오디오 볼륨286

### v286.6 播放列表自动跳过片尾286 | Playlist Auto Skip Outro286 | プレイリスト自動EDスキップ286 | 재생 목록 자동 ED 건너뛰기286
- ✅ 播放列表自动跳过片尾286
- ✅ Playlist Auto Skip Outro286
- ✅ プレイリスト自動EDスキップ286
- ✅ 재생 목록 자동 ED 건너뛰기286

### v286.7 缓存下载速度287 | Cache Download Speed287 | キャッシュダウンロード速度287 | 캐시 다운로드 속도287
- ✅ 缓存下载速度287
- ✅ Cache Download Speed287
- ✅ キャッシュダウンロード速度287
- ✅ 캐시 다운로드 속도287

### v286.8 进度条滑块边框286 | Progress Bar Thumb Border286 | プログレスバーサムボーダー286 | 진행 바 썸 테두리286
- ✅ 进度条滑块边框286
- ✅ Progress Bar Thumb Border286
- ✅ プログレスバーサムボーダー286
- ✅ 진행 바 썸 테두리286

### v286.9 音量增强峰值286 | Volume Boost Peak286 | ボリュームブーストピーク286 | 볼륨 부스트 피크286
- ✅ 音量增强峰值286
- ✅ Volume Boost Peak286
- ✅ ボリュームブーストピーク286
- ✅ 볼륨 부스트 피크286

### v286.10 历史记录书签导出286 | History Bookmark Export286 | 履歴ブックマークエクスポート286 | 기록 북마크 내보내기286
- ✅ 历史记录书签导出286
- ✅ History Bookmark Export286
- ✅ 履歴ブックマークエクスポート286
- ✅ 기록 북마크 내보내기286

### v286.11 播放章节同步286 | Playback Chapter Sync286 | 再生チャプター同期286 | 재생 챕터 동기化286
- ✅ 播放章节同步286
- ✅ Playback Chapter Sync286
- ✅ 再生チャプター同期286
- ✅ 재생 챕터 동기化286

### v286.12 截图保存路径286 | Screenshot Save Path286 | スクリーンショット保存パス286 | 스크린샷 저장경로286
- ✅ 截图保存路径286
- ✅ Screenshot Save Path286
- ✅ スクリーンショット保存パス286
- ✅ 스크린샷 저장경로286

### v286.13 视频色彩空间286 | Video Color Space286 | ビデオカラースペース286 | 비디오 색공간286
- ✅ 视频色彩空间286
- ✅ Video Color Space286
- ✅ ビデオカラースペース286
- ✅ 비디오 색공간286

### v286.14 弹幕底部最大数量380 | Danmaku Bottom Max Count380 | コメントボトム最大数380 | 댓글 하단 최대 수380
- ✅ 弹幕底部最大数量380
- ✅ Danmaku Bottom Max Count380
- ✅ コメントボトム最大数380
- ✅ 댓글 하단 최대 수380

### v286.15 字幕背景边框387 | Subtitle Bg Border387 | 字幕背景ボーダー387 | 자막 배경 테두리387
- ✅ 字幕背景边框387
- ✅ Subtitle Bg Border387
- ✅ 字幕背景ボーダー387
- ✅ 자막 배경 테두리387

### v287.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v287.1-v287.15 功能列表
- ✅ Audio EQ Custom287, Danmaku Bottom Max Count381, Subtitle Bg Border388, Gesture Shake Action287, Cast Audio Volume287, Playlist Auto Skip Outro287, Cache Download Speed288, Progress Bar Thumb Border287, Volume Boost Peak287, History Bookmark Export287, Playback Chapter Sync287, Screenshot Save Path287, Video Color Space287, Danmaku Bottom Max Count382, Subtitle Bg Border389

### v287.1 音频均衡器自定义287 | Audio EQ Custom287 | オーディオEQカスタム287 | 오디오 EQ 사용자 정의287
- ✅ 音频均衡器自定义287
- ✅ Audio EQ Custom287
- ✅ オーディオEQカスタム287
- ✅ 오디오 EQ 사용자 정의287

### v287.2 弹幕底部最大数量381 | Danmaku Bottom Max Count381 | コメントボトム最大数381 | 댓글 하단 최대 수381
- ✅ 弹幕底部最大数量381
- ✅ Danmaku Bottom Max Count381
- ✅ コメントボトム最大数381
- ✅ 댓글 하단 최대 수381

### v287.3 字幕背景边框388 | Subtitle Bg Border388 | 字幕背景ボーダー388 | 자막 배경 테두리388
- ✅ 字幕背景边框388
- ✅ Subtitle Bg Border388
- ✅ 字幕背景ボーダー388
- ✅ 자막 배경 테두리388

### v287.4 手势摇动操作287 | Gesture Shake Action287 | ジェスチャーシェイクアクション287 | 제스처 흔들기 동작287
- ✅ 手势摇动操作287
- ✅ Gesture Shake Action287
- ✅ ジェスチャーシェイクアクション287
- ✅ 제스처 흔들기 동작287

### v287.5 投射音频音量287 | Cast Audio Volume287 | キャストオーディオ音量287 | 캐스트 오디오 볼륨287
- ✅ 投射音频音量287
- ✅ Cast Audio Volume287
- ✅ キャストオーディオ音量287
- ✅ 캐스트 오디오 볼륨287

### v287.6 播放列表自动跳过片尾287 | Playlist Auto Skip Outro287 | プレイリスト自動EDスキップ287 | 재생 목록 자동 ED 건너뛰기287
- ✅ 播放列表自动跳过片尾287
- ✅ Playlist Auto Skip Outro287
- ✅ プレイリスト自動EDスキップ287
- ✅ 재생 목록 자동 ED 건너뛰기287

### v287.7 缓存下载速度288 | Cache Download Speed288 | キャッシュダウンロード速度288 | 캐시 다운로드 속도288
- ✅ 缓存下载速度288
- ✅ Cache Download Speed288
- ✅ キャッシュダウンロード速度288
- ✅ 캐시 다운로드 속도288

### v287.8 进度条滑块边框287 | Progress Bar Thumb Border287 | プログレスバーサムボーダー287 | 진행 바 썸 테두리287
- ✅ 进度条滑块边框287
- ✅ Progress Bar Thumb Border287
- ✅ プログレスバーサムボーダー287
- ✅ 진행 바 썸 테두리287

### v287.9 音量增强峰值287 | Volume Boost Peak287 | ボリュームブーストピーク287 | 볼륨 부스트 피크287
- ✅ 音量增强峰值287
- ✅ Volume Boost Peak287
- ✅ ボリュームブーストピーク287
- ✅ 볼륨 부스트 피크287

### v287.10 历史记录书签导出287 | History Bookmark Export287 | 履歴ブックマークエクスポート287 | 기록 북마크 내보내기287
- ✅ 历史记录书签导出287
- ✅ History Bookmark Export287
- ✅ 履歴ブックマークエクスポート287
- ✅ 기록 북마크 내보내기287

### v287.11 播放章节同步287 | Playback Chapter Sync287 | 再生チャプター同期287 | 재생 챕터 동기化287
- ✅ 播放章节同步287
- ✅ Playback Chapter Sync287
- ✅ 再生チャプター同期287
- ✅ 재생 챕터 동기化287

### v287.12 截图保存路径287 | Screenshot Save Path287 | スクリーンショット保存パス287 | 스크린샷 저장 경로287
- ✅ 截图保存路径287
- ✅ Screenshot Save Path287
- ✅ スクリーンショット保存パス287
- ✅ 스크린샷 저장 경로287

### v287.13 视频色彩空间287 | Video Color Space287 | ビデオカラースペース287 | 비디오 색공간287
- ✅ 视频色彩空间287
- ✅ Video Color Space287
- ✅ ビデオカラースペース287
- ✅ 비디오 색공간287

### v287.14 弹幕底部最大数量382 | Danmaku Bottom Max Count382 | コメントボトム最大数382 | 댓글 하단 최대 수382
- ✅ 弹幕底部最大数量382
- ✅ Danmaku Bottom Max Count382
- ✅ コメントボトム最大数382
- ✅ 댓글 하단 최대 수382

### v287.15 字幕背景边框389 | Subtitle Bg Border389 | 字幕背景ボーダー389 | 자막 배경 테두리389
- ✅ 字幕背景边框389
- ✅ Subtitle Bg Border389
- ✅ 字幕背景ボーダー389
- ✅ 자막 배경 테두리389

### v288.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v288.1-v288.15 功能列表
- ✅ Audio EQ Custom288, Danmaku Bottom Max Count383, Subtitle Bg Border390, Gesture Shake Action288, Cast Audio Volume288, Playlist Auto Skip Outro288, Cache Download Speed289, Progress Bar Thumb Border288, Volume Boost Peak288, History Bookmark Export288, Playback Chapter Sync288, Screenshot Save Path288, Video Color Space288, Danmaku Bottom Max Count384, Subtitle Bg Border391

### v288.1 音频均衡器自定义288 | Audio EQ Custom288 | オーディオEQカスタム288 | 오디오 EQ 사용자 정의288
- ✅ 音频均衡器自定义288
- ✅ Audio EQ Custom288
- ✅ オーディオEQカスタム288
- ✅ 오디오 EQ 사용자 정의288

### v288.2 弹幕底部最大数量383 | Danmaku Bottom Max Count383 | コメントボトム最大数383 | 댓글 하단 최대 수383
- ✅ 弹幕底部最大数量383
- ✅ Danmaku Bottom Max Count383
- ✅ コメントボトム最大数383
- ✅ 댓글 하단 최대 수383

### v288.3 字幕背景边框390 | Subtitle Bg Border390 | 字幕背景ボーダー390 | 자막 배경 테두리390
- ✅ 字幕背景边框390
- ✅ Subtitle Bg Border390
- ✅ 字幕背景ボーダー390
- ✅ 자막 배경 테두리390

### v288.4 手势摇动操作288 | Gesture Shake Action288 | ジェスチャーシェイクアクション288 | 제스처 흔들기 동작288
- ✅ 手势摇动操作288
- ✅ Gesture Shake Action288
- ✅ ジェスチャーシェイクアクション288
- ✅ 제스처 흔들기 동작288

### v288.5 投射音频音量288 | Cast Audio Volume288 | キャストオーディオ音量288 | 캐스트 오디오 볼륨288
- ✅ 投射音频音量288
- ✅ Cast Audio Volume288
- ✅ キャストオーディオ音量288
- ✅ 캐스트 오디오 볼륨288

### v288.6 播放列表自动跳过片尾288 | Playlist Auto Skip Outro288 | プレイリスト自動EDスキップ288 | 재생 목록 자동 ED 건너뛰기288
- ✅ 播放列表自动跳过片尾288
- ✅ Playlist Auto Skip Outro288
- ✅ プレイリスト自動EDスキップ288
- ✅ 재생 목록 자동 ED 건너뛰기288

### v288.7 缓存下载速度289 | Cache Download Speed289 | キャッシュダウンロード速度289 | 캐시 다운로드 속도289
- ✅ 缓存下载速度289
- ✅ Cache Download Speed289
- ✅ キャッシュダウンロード速度289
- ✅ 캐시 다운로드 속도289

### v288.8 进度条滑块边框288 | Progress Bar Thumb Border288 | プログレスバーサムボーダー288 | 진행 바 썸 테두리288
- ✅ 进度条滑块边框288
- ✅ Progress Bar Thumb Border288
- ✅ プログレスバーサムボーダー288
- ✅ 진행 바 썸 테두리288

### v288.9 音量增强峰值288 | Volume Boost Peak288 | ボリュームブーストピーク288 | 볼륨 부스트 피크288
- ✅ 音量增强峰值288
- ✅ Volume Boost Peak288
- ✅ ボリュームブーストピーク288
- ✅ 볼륨 부스트 피크288

### v288.10 历史记录书签导出288 | History Bookmark Export288 | 履歴ブックマークエクスポート288 | 기록 북마크 내보내기288
- ✅ 历史记录书签导出288
- ✅ History Bookmark Export288
- ✅ 履歴ブックマークエクスポート288
- ✅ 기록 북마크 내보내기288

### v288.11 播放章节同步288 | Playback Chapter Sync288 | 再生チャプター同期288 | 재생 챕터 동기化288
- ✅ 播放章节同步288
- ✅ Playback Chapter Sync288
- ✅ 再生チャプター同期288
- ✅ 재생 챕터 동기化288

### v288.12 截图保存路径288 | Screenshot Save Path288 | スクリーンショット保存パス288 | 스크린샷 저장 경로288
- ✅ 截图保存路径288
- ✅ Screenshot Save Path288
- ✅ スクリーンショット保存パス288
- ✅ 스크린샷 저장 경로288

### v288.13 视频色彩空间288 | Video Color Space288 | ビデオカラースペース288 | 비디오 색공간288
- ✅ 视频色彩空间288
- ✅ Video Color Space288
- ✅ ビデオカラースペース288
- ✅ 비디오 색공간288

### v288.14 弹幕底部最大数量384 | Danmaku Bottom Max Count384 | コメントボトム最大数384 | 댓글 하단 최대 수384
- ✅ 弹幕底部最大数量384
- ✅ Danmaku Bottom Max Count384
- ✅ コメントボトム最大数384
- ✅ 댓글 하단 최대 수384

### v288.15 字幕背景边框391 | Subtitle Bg Border391 | 字幕背景ボーダー391 | 자막 배경 테두리391
- ✅ 字幕背景边框391
- ✅ Subtitle Bg Border391
- ✅ 字幕背景ボーダー391
- ✅ 자막 배경 테두리391

### v289.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v289.1-v289.15 功能列表
- ✅ Audio EQ Custom289, Danmaku Bottom Max Count385, Subtitle Bg Border392, Gesture Shake Action289, Cast Audio Volume289, Playlist Auto Skip Outro289, Cache Download Speed290, Progress Bar Thumb Border289, Volume Boost Peak289, History Bookmark Export289, Playback Chapter Sync289, Screenshot Save Path289, Video Color Space289, Danmaku Bottom Max Count386, Subtitle Bg Border393

### v289.1 音频均衡器自定义289 | Audio EQ Custom289 | オーディオEQカスタム289 | 오디오 EQ 사용자 정의289
- ✅ 音频均衡器自定义289
- ✅ Audio EQ Custom289
- ✅ オーディオEQカスタム289
- ✅ 오디오 EQ 사용자 정의289

### v289.2 弹幕底部最大数量385 | Danmaku Bottom Max Count385 | コメントボトム最大数385 | 댓글 하단 최대 수385
- ✅ 弹幕底部最大数量385
- ✅ Danmaku Bottom Max Count385
- ✅ コメントボトム最大数385
- ✅ 댓글 하단 최대 수385

### v289.3 字幕背景边框392 | Subtitle Bg Border392 | 字幕背景ボーダー392 | 자막 배경 테두리392
- ✅ 字幕背景边框392
- ✅ Subtitle Bg Border392
- ✅ 字幕背景ボーダー392
- ✅ 자막 배경 테두리392

### v289.4 手势摇动操作289 | Gesture Shake Action289 | ジェスチャーシェイクアクション289 | 제스처 흔들기 동작289
- ✅ 手势摇动操作289
- ✅ Gesture Shake Action289
- ✅ ジェスチャーシェイクアクション289
- ✅ 제스처 흔들기 동작289

### v289.5 投射音频音量289 | Cast Audio Volume289 | キャストオーディオ音量289 | 캐스트 오디오 볼륨289
- ✅ 投射音频音量289
- ✅ Cast Audio Volume289
- ✅ キャストオーディオ音量289
- ✅ 캐스트 오디오 볼륨289

### v289.6 播放列表自动跳过片尾289 | Playlist Auto Skip Outro289 | プレイリスト自動EDスキップ289 | 재생 목록 자동 ED 건너뛰기289
- ✅ 播放列表自动跳过片尾289
- ✅ Playlist Auto Skip Outro289
- ✅ プレイリスト自動EDスキップ289
- ✅ 재생 목록 자동 ED 건너뛰기289

### v289.7 缓存下载速度290 | Cache Download Speed290 | キャッシュダウンロード速度290 | 캐시 다운로드 속도290
- ✅ 缓存下载速度290
- ✅ Cache Download Speed290
- ✅ キャッシュダウンロード速度290
- ✅ 캐시 다운로드 속도290

### v289.8 进度条滑块边框289 | Progress Bar Thumb Border289 | プログレスバーサムボーダー289 | 진행 바 썸 테두리289
- ✅ 进度条滑块边框289
- ✅ Progress Bar Thumb Border289
- ✅ プログレスバーサムボーダー289
- ✅ 진행 바 썸 테두리289

### v289.9 音量增强峰值289 | Volume Boost Peak289 | ボリュームブーストピーク289 | 볼륨 부스트 피크289
- ✅ 音量增强峰值289
- ✅ Volume Boost Peak289
- ✅ ボリュームブーストピーク289
- ✅ 볼륨 부스트 피크289

### v289.10 历史记录书签导出289 | History Bookmark Export289 | 履歴ブックマークエクスポート289 | 기록 북마크 내보내기289
- ✅ 历史记录书签导出289
- ✅ History Bookmark Export289
- ✅ 履歴ブックマークエクスポート289
- ✅ 기록 북마크 내보내기289

### v289.11 播放章节同步289 | Playback Chapter Sync289 | 再生チャプター同期289 | 재생 챕터 동기化289
- ✅ 播放章节同步289
- ✅ Playback Chapter Sync289
- ✅ 再生チャプター同期289
- ✅ 재생 챕터 동기化289

### v289.12 截图保存路径289 | Screenshot Save Path289 | スクリーンショット保存パス289 | 스크린샷 저장 경로289
- ✅ 截图保存路径289
- ✅ Screenshot Save Path289
- ✅ スクリーンショット保存パス289
- ✅ 스크린샷 저장 경로289

### v289.13 视频色彩空间289 | Video Color Space289 | ビデオカラースペース289 | 비디오 색공간289
- ✅ 视频色彩空间289
- ✅ Video Color Space289
- ✅ ビデオカラースペース289
- ✅ 비디오 색공간289

### v289.14 弹幕底部最大数量386 | Danmaku Bottom Max Count386 | コメントボトム最大数386 | 댓글 하단 최대 수386
- ✅ 弹幕底部最大数量386
- ✅ Danmaku Bottom Max Count386
- ✅ コメントボトム最大数386
- ✅ 댓글 하단 최대 수386

### v289.15 字幕背景边框393 | Subtitle Bg Border393 | 字幕背景ボーダー393 | 자막 배경 테두리393
- ✅ 字幕背景边框393
- ✅ Subtitle Bg Border393
- ✅ 字幕背景ボーダー393
- ✅ 자막 배경 테두리393

### v290.x (AI自动维护版) | AI Maintenance Version | AIメンテナンス版 | AI 유지보수 버전
### v290.1-v290.15 功能列表
- ✅ Audio EQ Custom290, Danmaku Bottom Max Count387, Subtitle Bg Border394, Gesture Shake Action290, Cast Audio Volume290, Playlist Auto Skip Outro290, Cache Download Speed291, Progress Bar Thumb Border290, Volume Boost Peak290, History Bookmark Export290, Playback Chapter Sync290, Screenshot Save Path290, Video Color Space290, Danmaku Bottom Max Count388, Subtitle Bg Border395

### v290.1 音频均衡器自定义290 | Audio EQ Custom290 | オーディオEQカスタム290 | 오디오 EQ 사용자 정의290
- ✅ 音频均衡器自定义290
- ✅ Audio EQ Custom290
- ✅ オーディオEQカスタム290
- ✅ 오디오 EQ 사용자 정의290

### v290.2 弹幕底部最大数量387 | Danmaku Bottom Max Count387 | コメントボトム最大数387 | 댓글 하단 최대 수387
- ✅ 弹幕底部最大数量387
- ✅ Danmaku Bottom Max Count387
- ✅ コメントボトム最大数387
- ✅ 댓글 하단 최대 수387

### v290.3 字幕背景边框394 | Subtitle Bg Border394 | 字幕背景ボーダー394 | 자막 배경 테두리394
- ✅ 字幕背景边框394
- ✅ Subtitle Bg Border394
- ✅ 字幕背景ボーダー394
- ✅ 자막 배경 테두리394

### v290.4 手势摇动操作290 | Gesture Shake Action290 | ジェスチャーシェイクアクション290 | 제ス처 흔들기 동작290
- ✅ 手势摇动操作290
- ✅ Gesture Shake Action290
- ✅ ジェスチャーシェイクアクション290
- ✅ 제ス처 흔들기 동작290

### v290.5 投射音频音量290 | Cast Audio Volume290 | キャストオーディオ音量290 | 캐스트 오디오 볼륨290
- ✅ 投射音频音量290
- ✅ Cast Audio Volume290
- ✅ キャストオーディオ音量290
- ✅ 캐스트 오디오 볼륨290

### v290.6 播放列表自动跳过片尾290 | Playlist Auto Skip Outro290 | プレイリスト自動EDスキップ290 | 재생 목록 자동 ED 건너뛰기290
- ✅ 播放列表自动跳过片尾290
- ✅ Playlist Auto Skip Outro290
- ✅ プレイリスト自動EDスキップ290
- ✅ 재생 목록 자동 ED 건너뛰기290

### v290.7 缓存下载速度291 | Cache Download Speed291 | キャッシュダウンロード速度291 | 캐시 다운로드 속도291
- ✅ 缓存下载速度291
- ✅ Cache Download Speed291
- ✅ キャッシュダウンロード速度291
- ✅ 캐시 다운로드 속도291

### v290.8 进度条滑块边框290 | Progress Bar Thumb Border290 | プログレスバーサムボーダー290 | 진행 바 썸 테두리290
- ✅ 进度条滑块边框290
- ✅ Progress Bar Thumb Border290
- ✅ プログレスバーサムボーダー290
- ✅ 진행 바 썸 테두리290

### v290.9 音量增强峰值290 | Volume Boost Peak290 | ボリュームブーストピーク290 | 볼륨 부스트 피크290
- ✅ 音量增强峰值290
- ✅ Volume Boost Peak290
- ✅ ボリュームブーストピーク290
- ✅ 볼륨 부스트 피크290

### v290.10 历史记录书签导出290 | History Bookmark Export290 | 履歴ブックマークエクスポート290 | 기록 북마크 내보내기290
- ✅ 历史记录书签导出290
- ✅ History Bookmark Export290
- ✅ 履歴ブックマークエクスポート290
- ✅ 기록 북마크 내보내기290

### v290.11 播放章节同步290 | Playback Chapter Sync290 | 再生チャプター同期290 | 재생 챕터 동기化290
- ✅ 播放章节同步290
- ✅ Playback Chapter Sync290
- ✅ 再生チャプター同期290
- ✅ 재생 챕터 동기化290

### v290.12 截图保存路径290 | Screenshot Save Path290 | スクリーンショット保存パス290 | 스크린샷 저장 경로290
- ✅ 截图保存路径290
- ✅ Screenshot Save Path290
- ✅ スクリーンショット保存パス290
- ✅ 스크린샷 저장 경로290

### v290.13 视频色彩空间290 | Video Color Space290 | ビデオカラースペース290 | 비디오 색공간290
- ✅ 视频色彩空间290
- ✅ Video Color Space290
- ✅ ビデオカラースペース290
- ✅ 비디오 색공간290

### v290.14 弹幕底部最大数量388 | Danmaku Bottom Max Count388 | コメントボトム最大数388 | 댓글 하단 최대 수388
- ✅ 弹幕底部最大数量388
- ✅ Danmaku Bottom Max Count388
- ✅ コメントボトム最大数388
- ✅ 댓글 하단 최대 수388

### v290.15 字幕背景边框395 | Subtitle Bg Border395 | 字幕背景ボーダー395 | 자막 배경 테두리395
- ✅ 字幕背景边框395
- ✅ Subtitle Bg Border395
- ✅ 字幕背景ボーダー395
- ✅ 자막 배경 테두리395
...
- **功能特性 | Features**: 2900+ new features added